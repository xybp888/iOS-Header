...
@class DNDStateService, NSArray, NSDateFormatter, NSHashTable, NSString, NSTimer, SBSStatusBarStyleOverridesAssertion, SBStatusBarDefaults, SBTelephonyManager, SBUserSessionController;
...
@interface SBStatusBarStateAggregator : NSObject <SBDateTimeOverrideObserver, DNDStateUpdateListener>
{
    ...
    unsigned long long _itemPostState[41];
    _Bool _nonItemDataChanged;
    CDStruct_1916f467 _data;
    int _actions;
    _Bool _performingAtomicUpdate;
    unsigned long long _atomicUpdateItemPostState[41];
    CDStruct_1916f467 _atomicUpdateData;
...
- (_Bool)_activeRemoteAlertWantsProgressIndicator;
...
- (void)_updateDataNetworkItem:(int)arg1 withInfo:(id)arg2 dataNetworkTypeGetter:(CDUnknownBlockType)arg3 dataNetworkTypeSetter:(CDUnknownBlockType)arg4;
- (void)_updateSecondaryDataNetworkItem;
- (void)_updateDataNetworkItem;
- (void)_updateServiceItem:(int)arg1 withInfo:(id)arg2 otherSIMInfo:(id)arg3 serviceStringGetter:(CDUnknownBlockType)arg4 serviceStringSetter:(CDUnknownBlockType)arg5 serviceCrossfadeStringGetter:(CDUnknownBlockType)arg6 serviceCrossfadeStringSetter:(CDUnknownBlockType)arg7 serviceContentTypeGetter:(CDUnknownBlockType)arg8 serviceContentTypeSetter:(CDUnknownBlockType)arg9 serviceBadgeStringGetter:(CDUnknownBlockType)arg10 serviceBadgeStringSetter:(CDUnknownBlockType)arg11;
- (void)_updateSecondaryServiceItem;
- (void)_updateServiceItem;
- (void)_updateSignalStrengthItem:(int)arg1 withInfo:(id)arg2 barsGetter:(CDUnknownBlockType)arg3 barsSetter:(CDUnknownBlockType)arg4;
...
- (const CDStruct_1916f467 *)_statusBarData;
- (void)dealloc;
- (id)init;
