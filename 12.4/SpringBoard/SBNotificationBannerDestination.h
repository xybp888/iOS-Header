...
@class BSSimpleAssertion, DNDEventBehaviorResolutionService, FBUIApplicationSceneDeactivationAssertion, NCNotificationManagementViewPresenter, NCNotificationViewController, NSMutableSet, NSString, SBAppStatusBarSettingsAssertion, SBAssistantController, SBLockScreenManager, SBNotificationBannerWindow, SBNotificationLongLookBannerDestination, SBSetupManager;
...
@interface SBNotificationBannerDestination : NSObject <NCNotificationViewControllerDelegatePrivate, SBDashBoardExternalBehaviorProviding, SBMotionGestureObserver, SBAssistantObserver, SBNotificationHomeAffordanceControllerClient, SBNotificationManagementDelegate, NCNotificationManagementViewPresenterDelegate, NCNotificationAlertDestination, SBNotificationDestinationHomeButtonPressHandler, SBNotificationExtensionVisibilityProviding, NCNotificationViewControllerDelegate, NCNotificationViewControllerObserving>
{
