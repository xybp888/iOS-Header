...
@class CAShapeLayer, NSMutableArray, NSMutableDictionary, NSString, SBAppLayout, SBAppSwitcherSettings, SBAppSwitcherSnapshotImageCache, SBAppSwitcherSnapshotLockoutViewControllerProvider, SBMedusa2oSettings, SBOrientationTransformWrapperView, SBSwitcherSnapshotImageView, UIView, UIViewController;
...
@interface SBAppSwitcherReusableSnapshotView : SBSwitcherWallpaperPageContentView <SBAppSwitcherSnapshotImageCacheObserver, SBReusableView, SBAppSwitcherPageContentView>
{
    ...
    SBMedusa2oSettings *_medusaSettings;
    _Bool _active;
    _Bool _visible;
