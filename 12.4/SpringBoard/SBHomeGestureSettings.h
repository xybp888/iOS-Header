...
@interface SBHomeGestureSettings : SBUISettings
{
    ...
    double _edgeDistanceToCorrectGestureFinalAction;
...
@property(nonatomic) double edgeDistanceToCorrectGestureFinalAction; // @synthesize edgeDistanceToCorrectGestureFinalAction=_edgeDistanceToCorrectGestureFinalAction;
