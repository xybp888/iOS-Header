...
@interface SBHomeGesturePanGestureRecognizer : SBScreenEdgePanGestureRecognizer <_UISettingsKeyObserver, SBGestureRecognizerPanGestureProviding, SBGestureRecognizerTouchHistoryProviding>
{
