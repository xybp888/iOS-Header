...
@class BKSProcessAssertion, BSAuditToken, NSDictionary, NSExtension, NSObject, NSString, NSTimer, NSURL, SBUISound, UIViewController, _SBRemoteAlertContentHostViewController, _SBUserNotificationImageDescriptor;
@protocol BSInvalidatable, NSCopying, OS_dispatch_source;
