...
#import "SBTelephonySubscriptionInfo.h"

@class NSString;

@interface SBMutableTelephonySubscriptionInfo : SBTelephonySubscriptionInfo
{
}
...
@property(nonatomic) unsigned long long cellRegistrationStatus; // @dynamic cellRegistrationStatus;
