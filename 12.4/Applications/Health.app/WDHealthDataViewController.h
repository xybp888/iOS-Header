...
#import "WDHealthDataTopLevelCategoryTableViewCellDelegate-Protocol.h"
...
- (id)_findCategoryViewController;
- (void)_replaceGatewayAccount:(id)arg1 withCredentialPersistentID:(id)arg2;
- (void)_reconnectGatewayAccount:(id)arg1;
- (void)askToReplaceAccountIniCloud:(id)arg1 withCredentialPersistentID:(id)arg2;
- (void)askToReplaceAccount:(id)arg1 withCredentialPersistentID:(id)arg2;
