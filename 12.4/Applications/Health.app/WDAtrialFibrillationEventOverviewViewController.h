...
@interface WDAtrialFibrillationEventOverviewViewController : HKTableViewController <HKSwitchTableViewCellDelegate, HRFeatureRegulatoryReenableFeatureActionDelegate, HROnboardingManagerDelegate, UITextViewDelegate, WDOverviewOnboardingSetupViewDelegate, WDUserActivityResponder, HKHeartRhythmAvailabilityObserver>
{
...
- (id)_cellForOnboardingInTable:(id)arg1;
