...
- (_Bool)shouldRejectTagID:(id)arg1 withBaselineAggregate:(id)arg2 currentDate:(id)arg3 addedDate:(id)arg4 maxIdleTime:(double)arg5 minEvents:(double)arg6 minRate:(double)arg7 baseRate:(double)arg8 multiplier:(double)arg9;
- (_Bool)shouldAcceptAggregate:(id)arg1 withCtr:(double)arg2 minEvents:(double)arg3 minClicks:(double)arg4 minRate:(double)arg5 baseRate:(double)arg6 multiplier:(double)arg7;
- (_Bool)shouldAcceptAggregate:(id)arg1 withCtr:(double)arg2 minEvents:(double)arg3 minClicks:(double)arg4 minRate:(double)arg5 baseRate:(double)arg6;
