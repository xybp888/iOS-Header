...
- (void)feedSubscriptionManager:(FRFeedSubscriptionManager *)arg1 updateHeartForTags:(NSSet *)arg2 isMuteHeart:(_Bool)arg3 withState:(_Bool)arg4 animationStyle:(long long)arg5 animationCompletionBlock:(void (^)(_Bool))arg6;
