...
@class FCArticle, FRContentObscuringView, FRFeedSubscriptionModificationSessionManager, FRFlintAdController, FRFlintAppActivityMonitor, FRFlintDataProvider, FRHardPaywallViewController, FRNativeAdFetcher, FRNativeSubscriptionAdFetcher, FRPaidBundleSoftPaywallDocumentSectionItemProvider, FRReferredArticlePageViewDataSource, FRScrollQueueManager, FRSpinnerView, FRSponsoredBarViewController, FRStatusBarObserver, FRSubscriptionHeaderViewController, FRValidationQueue, NPPaywall, NSDate, NSError, NSMutableDictionary, NSString, NUURLHandler, SFSafariViewController, SXContext, SXScrollViewController, SXVideoPlayerViewControllerManager, TSArticleRecirculationInArticleViewControllerProvider, TSKeyCommandManager, UIViewController;
...
@interface FRFlintArticleContentViewController : FRArticleContentViewController <FRScrollPositionProviding, FCReadingHistoryObserving, FRAppActivityObserving, FRSubscriptionHeaderViewControllerDelegate, SXScrollViewControllerDelegate, SXAnalyticsReporting, FCStreamingResultsObserving, FRFlintArticleDataSource, FRHardPaywallViewControllerDelegate, NUURLHandlerDelegate, TSArticleRecirculationViewControllerDelegate, TSArticleRecirculationRoutableFeedDelegate, FRLocalDraftPreviewable, NPPaywallDelegate, NUANFDebugSettingsObserver, FRArticleTransitionAnimatorArticle, FRViewControllerAnimatorContext, TSNativeAdDataProviderType, NABridgedArticleViewerPageItemActionHandlerDelegateType>
{
