...
@interface WebSheetView : UIView <UINavigationBarDelegate, SFFormAutoFillControllerDelegate, _WebSheetDownloadDelegate, WKNavigationDelegate, _WKInputDelegate, WKUIDelegate>
{
    ...
    NSMutableArray *_webArchiveFilePaths;
...
- (void)dumpWebarchive;
- (void)getAprrovalForWebArchival:(int)arg1;
- (void)reportWebArchiveCase;
- (void)removeUserDeniedArchiveFiles;
- (void)removeOldArchiveFiles;
- (_Bool)checkAndCreateArchiveDirectory;
