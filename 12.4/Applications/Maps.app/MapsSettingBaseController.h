...
@property(readonly) _Bool supportsNavigation; // @synthesize supportsNavigation=_supportsNavigation;
@property(readonly) _Bool canLocalizeLabels; // @synthesize canLocalizeLabels=_canLocalizeLabels;
