...
@class AppCoordinator, ControlContainerViewController, DirectionItem, LineCardViewController, MKMapItem, MapSelectionManager, MapSelectionManagerState, NSString, PlaceCardViewController, RoutePlanningDataCoordinator, RoutePlanningMapController, RoutePlanningOverviewViewController, RouteSearchViewController, RouteStepsViewController, RouteTransitIncidentsViewController, SearchSession, SearchViewController, SimpleResultsViewController, TrafficIncidentContaineeViewController, TransitLineSelectionActionController, UIViewController, VehicleConnectionMonitor, VenueCardCoordinator, VenuesManager;
@protocol ContaineeProtocol, GEOTransitLineItem, MKLocationManagerOperation;

__attribute__((visibility("hidden")))
@interface ActionCoordinator : NSObject <VenueCardCoordinatorDataSource, PlaceCardViewControllerDelegate, SimpleResultsViewControllerDelegate, LineCardViewControllerDelegate, MapSelectionManagerDelegate, SearchSessionObserver, SKStoreProductViewControllerDelegatePrivate, ViewModeDelegate, MarkedLocationRefinementDelegate, PPTTestPlaceCardProtocol, PPTTestSearchProtocol, PPTTestETAProtocol, PPTTestDirectionsDetailsProtocol, PPTTestGuidanceProtocol, PPTTestNavigationProtocol, PPTTestSettingsProtocol, PPTTestProactiveProtocol, PPTTestChromeTrayProtocol, PPTTestVenuesProtocol, ActionCoordination, MapViewResponderHandling, DeleteDelegate, MapsSuggestionsDeleteActionDelegate>
{
...
- (void)_enterRoutePlanningOverviewAnimated:(_Bool)arg1 resetDirectionItem:(_Bool)arg2 saveMapCamera:(_Bool)arg3 routePlanningOverviewStyle:(unsigned long long)arg4;
...
- (void)viewController:(id)arg1 startNavRoute:(id)arg2 navigationType:(unsigned long long)arg3;
...
- (void)viewController:(id)arg1 removeMapsSuggestionsEntry:(id)arg2 sourceView:(id)arg3 sourceRect:(struct CGRect)arg4 completion:(CDUnknownBlockType)arg5;
