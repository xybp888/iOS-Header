...
#import "TransitGuidanceSignAccessoryViewProtocol-Protocol.h"
#import "TransitSignCellDelegate-Protocol.h"

@class NSArray, NSMutableDictionary, NSString, Route, TransitSignView;
@protocol CellVendor, TransitSteppingSignGeneratorDelegate;

__attribute__((visibility("hidden")))
@interface TransitSteppingSignGenerator : NSObject <TransitSignCellDelegate, TransitGuidanceSignAccessoryViewProtocol, SteppingSignGenerator>
{
    NSArray *_signs;
...
- (id)transitSignViewStateForSign:(id)arg1;
- (id)transitStepForIndex:(unsigned long long)arg1;
