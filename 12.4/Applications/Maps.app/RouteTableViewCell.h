...
@class MapsLargerHitTargetButton, NSLayoutConstraint, Route, RouteTableViewCellButtonConstraintsController, _MKUILabel;
...
@interface RouteTableViewCell : RoutePickingCell
{
    ...
    Route *_route;
    struct MapsLargerHitTargetButton *_disclosureButton;
