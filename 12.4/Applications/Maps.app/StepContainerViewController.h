...
@class MKMapView, MNLocation, MapCameraController, NSDate, NSLayoutConstraint, NSMutableDictionary, NSMutableSet, NSString, NSTimer, NavDebugLocationManager, NavIdleTimer, NavRecenterButtonView, NavigationDebugViewsController, Route, StepActionCoordinator, SteppingPageViewController, UIScrollView;
...
@interface StepContainerViewController : OverlayContainerViewController <SteppingPageViewControllerDelegate, MNNavigationServiceObserver, GEOComposedRouteObserver, TransitSteppingSignGeneratorDelegate, MKMapViewDelegatePrivate, NavIdleTimerDelegate, PPTTestGuidanceStepProtocol, MapViewResponderHandling>
{
    ...
    _Bool _didSubmitAlightFeedback;
    _Bool _showingOverview;
    Route *_route;
...
@property(retain, nonatomic) NSMutableDictionary *alightStepsFeedback; // @synthesize alightStepsFeedback=_alightStepsFeedback;
@property(retain, nonatomic) NSMutableSet *alightStepsNotified; // @synthesize alightStepsNotified=_alightStepsNotified;
@property(nonatomic) _Bool didSubmitAlightFeedback; // @synthesize didSubmitAlightFeedback=_didSubmitAlightFeedback;
...
- (_Bool)transitSteppingSignGenerator:(id)arg1 signShouldBeExpandedAtIndex:(long long)arg2;
...
- (void)_setupViews;
- (void)viewDidLoad;
- (void)showOverview:(_Bool)arg1 andZoomToMapRegion:(_Bool)arg2;
