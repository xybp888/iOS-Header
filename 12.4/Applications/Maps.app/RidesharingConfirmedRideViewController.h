...
@interface RidesharingConfirmedRideViewController : ExtensionsStackViewController <HeaderViewDelegate, INUIRemoteViewControllerDelegate, RidesharingTippingViewDelegate, RideBookingRideStatusObserverProxyDelegate, _MXExtensionManagerDelegate>
{
    ...
    _Bool _hasShownFullContaineeLayout;
    _Bool _hasEverRequestedRemoteViewController;
...
- (void).cxx_destruct;
- (void)canCallPhoneNumber:(id)arg1 completion:(CDUnknownBlockType)arg2;
