...
@class CLLocation, NSArray, NSDate, NSDateInterval, NSDictionary, NSMutableDictionary, NSSet;
...
- (struct NSSet *)newIncidentsForDestination:(struct MapsSuggestionsEntry *)arg1;
- (void)updateWithIncidents:(struct NSSet *)arg1;
- (id)JSONString;
- (void)clear;
- (id)statusString;
- (_Bool)isInTripMode;
