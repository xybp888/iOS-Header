...
@class GuidanceManeuverView, NSArray, NSLayoutConstraint, NavSignManeuverGuidanceInfo, NavSignShieldInfo, UIImageView;
...
@interface NavManeuverSignView : NavSignView
{
    ...
    NavSignShieldInfo *_currentShield;
    long long _currentShieldSize;
