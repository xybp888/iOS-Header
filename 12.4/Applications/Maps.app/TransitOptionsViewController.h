...
@class ModalCardHeaderView, NSString, TransitOptionsViewControllerDataSource, TransitRouteOptions, UITableView;
...
@property(retain, nonatomic) TransitRouteOptions *options;
