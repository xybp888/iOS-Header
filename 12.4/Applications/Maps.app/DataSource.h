...
@class DragAndDropMapItem, DragAndDropPreview, GEOLocation, ListInteractionSession, MKLocationManager, NSDate, NSMutableDictionary, NSString, UITableView;
...
- (id)proactiveEventAtIndex:(int)arg1 withAction:(int)arg2;
- (void)sendAnalyticsForDataAtIndexPath:(id)arg1 object:(id)arg2 childPlaceIndexPath:(id)arg3 childPlaceObject:(id)arg4 action:(int)arg5 eventValue:(id)arg6 logContext:(id)arg7;
- (void)addEKAnalyticsForEntry:(id)arg1 tapped:(_Bool)arg2;
- (void)sendAnalyticsForDataAtIndexPath:(id)arg1 object:(id)arg2 action:(int)arg3 eventValue:(id)arg4 logContext:(id)arg5;
