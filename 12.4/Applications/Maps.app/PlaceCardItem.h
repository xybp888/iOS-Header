...
- (void).cxx_destruct;
@property(readonly, nonatomic) GEOMapItemCorrectedLocationAttributes *correctedLocationAttributes;
...
- (_Bool)shouldInsertInHistoryForRAPTrackingOnly;
- (_Bool)shouldInsertInHistory;
