...
@class AppCoordinator, AudioSettingsViewController, CustomPOIsController, GuidanceObserver, GuidanceSearchCategoriesViewModel, MapSelectionManager, MapViewZoomController, NSString, NavContainerViewController, NavTrafficIncidentContaineeViewController, NavTrafficIncidentCoordinator, NavigationDisplay, NavigationFeaturesViewModel, NavigationTrayContaineeViewController, PlaceCardViewController, SearchInfo, SimpleResultsViewController, TrafficCameraContaineeViewController;
@protocol GuidanceSearchResultsRouteDetouring, GuidanceSearchResultsRouteInfoProviding, MapViewZoomDelegate, NavTrafficIncidentAlertCoordination, NavigationMapItemDisplaying, NavigationTypeControlling;

__attribute__((visibility("hidden")))
@interface NavActionCoordinator : NSObject <PlaceCardViewControllerDelegate, MapSelectionManagerDelegate, SimpleResultsViewControllerDelegate, NavTrafficIncidentPresentation, AudioSettingsViewControllerDelegate, DirectionsStepsTableViewControllerDelegate, PPTTestNavigationProtocol, SARSearchResultTableViewCellDelegate, GEOLogContextDelegate, MapViewZoomControllerDelegate, PPTTestChromeTrayProtocol, NavActionCoordination, NavActionViewModelSource, MapViewResponderHandling>
{
    ...
    TrafficCameraContaineeViewController *_trafficCameraViewController;
...
@property(readonly, nonatomic) id <NavigationTypeControlling> navigationTypeController; // @synthesize navigationTypeController=_navigationTypeController;
...
- (void)_presentTrayWithDefaultLayout:(_Bool)arg1;
- (void)presentTray;
- (id)pedestrianNavContainerViewController;
- (_Bool)_isPedestrianNav;
@property(readonly, nonatomic) TrafficCameraContaineeViewController *trafficCameraViewController; // @synthesize trafficCameraViewController=_trafficCameraViewController;
...
@property(readonly, nonatomic) id <GuidanceSearchResultsRouteDetouring> routeDetourer; // @synthesize routeDetourer=_routeDetourer;
