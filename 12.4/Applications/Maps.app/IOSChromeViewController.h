...
@class CustomSearchManager, DirectionsController, DirectionsManager, EnvironmentObserver, InterruptionManager, LoadingIndicatorController, MapCameraController, MapSelectionManager, MapViewResponder, MapsActionController, MapsUserLocationView, NSArray, NSString, OverlayManager, ParkedCarManager, PersonalizedItemManager, RidesharingAnnotationsManager, RouteAnnotationsController, SearchPinsManager, SettingsController, UITapGestureRecognizer;
@protocol ViewModeDelegate;

__attribute__((visibility("hidden")))
@interface IOSChromeViewController : StackedChromeViewController <LightLevelObserver, MapSelectionManagerDelegate, MapsDebugViewControllerDelegate, InterruptionManagerProtocol, LockScreenProtocol, GEOLogContextDelegate>
{
...
@property(readonly, nonatomic) NSString *blurGroupName; // @synthesize blurGroupName=_blurGroupName;
...
- (void)searchForRouteFromAddress:(id)arg1 toAddress:(id)arg2 directionsMode:(unsigned long long)arg3 source:(int)arg4;
...
- (id)overlayManager;
- (id)mapViewResponder;
- (id)routeAnnotationsControllerIfExisted;
