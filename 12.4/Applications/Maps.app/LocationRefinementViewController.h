...
@class MKMapCamera, MKMapView, NSArray, NSLayoutConstraint, NSString, UIButton, UIImageView, UILabel, UIView;
...
@property(readonly, nonatomic) UIView *snapToUserLocationContainerView; // @synthesize snapToUserLocationContainerView=_snapToUserLocationContainerView;
