...
@class ContainerHeaderView, NSLayoutConstraint, NSString, SearchResultQuickActionMenuPresenter, SearchResultsDataSource, UITableView, VKLabelMarker;
...
- (void)setCluster:(id)arg1 sortAlphabetically:(_Bool)arg2;
- (void)clearCluster;
- (void)setSearchResults:(id)arg1 sortAlphabetically:(_Bool)arg2;
- (void)checkChain;
