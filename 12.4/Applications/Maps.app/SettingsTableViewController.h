...
@class MapViewModeSelector, NSArray, NSDictionary, UISwitch;
...
@property(nonatomic) __weak id <SettingsTableViewControllerObserver> observer; // @synthesize observer=_observer;
