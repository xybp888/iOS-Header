...
@class BlurView, MNNavigationService, NSArray, NSNumber, NSString, NavigationDebugViewsController, Route, UIBarButtonItem, UITableView;
@protocol DirectionsStepsTableViewControllerDelegate;

__attribute__((visibility("hidden")))
@interface DirectionsStepsTableViewController : UIViewController <MNNavigationServiceObserver, RoutePlanningFooterViewDelegate, LightLevelObserver, RouteDirectionsListController, UITableViewDelegate, UITableViewDataSource>
{
