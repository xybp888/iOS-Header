...
#import "RAPApplePayCellDelegate-Protocol.h"
#import "RAPCategoryChooserDelegate-Protocol.h"
#import "RAPInstrumentableTarget-Protocol.h"

@class NSString, RAPCommentPartHeaderView, RAPMapFeatureTableViewCell, RAPPhotoPickerController, RAPPlaceCorrectionsQuestion, RAPReport, ReportAProblemCategoryChooserViewController, UIBarButtonItem;

__attribute__((visibility("hidden")))
@interface RAPAddressCorrectionsViewController : UITableViewController <RAPAddressCellDelegate, RAPCategoryChooserDelegate, RAPApplePayCellDelegate, RAPInstrumentableTarget>
{
    RAPReport *_report;
...
- (void)applePayValueChangedTo:(_Bool)arg1;
