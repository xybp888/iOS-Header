...
@class CustomPOIsController, MKMapView, MapCameraController, MapSelectionManager, NSArray, NSHashTable, NSString, PlaceCardLinkedPlacesItemSource, RouteStartEndItemSource, SearchPinsManagerShowSearchResultsAnimation, SearchResult, SearchResultsItemSource, VKLabelMarker, VenuesManager;
@protocol POIShape;
...
- (void)dropPinsForSearchResults:(id)arg1 animated:(_Bool)arg2;
- (void)dropPinsForSearchResults:(id)arg1 selectedSearchResult:(id)arg2 animated:(_Bool)arg3;
- (void)selectLabelMarkerForSearchResult:(id)arg1 animated:(_Bool)arg2;
- (struct UIEdgeInsets)carRecommendedMapPadding;
