...
@class AddressBookAddress, CRRecentContact, DirectionsWaypoint, ExternalURLQuery, GEOMapItemChildPlace, GEORelatedSearchSuggestion, GEORetainedSearchMetadata, GEOSearchCategory, HistoryEntryRecentsItem, MKLocalSearchCompletion, MKMapItem, NSData, NSString, SearchResult, VenueCategoryItem;

__attribute__((visibility("hidden")))
@interface SearchFieldItem : NSObject <NSCopying>
{
    _Bool _popularNearbySearch;
    _Bool _favorites;
    int _engineType;
    ...
    long long _preferredFavoritesType;
...
@property(nonatomic) long long preferredFavoritesType; // @synthesize preferredFavoritesType=_preferredFavoritesType;
@property(nonatomic) _Bool favorites; // @synthesize favorites=_favorites;
...
@property(nonatomic, getter=isPopularNearbySearch) _Bool popularNearbySearch; // @synthesize popularNearbySearch=_popularNearbySearch;
