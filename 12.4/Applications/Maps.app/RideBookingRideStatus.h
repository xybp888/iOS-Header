...
@class CLLocation, CLPlacemark, INGetRideStatusIntentResponse, INRequestRideIntentResponse, INRideStatus, NSArray, NSDate, NSDateComponents, NSNumber, NSSet, NSString, NSUserActivity, RideBookingRideOption, RidesharingSpecialPricingBadge, UIImage;
@protocol RideBookingApplication;

__attribute__((visibility("hidden")))
@interface RideBookingRideStatus : NSObject
{
    _Bool _rideStatusIsCanceled;
    _Bool _rideStatusIsCanceledByService;
...
- (id)initWithApplication:(id)arg1 rideOption:(id)arg2 canceled:(_Bool)arg3 canceledByService:(_Bool)arg4 userActivityForCanceling:(id)arg5 identifier:(id)arg6 phase:(unsigned long long)arg7 error:(unsigned long long)arg8 cacheItems:(id)arg9;
...
- (_Bool)_feedbackRequired;
- (_Bool)_showFeedbackType:(unsigned long long)arg1;
