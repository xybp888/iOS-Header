...
@class MKMapItem, NSArray, NSDate, NSDictionary, NSError, NSString, NSURL, _MKURLHandler;
...
- (_Bool)URLHandler:(_MKURLHandler *)arg1 launchIntoTableBookingForMapItem:(MKMapItem *)arg2 options:(NSDictionary *)arg3 originIsActiveWatch:(_Bool)arg4;
...
@optional
- (void)URLHandler:(_MKURLHandler *)arg1 didFinishAsynchronousHandlingOfURL:(NSURL *)arg2 sourceApplication:(NSString *)arg3 originIsActiveWatch:(_Bool)arg4 error:(NSError *)arg5;
- (void)URLHandler:(_MKURLHandler *)arg1 willStartAsynchronousHandlingOfURL:(NSURL *)arg2 sourceApplication:(NSString *)arg3 originIsActiveWatch:(_Bool)arg4;
