...
@class CustomPOIsController, DrivingNavContainerViewController, GuidanceObserver, IOSChromeViewController, MKMapView, MNTrafficIncidentAlert, NSString, NSTimer, NavActionCoordinator, NavigationCustomFeaturesSource, NavigationDisplay, NavigationPowerLogger, PersonalizedItemManager, Route;
...
@interface NavModeController : NSObject <NavigationDisplayDelegate, LockScreenProtocol, PersonalizedItemSourceObserver, MapViewZoomDelegate, FBSDisplayLayoutObserver, StackedChromeModeController, MNNavigationServiceObserver, NavigationTypeControlling>
{
    ...
    DrivingNavContainerViewController *_containerViewController;
...
@property(retain, nonatomic) DrivingNavContainerViewController *containerViewController; // @synthesize containerViewController=_containerViewController;
