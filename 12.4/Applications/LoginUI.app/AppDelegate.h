...
@class NSString, NSXPCConnection, UINavigationController, UIWindow;

@interface AppDelegate : UIResponder <LKLoginUIProtocol, UMUserListUpdateObserver, LUIAttentionAwareIdleTimerDelegate, UIApplicationDelegate>
{
