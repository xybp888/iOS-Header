...
@class ActionPanel, BookmarksNavigationController, BrowserContainerViewController, BrowserRootViewController, BrowserWindowController, CatalogViewControllerState, ContinuousReadingController, ContinuousReadingViewController, NSDate, NSMapTable, NSString, NSTimer, NSUUID, RecentlyClosedTabViewController, SKStoreProductViewController, SearchStateCache, SidebarInteractionReporter, StatusBarSpinnerController, TabController, TabDocument, TabDragDropInteractionController, TabExposeActionsController, TabMergingController, UIPinchGestureRecognizer, UIScrollView, UIStatusBar, UITextRange, UIToolbar, UIView, WBSDigitalHealthManager, WKBackForwardListItem, WKPreferences, WKProcessPool, _SFBarManager, _SFBrowserConfiguration, _SFBrowserSavedState, _SFCrashBanner, _SFMailContentProvider, _SFWebView;
@protocol LoadProgressObserver;

@interface BrowserController : UIResponder <ActionPanelDelegate, AddBookmarkActivityDelegate, BackForwardTableViewControllerDelegate, BookmarksBarViewDelegate, BookmarksNavigationControllerDelegate, BrowserRootViewControllerDelegate, CatalogViewControllerDelegate, SidebarInteractionReporterDelegate, TabDocumentViewGeometryProviding, TabSnapshotGeneratorDelegate, UIGestureRecognizerDelegatePrivate, _SFDynamicBarAnimatorDelegate, SFReaderAppearanceViewControllerDelegate, SKStoreProductViewControllerDelegate, _SFBarManagerDelegate, _SFBrowserKeyCommandMethods, _SFMailContentProviderDataSource, WBSDigitalHealthManagerDelegate, DigitalHealthViewControllerDelegate, CompletionDetailViewControllerDelegate, ContinuousReadingViewControllerDelegate, LinkPreviewProvider, MobileSafariWindowDelegate, TabDocumentDelegate, UIScrollViewDelegate, _SFNavigationBarDelegate, _SFSingleBookmarkNavigationControllerDelegate>
{
    _Bool _antiPhishingServiceInitialized;
    _Bool _applicationIsOpaque;
    _Bool _avoidSuppressingBlurDueToReaderTransition;
    _Bool _backgrounded;
...
- (void)browserViewControllerDidChangeMaximumObscuredInsets:(id)arg1;
...
- (void)_updateDeviceMotionAndOrientationAccess;
...
- (void)_toggleShowingFavoritesBarKeyPressed;
- (void)_toggleBookmarksKeyPressed;
- (void)_focusAddressFieldAlternativeKeyPressed;
...
- (id)_showFavoritesBarActionTitle;
