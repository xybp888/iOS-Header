...
@class Application, BrowserController, CloudTabStore, NSArray, NSMapTable, NSMutableArray, NSMutableSet, NSSet, NSString, NSTimer, NSUUID, RecentlyClosedTabViewController, TabBar, TabDocument, TabOverview, TabSnapshotCache, TiltedTabView, UIBarButtonItem, UIButton, UIView, _SFBrowserSavedState;
@protocol TabCollectionView, TabThumbnailCollectionView;

@interface TabController : NSObject <RecentlyClosedTabViewControllerDelegate, TabBarDelegate, TabOverviewDelegate, TabSnapshotCacheDelegate, TiltedTabViewDelegate, TabDocumentDragDropDataSource>
{
    ...
    NSMutableSet *_tabDocumentsHiddenFromTabViews;
...
- (id)replacePlaceholderTabDocument:(id)arg1 withTabDocuments:(id)arg2;
