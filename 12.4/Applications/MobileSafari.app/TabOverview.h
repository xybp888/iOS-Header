...
@interface TabOverview : UIView <CloudTabTableDelegate, ReorderingAutoscrollerDelegate, _UIBasicAnimationFactory, UIGestureRecognizerDelegate, UISearchBarDelegate, UISearchBarDelegate_Private, UIKeyInput, TabThumbnailCollectionView>
{
...
- (void)stopReordering;
- (void)updateReorderingAtPoint:(struct CGPoint)arg1 anchorPoint:(struct CGPoint)arg2 dragging:(_Bool)arg3;
- (void)beginReorderingItem:(id)arg1 dragging:(_Bool)arg2;
...
- (void)_setDragPreviewStartingOffsetForItemView:(id)arg1;
...
- (CDStruct_5ca50560)_targetLocationForItemAtIndex:(unsigned long long)arg1 inNumberOfItems:(unsigned long long)arg2 includingNewTabScale:(_Bool)arg3;
