...
#import "_SFAutomaticBugCaptureObserver-Protocol.h"
...
@class BrowserController, CSSearchableItemAttributeSet, FALockOutViewController, FindOnPageCompletionProvider, FindOnPageView, LinkPreviewViewController, LoadingController, NSArray, NSDictionary, NSError, NSMutableArray, NSNumber, NSPointerArray, NSString, NSTimer, NSURL, NSUUID, NSUserActivity, PageLoadTest, PageLoadTestStatistics, PinnableBanner, TabBarItem, TabDocumentView, TabOverviewItem, TiltedTabItem, TouchIconFetcher, UIImage, UIView, WBSFluidProgressController, WBSFluidProgressState, WBSHistoryContextController, WBSHistoryVisit, WBSSameDocumentNavigationToHistoryVisitCorrelator, WKBackForwardListItem, WebBookmark, _SFAppleConnectExtensionPageController, _SFApplicationManifestFetcher, _SFBrowserConfiguration, _SFCalendarEventDetector, _SFDialogController, _SFDownload, _SFFluidProgressView, _SFFormAutoFillController, _SFInjectedJavaScriptController, _SFNavigationBarItem, _SFNavigationIntent, _SFNavigationUtilitiesManager, _SFPageLoadErrorController, _SFPrintController, _SFQuickLookDocument, _SFQuickLookDocumentController, _SFQuickLookDocumentWriter, _SFReaderController, _SFReloadOptionsController, _SFSafariSharingExtensionController, _SFSafeBrowsingController, _SFSecIdentityPreferencesController, _SFTabStateData, _SFTelephonyNavigationMitigationPolicy, _SFURLSpoofingMitigator, _SFWebClipMetadataFetcher, _SFWebView, _WKRemoteObjectInterface, _WKSessionState, _WKUserInitiatedAction;
@protocol LoadProgressObserver, TabDocumentDelegate, UIDragSession, WBSFluidProgressStateSource;

@interface TabDocument : NSObject <BCSActionDelegate, LoadingControllerDelegate, QuickWebsiteSearchEventListener, SFFormAutoFillControllerDelegate, WBSFluidProgressControllerWindowDelegate, WBSFluidProgressStateSource, WKNavigationDelegatePrivate, WKUIDelegatePrivate, _SFAppleConnectExtensionUIDelegate, _SFAutomaticBugCaptureObserver, _SFDialogControllerDelegate, _SFDialogViewControllerPresenting, _SFFindOnPageViewDelegate, _SFPageLoadErrorControllerDelegate, _SFPrintControllerDelegate, _SFReaderControllerDelegate, _SFWebViewDelegate, _WKDiagnosticLoggingDelegate, _WKFullscreenDelegate, _WKInputDelegate, _SFQuickLookDocumentSource, _WKIconLoadingDelegate, ReadingListMetadataProvider, LoadableResource, MergeableItem, _SFDialogPresenting, _SFDownloadDelegate, WBSTabItemSearchSupport>
{
    ...
    _Bool _showsQuickLookDocumentView;
    ...
    FALockOutViewController *_associatedLockOutViewController;
...
- (void)_animateElement:(id)arg1 toBarItem:(long long)arg2;
...
- (id)handleNavigationIntent:(id)arg1;
...
- (void)_setShowsQuickLookDocumentView:(_Bool)arg1;
