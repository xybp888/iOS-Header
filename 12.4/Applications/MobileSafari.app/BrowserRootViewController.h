...
@class BarContainerView, BookmarksBarView, BrowserController, BrowserToolbar, CatalogViewController, DigitalHealthViewController, NSString, NavigationBar, SidebarContentDimmingView, SidebarViewController, TabBar, UIApplication, UIScrollView, UITapGestureRecognizer, UIView, ViewWithCustomNextResponder, _SFBrowserConfiguration, _SFDynamicBarAnimator, _SFWebView;
@protocol BrowserRootViewControllerDelegate, TabThumbnailCollectionView, _SFBarCommon;

@interface BrowserRootViewController : UIViewController <UIGestureRecognizerDelegate, SidebarContentDimmingViewDelegate>
{
    UIApplication *_app;
    ...
    DigitalHealthViewController *_digitalHealthViewController;
...
- (void)_layOutTopBars;
- (struct UIEdgeInsets)_sidebarObscuredInsetsForRect:(struct CGRect)arg1 inCoordinateSpace:(id)arg2 includingSidebarOnlyIfEmbedded:(_Bool)arg3;
...
- (struct UIEdgeInsets)_obscuredInsetsForRect:(struct CGRect)arg1 inCoordinateSpace:(id)arg2 includingSidebarOnlyIfEmbedded:(_Bool)arg3;
