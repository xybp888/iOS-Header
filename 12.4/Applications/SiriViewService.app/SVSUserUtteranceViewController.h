...
#import "SVSEditableTextViewDelegate-Protocol.h"
...
{
    SVSUserUtteranceView *_utteranceView;
    ...
    SVSEditableTextView *_editableUtteranceView;
    ...
    SVSUserUtteranceContainerView *_containerView;
