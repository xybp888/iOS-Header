...
@class AWAttentionAwarenessClient, CMWakeGestureManager, NSMutableDictionary, NSString, SVSUserAttentionSignalProviderFactory;
@protocol OS_dispatch_queue, SVSUserAttentionControllerDelegate;

@interface SVSUserAttentionController : NSObject <CMWakeGestureDelegate>
{
    SVSUserAttentionSignalProviderFactory *_userAttentionSignalProviderFactory;
    ...
    id <SVSUserAttentionControllerDelegate> _delegate;
}
