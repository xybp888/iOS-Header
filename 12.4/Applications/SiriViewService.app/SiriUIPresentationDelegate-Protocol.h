...
@class AFUIRequestOptions, AFUserUtterance, AFUserUtteranceSelectionResults, AceObject, NSArray, NSBundle, NSDate, NSIndexPath, NSString, NSURL, NSUUID, SASSpeechRecognized, UIViewController;
