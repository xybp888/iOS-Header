...
#import "_UIInteractionProgressObserver-Protocol.h"
...
- (double)_yOffsetForWeekView:(id)arg1 circle:(id)arg2 dayNumberFrameHeight:(double)arg3;
- (id)_pressHintDayCircleWithTappedWeekView:(id)arg1 tappedDate:(id)arg2 containerFrame:(struct CGRect)arg3 dayNumberFrameHeight:(double)arg4;
