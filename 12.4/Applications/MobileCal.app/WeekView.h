...
@class CalendarOccurrencesCollection, EKDayViewContent, NSArray, NSCalendar, NSDate, NSDateComponents, NSObject, NSString, NSTimeZone, UIImage, UIImageView, UIScrollView, WeekAllDayView;
...
+ (unsigned long long)displayedDaysForOrientation:(long long)arg1;
+ (double)windowSpaceForOrientation:(long long)arg1;
