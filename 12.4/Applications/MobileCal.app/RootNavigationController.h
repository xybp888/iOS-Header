...
#import "DebugWindowSizeButtonDelegate-Protocol.h"
...
@class CalendarModel, CompactMonthDividedListSwitchButton, DebugWindowSizeControlPanel, ListViewSwitchButton, NSAttributedString, NSMutableDictionary, NSString, NSUserActivity, PaletteView, UIBarButtonItem, UIButton, UIFont, UILabel, UITraitCollection, _UINavigationControllerPalette;
...
@interface RootNavigationController : UINavigationController <UIPopoverPresentationControllerDelegate, EKEventViewDelegatePrivate, EKEventEditViewDelegate, CalendarDebugReportProblemViewControllerDelegate, NSUserActivityDelegate, UIWindowDelegate, UINavigationControllerDelegate, WeekViewControllerDelegate, DebugWindowSizeButtonDelegate, FutureTraitEnvironment>
{
    ...
    struct CGPoint _debugWindowSizeHUDPosition;
    _Bool _debugWindowSizeAnimatedWindowActive;
...
- (void)setDebugWindowAnimatedWindowActive:(_Bool)arg1;
...
- (void)recursiveBuildJournalOfViewControllerSubtree:(id)arg1 returnedArray:(id)arg2 stopCondition:(CDUnknownBlockType)arg3;
...
- (void)_updateCalendarButtonError;
