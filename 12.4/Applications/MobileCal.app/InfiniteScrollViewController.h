...
@property(readonly) _Bool viewIsVisible; // @synthesize viewIsVisible=_viewIsVisible;
@property _Bool isUserFingerDown; // @synthesize isUserFingerDown=_isUserFingerDown;
