...
- (void)updateView;
- (id)occurrence;
- (void)_setOccurrence:(id)arg1 preloadedTitle:(id)arg2;
...
- (void)_updateOccurrenceWithPreloadedTitle:(id)arg1;
...
- (id)initWithOccurrence:(id)arg1 preloadedTitle:(id)arg2 forDayRange:(struct _NSRange)arg3 isZoomedDay:(_Bool)arg4 isProposedTime:(_Bool)arg5;
- (id)_strikeColor;
- (id)_timeColor;
- (id)_titleColor;
