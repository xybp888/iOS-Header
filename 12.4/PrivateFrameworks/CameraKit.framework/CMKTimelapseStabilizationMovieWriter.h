...
#import <CameraKit/AVOfflineVideoStabilizerDataProvider-Protocol.h>
#import <CameraKit/CMKTimelapseMovieWriterProtocol-Protocol.h>

@class AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, AVOfflineVideoStabilizer, NSArray, NSString;
