...
@property(nonatomic) _Bool requestAuthoriztion; // @synthesize requestAuthoriztion=_requestAuthoriztion;
...
@property(nonatomic) _Bool hasRequestAuthoriztion;
