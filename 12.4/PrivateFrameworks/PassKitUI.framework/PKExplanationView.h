...
@interface PKExplanationView : UIView <UIScrollViewDelegate, UITextViewDelegate>
{
    ...
    _Bool _titleTextIsNaturalAlgined;
    _Bool _bodyTextIsNaturalAlgined;
...
@property(nonatomic) _Bool bodyTextIsNaturalAlgined; // @synthesize bodyTextIsNaturalAlgined=_bodyTextIsNaturalAlgined;
...
@property(nonatomic) _Bool titleTextIsNaturalAlgined; // @synthesize titleTextIsNaturalAlgined=_titleTextIsNaturalAlgined;
