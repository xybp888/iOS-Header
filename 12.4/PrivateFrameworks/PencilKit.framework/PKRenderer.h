...
- (void)renderParticleStroke:(_PKStrokePointSlice_6dfeec92)arg1 animatingStroke:(struct AnimatingStroke *)arg2 starts:(_Bool)arg3 ends:(_Bool)arg4 combinedRendering:(_Bool)arg5;
...
- (void)renderPenStroke:(_PKStrokePointSlice_6dfeec92)arg1 animatingStroke:(struct AnimatingStroke *)arg2 alpha:(double)arg3 combinedRendering:(_Bool)arg4;
- (void)renderEraserIndicator:(struct _PKStrokePoint)arg1 withTransform:(struct CGAffineTransform)arg2;
- (void)renderStroke:(_PKStrokePointSlice_6dfeec92)arg1 animatingStroke:(struct AnimatingStroke *)arg2 accumulating:(_Bool)arg3 combinedRendering:(_Bool)arg4;
- (void)setupOpenGL;
