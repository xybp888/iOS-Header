...
- (id)compositeEraseShaderWithMode:(long long)arg1 clipping:(_Bool)arg2;
- (id)compositeSoftWhiteShaderWithMode:(long long)arg1 clipping:(_Bool)arg2;
- (id)compositeMultiplyShaderWithMode:(long long)arg1 clipping:(_Bool)arg2;
- (id)compositeOverShaderWithMode:(long long)arg1 clipping:(_Bool)arg2;
- (id)compositePaperShaderWithMode:(long long)arg1;
@property(readonly, nonatomic) DKDGLShader *blitShader;
- (id)glVersionString;
- (id)definesForMode:(long long)arg1 clipping:(_Bool)arg2;
