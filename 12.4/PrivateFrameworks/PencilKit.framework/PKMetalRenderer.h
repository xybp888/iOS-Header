...
- (id)generateCacheForParticleStroke:(struct AnimatingStroke *)arg1 points:(_PKStrokePointSlice_0c0423af)arg2 startPt:(_Bool)arg3 endPt:(_Bool)arg4;
...
- (unsigned long long)renderParticleStroke:(_PKStrokePointSlice_0c0423af)arg1 animatingStroke:(struct AnimatingStroke *)arg2 starts:(_Bool)arg3 ends:(_Bool)arg4 combinedRendering:(_Bool)arg5 renderEncoder:(id)arg6;
- (id)generateParticleCacheForStroke:(_PKStrokePointSlice_0c0423af)arg1 animatingStroke:(struct AnimatingStroke *)arg2 starts:(_Bool)arg3 ends:(_Bool)arg4;
...
- (unsigned long long)renderPenStroke:(_PKStrokePointSlice_0c0423af)arg1 animatingStroke:(struct AnimatingStroke *)arg2 combinedRendering:(_Bool)arg3 renderEncoder:(id)arg4;
...
- (unsigned long long)renderStroke:(_PKStrokePointSlice_0c0423af)arg1 animatingStroke:(struct AnimatingStroke *)arg2 accumulating:(_Bool)arg3 combinedRendering:(_Bool)arg4 renderEncoder:(id)arg5 computeEncoder:(id)arg6 renderCache:(id)arg7;
