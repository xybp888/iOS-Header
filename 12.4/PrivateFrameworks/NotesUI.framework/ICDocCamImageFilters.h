...
+ (struct UIImage *)autoEnhancement:(struct UIImage *)arg1 orientation:(long long)arg2;
...
+ (struct UIImage *)normalization:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)histogramEqualization:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)autoBlackAndWhitePoint:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)grayscale:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)icImageCleanupFilter:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)swapRedAndGreen:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)whiteboardAndSaturation:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)sigmoidColor:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)sigmoidGrayscale:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)whiteboardFilter:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)sepiaFilter:(struct UIImage *)arg1 orientation:(long long)arg2;
+ (struct UIImage *)convertImageToGrayScale:(struct UIImage *)arg1;
+ (struct UIImage *)convertImageTo8BitGrayScale:(struct UIImage *)arg1;
