...
@interface CAMCaptureCapabilities : NSObject
{
    ...
    _Bool _unifiedBracketingSupported;
...
@property(readonly, nonatomic, getter=isUnifiedBracketingSupported) _Bool unifiedBracketingSupported; // @synthesize unifiedBracketingSupported=_unifiedBracketingSupported;
...
- (_Bool)isSupportedLightingType:(long long)arg1 forDevicePosition:(long long)arg2;
