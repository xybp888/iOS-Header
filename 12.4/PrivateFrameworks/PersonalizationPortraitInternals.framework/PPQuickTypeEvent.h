...
@property(nonatomic) _Bool isUnscheduledFreeTime; // @synthesize isUnscheduledFreeTime=_isUnscheduledFreeTime;
...
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 calendarTitle:(id)arg3 start:(id)arg4 end:(id)arg5 isUnscheduledFreeTime:(_Bool)arg6;
