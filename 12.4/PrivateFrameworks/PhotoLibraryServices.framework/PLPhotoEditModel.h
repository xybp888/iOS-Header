...
@interface PLPhotoEditModel : NSObject <NSCopying>
{
    ...
    _Bool _rawNoiseReductionEnabled;
...
@property(readonly, nonatomic, getter=isRawNoiseReductionEnabled) _Bool rawNoiseReductionEnabled; // @synthesize rawNoiseReductionEnabled=_rawNoiseReductionEnabled;
