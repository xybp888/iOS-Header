...
+ (struct CGPath *)_newPathForAnnotation:(id)arg1 axisAlignedForStroke:(_Bool)arg2 alignToScreenUsingPageController:(id)arg3 orAlignToContext:(struct CGContext *)arg4;
