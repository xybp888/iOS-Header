...
- (id)_fetchConfigurationWithFilterPredicate:(id)arg1 inclusionPredicate:(id)arg2 fetchLimit:(unsigned long long)arg3 reverseSortOrder:(_Bool)arg4 hideHiddenAssets:(_Bool)arg5 fetchPropertySets:(id)arg6;
...
- (id)existingFetchResultForAssetCollection:(id)arg1 withFilterPredicate:(id)arg2 inclusionPredicate:(id)arg3 fetchLimit:(unsigned long long)arg4 reverseSortOrder:(_Bool)arg5 hideHiddenAssets:(_Bool)arg6 fetchPropertySets:(id)arg7;
- (id)fetchAssetsInAssetCollection:(id)arg1 withFilterPredicate:(id)arg2 inclusionPredicate:(id)arg3 fetchLimit:(unsigned long long)arg4 reverseSortOrder:(_Bool)arg5 hideHiddenAssets:(_Bool)arg6 fetchPropertySets:(id)arg7;
- (void)dealloc;
