...
+ (void)saveUtteranceMetadataForUtterance:(id)arg1 isExplicitEnrollment:(_Bool)arg2 isHandheldEnrollment:(_Bool)arg3 triggerSource:(id)arg4 audioInput:(id)arg5 otherBiometricResult:(unsigned long long)arg6 containsPayload:(_Bool)arg7;
