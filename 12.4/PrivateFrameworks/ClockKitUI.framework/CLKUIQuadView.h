...
- (_Bool)_prepareAndRenderForTime:(double)arg1 completion:(CDUnknownBlockType)arg2;
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1;
- (_Bool)renderSynchronouslyWithImageQueueDiscard:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)renderSynchronouslyWithImageQueueDiscard:(_Bool)arg1;
