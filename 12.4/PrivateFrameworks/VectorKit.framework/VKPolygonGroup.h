...
- (void)addPolygon:(CDStruct_dbfa07c5 *)arg1 hasNonWaterStyle:(_Bool)arg2 accessor:(struct ResourceAccessor *)arg3 triangulator:(id)arg4;
...
- (void)prepareForPolygon:(CDStruct_dbfa07c5 *)arg1 hasNonWaterStyle:(_Bool)arg2;
- (unsigned int)createStrokePointStyleList:(CDStruct_dbfa07c5 *)arg1 section:(unsigned long long)arg2 outPointStyles:(vector_0496561e *)arg3;
