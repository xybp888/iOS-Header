...
- (id)iconForStyleAttributes:(id)arg1 styleManager:(shared_ptr_a3c46825)arg2 contentScale:(double)arg3 size:(long long)arg4 customIconID:(unsigned long long)arg5 transparent:(_Bool)arg6 overrides:(struct QueryOverrides)arg7;
- (id)iconForStyleAttributes:(id)arg1 styleManager:(shared_ptr_a3c46825)arg2 contentScale:(double)arg3 size:(long long)arg4 customIconID:(unsigned long long)arg5 transparent:(_Bool)arg6;
- (id)iconForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 contentScale:(double)arg3 size:(long long)arg4 customIconID:(unsigned long long)arg5 transparent:(_Bool)arg6 transitMode:(_Bool)arg7 interactive:(_Bool)arg8;
- (id)_artworkForStyleAttributes:(id)arg1 iconStyleDescriptor:(struct VKIconStyleDescriptor)arg2 contentScale:(double)arg3 size:(long long)arg4 customIconID:(unsigned long long)arg5 transparent:(_Bool)arg6;
- (id)imageForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 iconText:(const char *)arg3 contentScale:(double)arg4 size:(long long)arg5 customIconID:(unsigned long long)arg6 transparent:(_Bool)arg7 transitMode:(_Bool)arg8 interactive:(_Bool)arg9 navMode:(_Bool)arg10;
- (id)imageForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 contentScale:(double)arg3 size:(long long)arg4 customIconID:(unsigned long long)arg5 transparent:(_Bool)arg6 transitMode:(_Bool)arg7 interactive:(_Bool)arg8 navMode:(_Bool)arg9;
...
- (_Bool)_getIconStyleDescriptorForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 contentScale:(double)arg3 iconStyleDescriptor:(struct VKIconStyleDescriptor *)arg4 transitMode:(_Bool)arg5 interactive:(_Bool)arg6 navMode:(_Bool)arg7;
- (_Bool)_getIconStyleDescriptorForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 contentScale:(double)arg3 iconStyleDescriptor:(struct VKIconStyleDescriptor *)arg4 transitMode:(_Bool)arg5;
- (_Bool)_getIconStyleDescriptorForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 contentScale:(double)arg3 iconStyleDescriptor:(struct VKIconStyleDescriptor *)arg4;
