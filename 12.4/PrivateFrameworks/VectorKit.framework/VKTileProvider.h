...
@interface VKTileProvider : NSObject <VKLRUCacheDelegate, VKTileSourceClient>
{
    ...
    _Bool _finishedLoadingOptionalLayers;
    _Bool _canceled;
...
@property(readonly, nonatomic, getter=isFinishedLoadingOptionalLayers) _Bool finishedLoadingOptionalLayers; // @synthesize finishedLoadingOptionalLayers=_finishedLoadingOptionalLayers;
...
- (_Bool)checkMapTileIntegrity:(id)arg1 errors:(id)arg2;
