...
- (_Bool)_cacheParsedForecastData:(id)arg1 type:(unsigned long long)arg2 location:(id)arg3 date:(id)arg4 requestIdentifier:(id)arg5;
- (_Bool)_forecastConditionsForType:(unsigned long long)arg1 location:(id)arg2 date:(id)arg3 requestIdentifier:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
