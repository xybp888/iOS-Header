...
@interface _TVAppDocumentController : UIViewController <UIGestureRecognizerDelegate, _TVModalPresenterFocusing, _TVPagePerformanceDelegate, UIPopoverPresentationControllerDelegate, _TVIKAppDocumentDelegate, IKAppDocumentDelegate>
{
    struct {
