...
- (void)_loadSessionsFromTupleDescriptors:(id)arg1 model:(id)arg2 onlyAppleInternal:(_Bool)arg3 positiveLabel:(unsigned long long)arg4 ignoreIfSingular:(_Bool)arg5 numberOfRows:(unsigned long long)arg6 numberOfColumns:(unsigned long long)arg7 lastUsedMax:(double)arg8 block:(CDUnknownBlockType)arg9;
