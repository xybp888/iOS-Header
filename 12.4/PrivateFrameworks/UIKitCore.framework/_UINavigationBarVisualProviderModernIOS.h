...
- (void)navigationItemUpdatedSearchController:(id)arg1 oldSearchController:(id)arg2 animated:(_Bool)arg3;
- (void)navigationItemUpdatedBackgroundAppearance:(id)arg1 animated:(_Bool)arg2;
- (void)navigationItemUpdatedCanvasView:(id)arg1 animated:(_Bool)arg2;
...
- (void)navigationItemUpdatedPromptContent:(id)arg1 animated:(_Bool)arg2;
- (_Bool)_isShowingExtendedContentView;
...
- (void)_layoutInBounds:(struct CGRect)arg1 wantsExtendedContentView:(_Bool)arg2;
