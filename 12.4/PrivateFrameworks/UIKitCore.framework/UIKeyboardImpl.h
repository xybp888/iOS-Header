...
@property(nonatomic) _Bool prewarmsPredictiveCandidates; // @synthesize prewarmsPredictiveCandidates=m_prewarmsPredictiveCandidates;
...
- (void)handlePredictionViewIfNeeded:(_Bool)arg1;
