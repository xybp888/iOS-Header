...
@property(nonatomic) _Bool isKnownGood; // @synthesize isKnownGood=_isKnownGood;
@property(nonatomic) _Bool lowInternetDL; // @synthesize lowInternetDL=_lowInternetDL;
@property(nonatomic) _Bool lowInternetUL; // @synthesize lowInternetUL=_lowInternetUL;
