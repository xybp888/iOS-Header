...
@interface GEOVectorTile : NSObject
{
    ...
    CDStruct_8e575d68 *_overlapBuildingFootprints;
...
@property(readonly, nonatomic) CDStruct_6b54c102 *venues; // @synthesize venues=_venues;
...
- (void)forEachEdgeInRoad:(CDStruct_a2ef2718 *)arg1 visitTwice:(_Bool)arg2 visitor:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic) CDStruct_8e575d68 *overlapBuildingFootprints;
...
- (_Bool)_readRoadNetwork:(CDStruct_effb527d *)arg1;
...
- (_Bool)_decodeLabelTextPlacementsFromStream:(CDStruct_8bf61218 *)arg1 count:(unsigned long long)arg2 firstFeature:(CDStruct_d6359813 *)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5;
