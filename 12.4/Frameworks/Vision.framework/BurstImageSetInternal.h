...
@property _Bool enableDumpYUV; // @synthesize enableDumpYUV=_enableDumpYUV;
@property _Bool enableFaceCore; // @synthesize enableFaceCore=_enableFaceCore;
@property int dummyAnalysisCount; // @synthesize dummyAnalysisCount=_dummyAnalysisCount;
@property _Bool enableAnalysis; // @synthesize enableAnalysis=_enableAnalysis;
