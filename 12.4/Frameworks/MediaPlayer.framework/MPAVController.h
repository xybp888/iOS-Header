...
- (_Bool)changePlaybackIndexBy:(long long)arg1 deltaType:(long long)arg2 ignoreElapsedTime:(_Bool)arg3 allowSkippingUnskippableContent:(_Bool)arg4;
...
- (_Bool)changePlaybackIndexBy:(long long)arg1;
