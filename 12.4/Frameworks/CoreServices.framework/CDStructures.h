...
struct LSDatabase {
    ...
    struct LSDBImpl *_field2;
    struct __CSStore *_field3;
    struct LSSchema _field4;
};
...
struct LSSchema {
    ...
    unsigned int _field15;
    unsigned int _field16;
    struct _LSSchemaCache *_field17;
};
...
struct Store {
    id _field1;
    struct array<unsigned int, 64> _field2;
    struct atomic<long long> _field3;
    struct atomic<long long> _field4;
};
