...
- (int)activateBindings:(struct LSDatabase *)arg1 unitID:(unsigned int)arg2 bundleData:(const struct LSBundleData *)arg3;
- (struct LSBundleData)buildBundleData:(struct LSDatabase *)arg1 error:(id *)arg2;
...
- (id)_LSBundleFlagMap;
- (int)registerSchemesWhitelist:(struct LSDatabase *)arg1 bundleData:(struct LSBundleData *)arg2;
