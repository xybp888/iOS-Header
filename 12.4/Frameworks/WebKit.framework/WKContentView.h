...
- (void)_didConcludeEditDataInteraction:(Optional_bb099823)arg1;
...
- (void)_showShareSheet:(const struct ShareDataWithParsedURL *)arg1 completionHandler:(CompletionHandler_dde7f840 *)arg2;
