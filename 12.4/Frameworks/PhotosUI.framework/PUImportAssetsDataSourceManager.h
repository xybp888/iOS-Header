...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject, NSSet, PUImportAssetCollection, PUImportAssetsDataSource;
@protocol OS_dispatch_queue, PUImportAssetsDataSourceManagerDelegate;
