...
{
    _Bool _ready;
    _Bool _realtimeLocationTaggingAllowed;
    _Bool _historicLocationTaggingAllowed;
...
@property(nonatomic) _Bool realtimeLocationTaggingAllowed; // @synthesize realtimeLocationTaggingAllowed=_realtimeLocationTaggingAllowed;
