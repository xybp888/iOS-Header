...
@interface COSPreferencesAppController : UIApplication
{
    ...
    _Bool _isUpdatingInRevLock;
    BPSNTKCustomization *_ntkCustomization;
    UIWindow *_window;
    ...
    NSTimer *_idleNotificationTimer;
    ...
    unsigned long long _activationRetryCountLimit;
    unsigned long long _activationRetryCount;
...
- (void)generateURL;
- (void)presentDevicePicker:(_Bool)arg1;
...
- (void)resetActivationFailureCountAndReport:(_Bool)arg1;
...
- (void)unpairOrResetBuddyForEvent:(unsigned long long)arg1;
