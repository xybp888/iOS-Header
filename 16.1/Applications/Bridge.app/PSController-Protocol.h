...
@class MISSING_TYPE, NSBundle, NSDictionary, NSMutableArray, NSString, PSRootController, PSSearchEntry, PSSpecifier, UIViewController;
...
- (void)didLock;
- (void)suspend;
- (MISSING_TYPE *)prepareHandlingURLForSpecifierID:resourceDictionary:animatePush:withCompletion: /* Error: Ran out of types for this method. */;
@end
