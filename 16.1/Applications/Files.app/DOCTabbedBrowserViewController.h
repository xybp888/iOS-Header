...
@class DOCAutoBarHidingTabBarController, DOCFullDocumentManagerViewController, DOCSourceObserver, DOCSplitBrowserViewController, MISSING_TYPE, NSArray, NSString, _TtC5Files24DOCNamedLocationResolver, _TtC5Files25DOCDefaultSourceUIManager, _TtC5Files29DOCBrowserContainerController;
...
@interface DOCTabbedBrowserViewController : UIDocumentBrowserViewController
{
    ...
    DOCFullDocumentManagerViewController *_fullSharedViewController;
...
- (void)columViewControllerDidUpdate:(id)arg1;
...
- (MISSING_TYPE *)viewDidLayoutSubviews;
...
- (void)performGoToShared:(id)arg1;
- (void)performGoToICloudDrive:(id)arg1;
- (void)performGoToDownloads:(id)arg1;
- (void)performGoToDesktop:(id)arg1;
- (void)performGoToDocuments:(id)arg1;
- (void)performConnectToServer:(id)arg1;
- (void)performGoToEnclosingFolder:(id)arg1;
- (void)performGoToBrowse:(id)arg1;
- (void)performGoToRecents:(id)arg1;
