...
- (void)flash;
- (void)imageView:(id)arg1 requestsUpdateToInteractionMode:(unsigned long long)arg2;
- (void)imageViewDidUpdateInteraction:(id)arg1 withAnalysis:(id)arg2;
...
- (void)cropControllerDidBeginCropping:(id)arg1;
