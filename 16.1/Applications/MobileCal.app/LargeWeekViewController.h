...
@interface LargeWeekViewController
{
    ...
    _Bool _needToNotifyEnqueuedManagedNavigationController;
...
- (void)_showEditorForEvent:(id)arg1;
...
- (void)_displayEventDetailsViewControllerForSelectedEventWithOccurrenceView:(id)arg1 showComments:(_Bool)arg2 creationMethod:(id)arg3;
- (void)_displayEventDetailsViewControllerForSelectedEventWithOccurrenceView:(id)arg1 showComments:(_Bool)arg2 context:(id)arg3 forceShowEditor:(_Bool)arg4 creationMethod:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)_setSelectedEvents:(id)arg1;
...
- (void)_presentationControllerDidDismissPopover:(id)arg1 cleanSelectionState:(_Bool)arg2;
...
- (void)showEvent:(id)arg1 animated:(_Bool)arg2 showMode:(unsigned long long)arg3 context:(id)arg4 completion:(CDUnknownBlockType)arg5;
