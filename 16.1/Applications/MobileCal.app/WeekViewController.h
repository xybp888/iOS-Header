...
@interface WeekViewController
{
    ...
    _Bool _weekViewStartsOnToday;
    _Bool _preventScrollUpdates;
    ...
    NSDateIntervalFormatter *_titleIntervalDateFormatter;
    NSMutableArray *_selectedOccurrenceViews;
    NSMutableArray *_selectedOccurrencesFrontmostClonedViews;
    EKEventCreationGestureController *_eventCreationController;
...
- (unsigned long long)_dateModeForAllDay:(_Bool)arg1;
- (void)_logUserStateDiagnostics:(id)arg1;
...
- (void)_deselectOccurrenceView:(id)arg1 updatingModel:(_Bool)arg2;
- (void)_deselectOccurrenceView:(id)arg1;
- (void)_selectOccurrenceView:(id)arg1 updatingModel:(_Bool)arg2;
- (void)_selectOccurrenceView:(id)arg1;
- (void)_selectEvent:(id)arg1 updatingModel:(_Bool)arg2;
- (void)_clearSelectedOccurrenceViewsUpdatingModel:(_Bool)arg1;
- (void)_clearSelectedOccurrenceViews;
- (void)_updateSelectedViewsToMatchModel;
- (id)_selectedOccurrenceViews;
- (void)saveFirstVisibleSecond:(long long)arg1;
- (void)weekGroupViewFirstVisibleSecondChanged:(long long)arg1;
- (long long)savedFirstVisibleSecond;
...
- (void)_setHeaderHeightForWeekGroupView:(id)arg1 forceLayout:(_Bool)arg2;
...
- (id)editorForEventGestureController:(id)arg1;
...
- (void)eventGestureController:(id)arg1 didSingleTapOccurrence:(id)arg2 shouldExtendSelection:(_Bool)arg3;
...
- (void)eventGestureController:(id)arg1 adjustDraggingView:(id)arg2 forAllDay:(_Bool)arg3;
...
- (void)_highlightEvent:(id)arg1 dayViewDate:(double)arg2 isAllDay:(_Bool)arg3;
...
- (void)weekGroupViewOccurrenceLayoutDidChange:(id)arg1;
- (void)weekGroupViewDidLayout:(id)arg1;
- (void)synchronizeWeekGroupScrollingToWeek:(id)arg1;
- (void)weekGroupDidScroll:(id)arg1;
- (void)didEditEvent:(id)arg1 creationMethod:(id)arg2;
- (void)weekGroup:(id)arg1 didSelectEvent:(id)arg2 userInitiated:(_Bool)arg3;
...
- (void)selectedOccurrencesChanged:(id)arg1;
