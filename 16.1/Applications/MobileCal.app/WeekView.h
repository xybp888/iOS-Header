...
@interface WeekView : UIView
{
    ...
    struct CGRect _visibleRectToSet;
...
- (void)setScrollerContentOffset:(struct CGPoint)arg1;
...
- (void)weekAllDayView:(id)arg1 didSelectEvent:(id)arg2 userInitiated:(_Bool)arg3;
- (id)selectedEventsForEditMenu;
- (id)presentationControllerForEditMenu;
- (void)dayViewContentDidLayout:(id)arg1;
- (void)dayViewContent:(id)arg1 didSelectEvent:(id)arg2 userInitiated:(_Bool)arg3;
