...
@interface LargeMonthWeekView : UIView
{
    ...
    NSArray *_dayBadgeViews;
    UIImageView *_dayBadgeViewBesideFirstOfMonthLabel;
...
- (void)largeMonthWeekOccurrencesView:(id)arg1 selectedEvent:(id)arg2 userInitiated:(_Bool)arg3;
...
- (void)_updateBadgeAtIndex:(unsigned long long)arg1;
- (void)_updateBadges;
