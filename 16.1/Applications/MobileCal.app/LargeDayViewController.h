...
@class EKEvent, LargeDayNavigationWrapperView, MISSING_TYPE, NSString, UIView;
...
- (void)eventViewControllerModifiedEventWithoutEditing:(id)arg1;
...
- (_Bool)_showsEventViewControllerAsFullScreen:(id)arg1;
...
- (id)_clonedViewForSelectedOccurrence:(id)arg1;
...
- (MISSING_TYPE *)usePortraitLayoutForSize: /* Error: Ran out of types for this method. */;
...
- (_Bool)shouldJournalMainViewControllerParent;
...
- (_Bool)selectedEventWasAutoSelected;
@property(retain, nonatomic) EKEvent *modelSelectedEvent;
- (void)loadView;
- (void)dealloc;
- (void)updateSelectedOccurrenceViews;
