...
+ (struct CGRect)dayTypeBadgeFrameFromDayNumberFrame:(struct CGRect)arg1 compressed:(_Bool)arg2;
+ (id)dayTypeBadgeBackgroundColorForVerticallyCompressedMode:(_Bool)arg1;
...
+ (double)dayTypeBadgeDiameter:(_Bool)arg1;
...
- (void)_layoutDayTypeBadgeForDayNumber:(id)arg1 yOffset:(double)arg2;
- (void)_updateDayTypeBadgesWithBackgroundColor;
- (void)_forceReloadImagesForDayTypeBadges;
- (void)_updateDayTypeBadgeForDayNumber:(id)arg1 withDayType:(long long)arg2 color:(id)arg3 locale:(id)arg4 forceImageUpdate:(_Bool)arg5;
...
- (void)setEventData:(id)arg1 animated:(_Bool)arg2;
