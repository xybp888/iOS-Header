...
+ (double)_monthHeaderHeightForWindowSize:(struct CGSize)arg1;
- (void).cxx_destruct;
- (id)_getWeekContainingDate:(id)arg1 prevDate:(id)arg2;
- (id)_getMonthViewMonthContainingDate:(id)arg1 hideMonthLabel:(_Bool)arg2;
...
- (void)prepareWithYearViewController:(id)arg1 monthViewController:(id)arg2 selectedDate:(id)arg3 calendar:(id)arg4 yearToMonth:(_Bool)arg5 paletteView:(id)arg6;
