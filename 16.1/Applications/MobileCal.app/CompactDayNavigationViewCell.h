...
@interface CompactDayNavigationViewCell
{
    ...
    _Bool _applyMonthAnimationStateAdjustments;
    _Bool _hasOverlay;
    ...
    UIImageView *_dayBadge;
    UIImageView *_monthAnimationStateDayBadge;
...
- (void)_updateMonthAnimationStateBadgeToState:(_Bool)arg1;
