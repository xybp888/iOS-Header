...
- (_Bool)upgraded;
- (_Bool)upgradedToSydneyRomeKincaid;
- (_Bool)upgradedTo2019OSes;
- (_Bool)upgradedToMajor:(int)arg1 minor:(int)arg2;
- (_Bool)isHardwareInfoUpgradableToSydneyRomeKincaid:(struct ICDeviceHardwareInfo)arg1;
- (_Bool)upgradableToSydneyRomeKincaid;
