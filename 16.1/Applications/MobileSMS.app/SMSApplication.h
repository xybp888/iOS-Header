...
@interface SMSApplication : UIApplication
{
    ...
    NSDictionary *_pendingAppleEventInfoDictionary;
    SHKMessagesLaunchEventContext *_pendingLaunchEventContext;
...
+ (id)addMessagesFileProviderDomain:(id *)arg1;
+ (id)logHandle;
- (void).cxx_destruct;
...
- (void)_registerForAppleEventsIfNecessary;
...
- (_Bool)isFromFilteredSender:(id)arg1 fromSender:(id)arg2;
...
- (void)dealloc;
- (void)applicationWillHandleReopen:(id)arg1;
...
- (id)extractValueFromURL:(id)arg1 forKey:(id)arg2;
- (void)_application:(id)arg1 handleSiriTask:(id)arg2;
- (id)init;
- (void)_clearFailureBadge;
- (id)logHandle;
- (void)startTranscriptOnlyScreenshotTestwithOptions:(id)arg1;
- (void)startScreenshotTestWithOptions:(id)arg1;
...
- (void)startMacFullscreenTestWithOptions:(id)arg1;
- (void)startMacActivateTestWithOptions:(id)arg1;
- (void)startMacResizeTestWithOptions:(id)arg1;
- (void)startResizeTestWithOptions:(id)arg1;
...
- (_Bool)isNewConversationList;
- (_Bool)isOldConversationList;
...
- (struct CGRect)windowBoundsForScrollView:(id)arg1;
