...
@interface PreferencesAppController : UIApplication
{
    ...
    NSRegularExpression *__uuidRegex;
}
...
- (void)generateURL;
- (void)processOtpauthURL:(id)arg1;
- (void)processTVProviderPrefsURL:(id)arg1;
- (void)processPrebuddyURL:(id)arg1;
...
- (void)processStateRestorationURL;
