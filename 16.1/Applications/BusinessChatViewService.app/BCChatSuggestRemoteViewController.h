...
@interface BCChatSuggestRemoteViewController : SBUIRemoteAlertServiceViewController
{
    ...
    id <BCDeviceStateProtocol> _deviceState;
    id <BCPresenterProtocol> _presenter;
...
- (void)brandedHeaderViewController:(id)arg1 logoFetchingDidFinishForBusinessItem:(id)arg2 success:(_Bool)arg3;
- (void)brandedHeaderViewController:(id)arg1 logoFetchingWillBeginForBusinessItem:(id)arg2;
...
- (void)viewDidLoad;
- (id)initWithDeviceState:(id)arg1 presenter:(id)arg2;
- (id)init;
