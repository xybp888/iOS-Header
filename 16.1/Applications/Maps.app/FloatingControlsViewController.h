...
{
    _Bool _isConfigured;
    _Bool _automaticallyUpdateCompassInsets;
    _Bool _hasReceivedLocationUpdate;
    _Bool _visible;
    long long _settingsTipState;
    ...
    id <FloatingControlsViewControllerOpenSettingsDelegate> _openSettingsDelegate;
...
- (void)_updateAlphaAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
