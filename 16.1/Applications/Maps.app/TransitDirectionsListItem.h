...
@class GEOComposedRouteStep, MISSING_TYPE, MNTransitInstruction, NSArray, UIColor, UIImage;
...
+ (long long)defaultInstructionContextForItemType:(long long)arg1 forGuidance:(_Bool)arg2;
- (void).cxx_destruct;
