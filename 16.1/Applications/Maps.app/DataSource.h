...
- (int)flattenedIndexWithIndexPath:(id)arg1;
- (void)sendAnalyticsForDataAtIndexPath:(id)arg1 object:(id)arg2 childPlaceIndexPath:(id)arg3 childPlaceObject:(id)arg4 action:(int)arg5 eventValue:(id)arg6 populateSearchTapEvent:(_Bool)arg7;
...
- (void)sendAnalyticsForDataAtIndexPath:(id)arg1 object:(id)arg2 action:(int)arg3 populateSearchTapEvent:(_Bool)arg4;
...
- (void)commonInitWithUpdateLocation:(_Bool)arg1;
