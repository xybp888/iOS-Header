...
@class ChildItemsViewModel, MISSING_TYPE, MKLocalSearchCompletion, NSArray, NSString, UIImageView, _SearchResultChildItemGridView;
...
- (void)addTransitLabelWithFirstPartDetailString:(id)arg1 secondPartDetailString:(id)arg2;
