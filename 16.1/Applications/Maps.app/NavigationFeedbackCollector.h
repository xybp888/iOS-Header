...
@interface NavigationFeedbackCollector : NSObject
{
    ...
    _Bool _outOfRangeDodgeballDisplayed;
    _Bool _batteryDied;
...
- (void)_completeCurrentStepFeedback:(_Bool)arg1;
...
- (void)_runAsyncBlockOnLocalQueueIfNotSuppressed:(CDUnknownBlockType)arg1;
...
- (void)_captureArrivalAtWaypoint:(id)arg1;
...
- (void)offeredRerouteWithMoreChargingStationsWasAccepted:(_Bool)arg1;
...
- (void)_captureVirtualGarageAnalytics:(id)arg1;
