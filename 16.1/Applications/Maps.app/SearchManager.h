...
- (_Bool)_shouldEnableRAPForNoResultsWithError:(id)arg1;
- (void)_searchReceivedResults:(id)arg1;
- (void)_searchCanceled;
- (void)_searchFailedWithError:(id)arg1 resultRefinementGroup:(id)arg2 enableStructuredRAPAffordance:(_Bool)arg3;
...
- (void)_searchForHistoryItem:(id)arg1 completedQuery:(id)arg2 traits:(id)arg3 source:(int)arg4 isRedoOrAutoRedoSearch:(_Bool)arg5;
...
- (void)_submitTicketForSearchForCategory:(id)arg1 searchQuery:(id)arg2 completionItem:(id)arg3 traits:(id)arg4 defaultSearchResultType:(unsigned int)arg5 source:(int)arg6 maxResults:(unsigned int)arg7;
- (void)_searchForCategory:(id)arg1 traits:(id)arg2 defaultSearchResultType:(unsigned int)arg3 source:(int)arg4 maxResults:(unsigned int)arg5;
...
- (void)searchForSearchFieldItem:(id)arg1 traits:(id)arg2 source:(int)arg3 isRedoOrAutoRedoSearch:(_Bool)arg4;
- (void)_submitSearchTicket:(id)arg1 defaultSearchResultType:(unsigned int)arg2 saveToHistory:(_Bool)arg3 origin:(long long)arg4 completionTitle:(id)arg5;
