...
@interface StepContainerViewController
{
    ...
    _Bool _userTrackingViewVisible;
    NSDateComponentsFormatter *_debugMinsDurationFormatter;
    NSDateComponentsFormatter *_debugHoursDurationFormatter;
    Route *_route;
...
- (_Bool)showStatusBarBackgroundViewUnderDimmingView;
...
- (void)setUserTrackingViewVisible:(_Bool)arg1 animated:(_Bool)arg2;
