...
@interface StepActionCoordinator : NSObject
{
    ...
    NavTrayViewController *_trayContaineeViewController;
    ...
    RouteStepListViewController *_directionsStepsViewController;
...
- (_Bool)canSelectVKLabelMarker:(id)arg1;
...
- (void)viewController:(id)arg1 showOverview:(_Bool)arg2 zoomToMapRegion:(_Bool)arg3;
