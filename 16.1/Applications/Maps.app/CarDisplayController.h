...
@interface CarDisplayController : NSObject
{
    ...
    _Bool _shouldOverrideMapTypeToStandard;
    int _lastMapTypeFromiOSChrome;
    MapsSuggestionsDonater *_donater;
    MapsSuggestionsMutableSignalPack *_signalPack;
    NSObject<OS_dispatch_queue> *_signalPackQueue;
...
- (_Bool)hasMapsSuggestionsController;
- (_Bool)_activelyOnScreen:(id *)arg1;
...
- (void)updateMapsSuggestionsSignalForMapType:(int)arg1;
- (void)_sendMapsSuggestionsSignals;
- (void)updateForCurrentEnablingState;
- (void)_externalNavigationOwnershipUpdated:(id)arg1;
