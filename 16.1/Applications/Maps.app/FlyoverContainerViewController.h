...
@class FlyoverActionCoordinator, FlyoverBannerView, FlyoverStatusView, MKMapItem, NSMutableDictionary, NSString, NSTimer, UILabel;
...
- (id)mapView;
// Error: Property attributes should begin with the type ('T') attribute, property name: passThroughView
