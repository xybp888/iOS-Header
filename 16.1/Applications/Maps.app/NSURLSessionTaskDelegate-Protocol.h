...
@class MISSING_TYPE, NSError, NSHTTPURLResponse, NSURLAuthenticationChallenge, NSURLRequest, NSURLSession, NSURLSessionTask, NSURLSessionTaskMetrics;
...
- (MISSING_TYPE *)URLSession:didCreateTask: /* Error: Ran out of types for this method. */;
@end
