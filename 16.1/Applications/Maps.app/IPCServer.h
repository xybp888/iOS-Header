...
@interface IPCServer : NSObject
{
    ...
    _Bool _hasCheckedNotificationSettingsForManeuver;
    _Bool _isPersistentDisplay;
    _Bool _isStickySignal;
    _Bool _spokenEventProcessing;
    _Bool _isRerouting;
    ...
    NSTimer *_waitingForKeyScenePollTimer;
    ...
    IPCLoadDirectionsMessage *_pendingLoadDirectionsMessage;
    unsigned long long _keyScenePollCount;
    MNTransitAlert *_alightAlert;
    _Bool _hasPendingAlight;
    _Bool _shownWeakLocationAlert;
    _Bool _hasPendingWeakLocationAlert;
    NSMapTable *_occlusionStates;
    _Bool _etaOnlyNavMode;
    _Bool _routePreviewGuidanceNavMode;
    _Bool _needsGuidanceUpdate;
    int _maneuver;
    int _transportType;
...
- (void)navigationService:(id)arg1 didReceiveRouteSignalStrength:(unsigned long long)arg2;
...
- (void)_checkKeyScene;
- (void)_startWaitingToHandleMessage:(id)arg1;
...
- (void)_sendWeakLocationNotificationIfNeededWithGuidanceState:(id)arg1;
- (void)_pushGuidanceStateIfChangedWithVibration:(_Bool)arg1;
...
- (_Bool)_isAnySceneForegroundAndNotOccludedForRole:(id)arg1;
- (_Bool)_isMapsForegroundOnCarPlay;
- (_Bool)_isMapsForegroundOnMainWindow;
