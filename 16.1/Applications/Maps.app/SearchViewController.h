...
@interface SearchViewController
{
    ...
    _Bool _userSelectedSearchBar;
    _Bool _didPresentPopover;
    double _isTouristHereValue;
    double _cachedMediumHeight;
    _Bool _searchFieldWantsFocus;
...
- (void)_updateHeaderHairlineAlphaWithContentAlpha:(double)arg1 animated:(_Bool)arg2;
...
- (void)homeDidTapOnCuratedGuides:(id)arg1;
- (void)homeDidTapOnCuratedGuide:(id)arg1;
- (void)homeDidTapOnUserGeneratedGuide:(id)arg1;
...
- (void)showGuidesHomeFromExploreGuides:(id)arg1;
...
- (void)fetchMapItemWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (_Bool)shouldInjectVenueSearchResult:(id)arg1;
...
- (void)_updateDefaultLayoutWithContainerStyle:(unsigned long long)arg1;
...
- (void)showTitleBarSeparatorWhenScrolling:(_Bool)arg1;
- (void)_updateSearchFieldWithItem:(id)arg1 updatingSearchText:(_Bool)arg2;
