...
- (_Bool)shouldRejectTagID:(id)arg1 withAggregate:(id)arg2 baseline:(id)arg3 currentDate:(id)arg4 addedDate:(id)arg5 maxIdleTime:(double)arg6 minEvents:(double)arg7 minRate:(double)arg8 baseRate:(double)arg9 multiplier:(double)arg10;
...
- (double)metricMultiplierForTagID:(id)arg1 withPriorFactorExponent:(double)arg2 tagFavorabilityExponent:(double)arg3;
