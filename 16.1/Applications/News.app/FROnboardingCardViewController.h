...
{
    struct multimap<float, FROnboardingSubscribableItem *, std::less<float>, std::allocator<std::pair<const float, FROnboardingSubscribableItem *>>> yToSubscribableItems;
    _Bool _eventRecordingDisabled;
    _Bool _initialLayoutMode;
    ...
    UIColor *_currentSystemBackgroundColor;
    FCMapTable *_subscribableItemsToOnScreenCells;
...
- (void)_setBlurred:(_Bool)arg1 animated:(_Bool)arg2 duration:(double)arg3;
...
- (void)checkIfCloseToBottomRespectingTimer:(_Bool)arg1;
...
- (void)_selectItem:(id)arg1 animated:(_Bool)arg2;
- (_Bool)_cellAlreadyHasSelectionAnimatorRunning:(id)arg1;
- (id)_selectionAnimatorForCell:(id)arg1;
- (void)_undimpleCell:(id)arg1;
- (void)_dimpleCell:(id)arg1 quickPress:(_Bool)arg2;
- (void)_dimpleCell:(id)arg1;
- (void)selectionGestureFired:(id)arg1;
- (void)_setLayout:(id)arg1 clearCells:(_Bool)arg2;
...
- (void)setItem:(id)arg1 selected:(_Bool)arg2 animated:(_Bool)arg3;
...
- (void)setBlurred:(_Bool)arg1 animated:(_Bool)arg2 duration:(double)arg3;
- (void)setBlurred:(_Bool)arg1 animated:(_Bool)arg2;
- (void)setBlurred:(_Bool)arg1;
- (void)setBottomSpinnerHidden:(_Bool)arg1 animated:(_Bool)arg2;
