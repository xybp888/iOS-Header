...
@class INIntent, MISSING_TYPE, NSArray, NSCoder, NSData, NSDictionary, NSError, NSSet, NSString, NSURL, NSUserActivity, UIApplication, UIApplicationShortcutItem, UILocalNotification, UISceneConfiguration, UISceneConnectionOptions, UISceneSession, UIUserNotificationSettings, UIViewController, UIWindow;
...
- (MISSING_TYPE *)application:userDidAcceptCloudKitShareWithMetadata: /* Error: Ran out of types for this method. */;
