...
@class AFConversation, AFDialogPhase, AceObject, NSArray, NSIndexPath, NSString, NSURL, NSUUID, SAUIListItem, SRUIFSiriSessionInfo;
...
- (SRUIFSiriSessionInfo *)sessionInfoForSiriPresentation:(id <SiriUIPresentation>)arg1;
...
- (long long)siriPresentationStateForSiriPresentation:(id <SiriUIPresentation>)arg1;
