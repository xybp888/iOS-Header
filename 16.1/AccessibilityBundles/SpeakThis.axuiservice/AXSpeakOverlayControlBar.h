...
@class AXSpeakScreenButton, NSArray, SpeakThisUIStateManager, UIActivityIndicatorView, UILabel, UILongPressGestureRecognizer, UITapGestureRecognizer;
...
- (id)_squareButtons;
- (id)_buttons;
- (void)updateForTabModeChangeUsingSpeakFingerButton:(_Bool)arg1;
