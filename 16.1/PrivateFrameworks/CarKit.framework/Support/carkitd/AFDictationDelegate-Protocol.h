...
@class AFDictationConnection, AFDictationNLUResult, AFDictationOptions, AFSpeechPackage, MISSING_TYPE, NSArray, NSDictionary, NSError, NSFileHandle, NSString, SASMultilingualSpeechRecognized, SASSpeechPartialResult;
...
- (MISSING_TYPE *)dictationConnection:speechRecordingDidFail: /* Error: Ran out of types for this method. */;
