...
@property(retain, nonatomic) NSURL *infoResponseURL; // @synthesize infoResponseURL=_infoResponseURL;
...
- (id)initWithDeviceScreenshot:(id)arg1 carScreenshot:(id)arg2 configuration:(id)arg3 attachmentURLs:(id)arg4 siriInfo:(id)arg5 activeBundleID:(id)arg6 transportType:(unsigned long long)arg7 infoResponseURL:(id)arg8;
