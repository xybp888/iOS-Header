...
+ (MISSING_TYPE *)_sendSoftwareManifest:withReason: /* Error: Ran out of types for this method. */;
...
+ (void)sendActivitySubscriptionEntitlementsWithDictionary:(id)arg1 forAccountID:(id)arg2;
