...
@interface DisplayPaymentSheetOperation : ISOperation
{
    ...
    long long _tintArrayIndex;
    struct __CFArray *_tintArrayRef;
...
- (struct CGImage *)_createImageRefWithURL:(id)arg1 adornmentStyle:(long long)arg2 designVersion:(id)arg3;
- (struct CGImage *)_createImageMaskRefWithSize:(struct CGSize)arg1 andPath:(struct CGPath *)arg2;
- (struct CGPath *)_createBorderPathForAdornmentStyle:(long long)arg1 iconWidth:(double)arg2 iconHeight:(double)arg3 designVersion:(id)arg4;
