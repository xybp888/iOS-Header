...
- (id)_recordEngagementEventWithResult:(id)arg1 error:(id)arg2;
...
- (id)_account;
- (void)sender:(id)arg1 willSendChallenge:(id)arg2 andSignature:(id)arg3 andPaymentTokenData:(id)arg4 andFpanID:(id)arg5 isExtendedAction:(_Bool)arg6 isPayment:(_Bool)arg7 additionalHeaders:(id)arg8;
