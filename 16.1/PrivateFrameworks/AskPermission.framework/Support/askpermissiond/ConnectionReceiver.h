...
- (void)getRequestWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)checkDownloadQueueWithContentType:(long long)arg1 completion:(CDUnknownBlockType)arg2;
