...
@class BLDatabaseManager, MISSING_TYPE, NSArray, NSFetchedResultsController, NSMutableDictionary, NSOperationQueue, NSString;
@protocol BLBookInstallManagerProgressDelegate, OS_dispatch_queue;

@interface BLBookInstallManager : NSObject
{
