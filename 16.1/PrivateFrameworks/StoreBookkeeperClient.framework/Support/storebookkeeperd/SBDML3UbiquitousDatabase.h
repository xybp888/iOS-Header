...
- (id)readUbiquitousDatabaseMetadataValuesWithClientIdentity:(id)arg1 identifiers:(id)arg2;
- (id)readUbiquitousDatabaseMetadataValuesWithClientIdentity:(id)arg1 identifier:(id)arg2;
- (void)updateUbiquitousDatabaseByResetingSyncEntityRevisionForItemsWithMetadataIdentifiers:(id)arg1;
- (void)updateMusicLibraryWithClientIdentity:(id)arg1 applyUbiquitousBookmarkMetadataToTrackWithPersistentID:(long long)arg2;
- (void)updateUbiquitousDatabaseWithClientIdentity:(id)arg1 removeUbiquitousMetadataFromTrackWithPersistentID:(long long)arg2;
- (_Bool)_databaseHasEntryForEntity:(id)arg1;
- (_Bool)updateUbiquitousDatabaseWithClientIdentity:(id)arg1 persistUbiquitousMetadataWithEntity:(id)arg2;
