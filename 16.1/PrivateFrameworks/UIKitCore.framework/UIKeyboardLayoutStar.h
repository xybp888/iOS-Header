...
+ (id)keyboardFromFactoryWithName:(id)arg1 screenTraits:(id)arg2;
...
- (void)touchDownWithKey:(id)arg1 withTouchInfo:(id)arg2 atPoint:(struct CGPoint)arg3 executionContext:(id)arg4;
...
- (void)fadeActivationIndicatorWithDuration:(double)arg1 withDelay:(double)arg2;
...
- (void)playKeyFeedbackIfNecessaryForTouchDownOnKey:(id)arg1 touchInfo:(id)arg2;
...
- (void)showKeyboardWithInputMode:(id)arg1 renderConfig:(id)arg2 inputTraits:(id)arg3 screenTraits:(id)arg4 splitTraits:(id)arg5 reload:(_Bool)arg6;
...
- (void)updateStateForKey:(id)arg1;
- (void)updateAllKeyStates;
- (void)createLayoutFromName:(id)arg1;
...
- (_Bool)_allowStartingContinuousPathForTouchInfo:(id)arg1 alreadyActiveKeyExisting:(_Bool)arg2;
...
- (void)setTrackpadMode:(_Bool)arg1 animated:(_Bool)arg2;
...
- (void)setRenderConfig:(id)arg1 updateKeyplane:(_Bool)arg2;
