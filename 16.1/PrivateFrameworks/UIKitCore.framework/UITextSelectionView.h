...
- (void)_setCaretBlinkAnimationEnabled:(_Bool)arg1;
...
- (_Bool)updateCalloutBarRects:(id)arg1 effectsWindow:(id)arg2 arrowDirection:(long long)arg3 replacements:(id)arg4;
