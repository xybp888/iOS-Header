...
- (id)initWithString:(id)arg1 score:(double)arg2 rotation:(double)arg3 upperLeftPoint:(struct CGPoint)arg4 upperRightPoint:(struct CGPoint)arg5 lowerLeftPoint:(struct CGPoint)arg6 lowerRightPoint:(struct CGPoint)arg7 size:(struct CGSize)arg8;
