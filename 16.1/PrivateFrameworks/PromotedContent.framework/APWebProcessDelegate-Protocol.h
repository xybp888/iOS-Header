...
@optional
- (void)webProcessDiagnosticJSOStatusReported:(NSString *)arg1 status:(NSString *)arg2;
...
- (void)webProcessMRAIDJSODidCallExpand:(NSURL *)arg1 withMaximumWidth:(double)arg2 andHeight:(double)arg3;
