...
@interface LabelNavRouteLabeler : NSObject
{
    ...
    struct unordered_set<std::shared_ptr<md::LabelTile>, std::hash<std::shared_ptr<md::LabelTile>>, std::equal_to<std::shared_ptr<md::LabelTile>>, geo::StdAllocator<std::shared_ptr<md::LabelTile>, mdm::Allocator>> _pendingTiles;
    NSMutableArray *_junctions;
    VKLabelNavRoadGraph *_roadGraph;
    struct vector<std::shared_ptr<md::NavLabel>, geo::StdAllocator<std::shared_ptr<md::NavLabel>, mdm::Allocator>> _activeSigns;
    struct vector<std::shared_ptr<md::NavLabel>, geo::StdAllocator<std::shared_ptr<md::NavLabel>, mdm::Allocator>> _visibleSigns;
...
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;
...
- (_Bool)_addJunctionsForTile:(const void *)arg1;
...
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;
...
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;
