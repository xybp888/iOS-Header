...
- (CDUnknownBlockType)authorizationRequestCallbackForRouteID:(id)arg1;
- (void)removeAuthorizationCallbackForRouteID:(id)arg1;
- (void)addAuthorizationCallbackForRouteID:(id)arg1 requestCallback:(CDUnknownBlockType)arg2;
