...
@interface MRDAVRoutingServer : NSObject
{
    ...
    MRDAVLocalDeviceCommitManager *_localDeviceCommitManager;
    MRDIdleTopologySimplifier *_topologySimplifier;
...
- (void)_createEndpointForOutputDeviceIDsLegacy:(id)arg1 options:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)createHostedEndpointForOutputDeviceUIDs:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_createEndpointForOutputDeviceIDs:(id)arg1 options:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_handleClusterErrorStatus:(int)arg1 forRoute:(id)arg2;
...
- (void)_handleWillStartPlayingInterruptMessage:(id)arg1 fromClient:(id)arg2;
- (void)_handleModifyOutputContextMessage:(id)arg1 fromClient:(id)arg2;
...
- (void)_handleCreateHostedEndpointForDevices:(id)arg1 fromClient:(id)arg2;
...
- (void)_handleMigrateFromEndpointToEndpointMessage:(id)arg1 fromClient:(id)arg2;
- (void)_handleMigrateFromEndpointToOutputDevicesMessage:(id)arg1 fromClient:(id)arg2;
- (void)_handleGetOutputContextUIDMessage:(id)arg1 fromClient:(id)arg2;
- (void)_handleStopNowPlayingSession:(id)arg1 fromClient:(id)arg2;
- (void)_handleStartNowPlayingSession:(id)arg1 fromClient:(id)arg2;
...
- (void)dealloc;
- (id)initWithRoutingDataSource:(id)arg1 hostedRoutingService:(id)arg2 systemEndpointController:(id)arg3 autoConnectionController:(id)arg4 homeServer:(id)arg5 avOutputDeviceAuthorizationSession:(id)arg6;
