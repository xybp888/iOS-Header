...
@interface ACXServerInstallOperation : NSObject
{
    ...
    NSURL *_appURL;
    long long _appSize;
    MISSING_TYPE *_socketManager;
}

+ (id)installOperationForURL:(id)arg1 watchAppBundleIdentifier:(id)arg2 companionAppBundleID:(id)arg3 isPlaceholder:(_Bool)arg4 size:(long long)arg5 targetUsesLegacySocketService:(_Bool)arg6;
+ (id)installOperationForCompanionAppBundleIdentifier:(id)arg1 watchAppBundleIdentifier:(id)arg2 targetUsesLegacySocketService:(_Bool)arg3;
- (void).cxx_destruct;
...
- (void)dealloc;
- (id)initWithWatchAppBundleID:(id)arg1 companionAppBundleID:(id)arg2 isPlaceholder:(_Bool)arg3 appURL:(id)arg4 size:(long long)arg5 targetUsesLegacySocketService:(_Bool)arg6;
- (id)initWithCompanionBundleID:(id)arg1 watchAppBundleID:(id)arg2 targetUsesLegacySocketService:(_Bool)arg3;
