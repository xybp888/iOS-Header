...
@interface ACXRemoteAppList : NSObject
{
    ...
    NSObject<OS_dispatch_source> *_resyncThrottleTimer;
    id <ACXRemoteAppListCommunications> _delegate;
    NSObject<OS_dispatch_queue> *_delegateQueue;
    NSDictionary *_appInstallRecordsToFetch;
    NSSet *_bundleIDsToFetch;
    NSMutableSet *_observers;
    NSMutableDictionary *_attemptsPerBundleID;
    unsigned long long _resyncAttempts;
}
...
- (void)reportTotalSyncFailureForError:(id)arg1;
