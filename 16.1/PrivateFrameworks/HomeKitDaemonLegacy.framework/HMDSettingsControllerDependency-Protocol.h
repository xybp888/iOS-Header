...
@protocol HMDSettingGroupModelProtocol, HMDSettingModelProtocol, HMDSettingTransactionReceiverProtocol, HMDSettingsBackingStoreController, HMDSettingsMessageHandlerProtocol, HMDSettingsMetadataParserProtocol, HMDUserSettingsInitialValueProviding;
...
@property(readonly) __weak id <HMDUserSettingsInitialValueProviding> migrationProvider;
