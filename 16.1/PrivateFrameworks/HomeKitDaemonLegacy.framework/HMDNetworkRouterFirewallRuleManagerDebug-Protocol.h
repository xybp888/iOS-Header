...
- (void)dumpPairedMetadataForProductGroup:(NSString *)arg1 productNumber:(NSString *)arg2 firmwareVersion:(HMFVersion *)arg3 ignoreOverrides:(_Bool)arg4 rawOutput:(_Bool)arg5 completion:(void (^)(NSError *, NSString *))arg6;
...
- (void)dumpCloudRecordsForProductGroup:(NSString *)arg1 productNumber:(NSString *)arg2 rawOutput:(_Bool)arg3 verifySignatures:(_Bool)arg4 completion:(void (^)(NSError *, NSString *))arg5;
