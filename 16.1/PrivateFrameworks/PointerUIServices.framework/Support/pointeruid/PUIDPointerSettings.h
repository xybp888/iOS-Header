...
@interface PUIDPointerSettings : PTSettings
{
    ...
    _Bool _pointerSlipEnabled;
    _Bool _allowPositionToPositionAnimations;
    ...
    double _flexibleRectIntensityReductionRange;
    double _minFlexibleRectLightLuminanceIntensity;
    double _minFlexibleRectDarkLuminanceIntensity;
    double _positionToPositionAnimationThreshold;
    SBFFluidBehaviorSettings *_pointerAccessoryAnimationSettings;
}
