...
- (void)updateVideoBuffer:(struct __CVBuffer *)arg1 withPresentationTime:(CDStruct_1b6d18a9)arg2 sampleBufferCopy:(struct opaqueCMSampleBuffer *)arg3 cameraStatusBits:(unsigned char)arg4 timestamp:(unsigned int)arg5;
