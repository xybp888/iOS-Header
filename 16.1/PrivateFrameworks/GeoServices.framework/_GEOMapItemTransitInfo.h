...
- (id)_departureSequencesForSystem:(id)arg1 excludingIncidentEntities:(id)arg2 container:(id)arg3 validForDateFromBlock:(CDUnknownBlockType)arg4;
...
- (id)initWithTransitInfo:(id)arg1 schedule:(id)arg2 timeZone:(id)arg3 incidents:(id)arg4 hasTransitIncidentComponent:(_Bool)arg5 incidentExpirationDate:(id)arg6 providerID:(int)arg7 coordinate:(CDStruct_c3b9c2ee)arg8 transitStops:(id)arg9 composedRoute:(id)arg10 nearbySchedule:(id)arg11;
