...
@interface DRDataTransferSession : NSObject
{
    ...
    _Bool _destinationIsAnotherDevice;
...
- (void)_setupItem:(id)arg1 forLoadingFromSourceItem:(id)arg2 destinationBundleID:(id)arg3 destinationAuditToken:(CDStruct_4c969caf)arg4 destinationIsSameTeam:(_Bool)arg5 destinationIsSameProcess:(_Bool)arg6 destinationIsAppleProcess:(_Bool)arg7 destinationIsAnotherDevice:(_Bool)arg8;
