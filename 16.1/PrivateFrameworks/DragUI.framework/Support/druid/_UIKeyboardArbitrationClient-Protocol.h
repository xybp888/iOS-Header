...
@class FBSSceneIdentityToken, MISSING_TYPE, NSDictionary, NSString, _UIKeyboardChangedInformation;

@protocol _UIKeyboardArbitrationClient
- (MISSING_TYPE *)queue_keyboardUIDidChange:onComplete: /* Error: Ran out of types for this method. */;
