...
@interface FTKeywordFinderResponse : NSObject
{
    ...
    NSData *_data;
    const struct KeywordFinderResponse *_root;
}
...
- (id)initWithFlatbuffData:(id)arg1 root:(const struct KeywordFinderResponse *)arg2 verify:(_Bool)arg3;
- (id)initWithFlatbuffData:(id)arg1 root:(const struct KeywordFinderResponse *)arg2;
