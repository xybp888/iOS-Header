...
@interface FTTtsTextToSpeechStreamingMessage : NSObject
{
    ...
    NSData *_data;
    const struct TtsTextToSpeechStreamingMessage *_root;
}
...
- (void).cxx_destruct;
- (id)flatbuffData;
- (Offset_6cadd334)addObjectToBuffer:(void *)arg1;
...
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TtsTextToSpeechStreamingMessage *)arg2 verify:(_Bool)arg3;
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TtsTextToSpeechStreamingMessage *)arg2;
