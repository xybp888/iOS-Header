...
- (id)hf_accessoryRepresentableUsageCountsByRoomWithFilter:(CDUnknownBlockType)arg1;
- (id)hf_shortcutsComponentActionSetWithActions:(id)arg1;
- (_Bool)hf_canUpdateToHH2;
- (_Bool)hf_hasFavorites;
- (id)hf_setShowPredictedScenesOnDashboard:(_Bool)arg1;
- (_Bool)hf_showPredictedScenesOnDashboard;
- (id)hf_partnerEcosystemAccessoryUUIDMapFuture;
...
- (_Bool)hf_hasAtleastOneOasisEnabledHomePod;
...
- (id)hf_setHomeHasMigratedForRedesign:(_Bool)arg1;
- (_Bool)hf_homeHasMigratedForRedesign;
...
- (CDUnknownBlockType)hf_dashboardSectionReorderableHomeKitObjectComparator;
- (CDUnknownBlockType)hf_dashboardSectionReorderableItemComparator;
- (CDUnknownBlockType)hf_dashboardSectionReorderableUUIDStringComparator;
- (id)hf_reorderableDashboardSectionList;
- (CDUnknownBlockType)hf_accessoryCategoriesReorderableItemComparator;
...
- (id)hf_setPhotosLibrarySettingsForUser:(id)arg1 importPhotosLibraryEnabled:(_Bool)arg2 shareFacesEnabled:(_Bool)arg3;
- (id)hf_setSharePhotosLibraryEnabled:(_Bool)arg1 forUser:(id)arg2;
- (id)hf_setImportPhotosLibraryEnabled:(_Bool)arg1 forUser:(id)arg2;
...
- (_Bool)hf_userIsOwner:(id)arg1;
- (_Bool)hf_userIsAdministrator:(id)arg1;
...
- (id)_hf_accessoryTopics:(_Bool)arg1;
