...
- (id)i_topicNumberHintsAfterPageIndex:(unsigned long long)arg1;
...
- (void)performBlockForExport:(CDUnknownBlockType)arg1;
...
- (id)topicNumbersForStorage:(id)arg1;
- (id)textWrapper;
- (void)p_processBodyLayoutInvalidation;
- (void)layoutManagerNeedsLayout:(id)arg1;
- (_Bool)caresAboutStorageChanges;
- (void)removePaginationObserver:(id)arg1;
- (void)addPaginationObserver:(id)arg1;
...
- (id)sectionTemplateDrawableProviderForPageIndex:(unsigned long long)arg1;
