...
- (id)eliminateLargestCommonSubexpression:(id)arg1 withSymbolTable:(void *)arg2 newIdentifierOut:(id *)arg3;
- (id)p_eliminateLargestCommonSubexpressionWithLCA:(id)arg1 expressions:(id)arg2 withSymbolTable:(void *)arg3 newIdentifierOut:(id *)arg4;
- (id)lowestCommonAncestor:(id)arg1;
- (id)eliminateLargestCommonSubexpressionWithSymbolTable:(void *)arg1 newIdentifierOut:(id *)arg2;
- (_Bool)canEliminateLargestCommonSubexpressionWithSymbolTable:(void *)arg1;
