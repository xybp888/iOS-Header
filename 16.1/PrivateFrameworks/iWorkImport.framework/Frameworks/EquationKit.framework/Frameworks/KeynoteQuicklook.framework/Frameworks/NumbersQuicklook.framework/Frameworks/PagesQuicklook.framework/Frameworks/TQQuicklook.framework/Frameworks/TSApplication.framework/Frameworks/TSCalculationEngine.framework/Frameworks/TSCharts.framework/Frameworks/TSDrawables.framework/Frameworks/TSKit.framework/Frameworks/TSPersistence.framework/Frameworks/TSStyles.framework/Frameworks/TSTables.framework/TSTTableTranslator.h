...
- (id)baseCellRegionForUIDRange:(const void *)arg1;
...
- (id)viewRowIndexesForUIDs:(const void *)arg1;
- (id)viewColumnIndexesForUIDs:(const void *)arg1;
...
- (id)baseRowIndexesForUIDs:(const void *)arg1;
- (id)baseColumnIndexesForUIDs:(const void *)arg1;
- (id)mutableBaseRowIndexesForUIDs:(const void *)arg1;
- (id)mutableBaseColumnIndexesForUIDs:(const void *)arg1;
- (TSKUIDStructVectorTemplate_de88e035)rowUIDsForViewRowIndexes:(id)arg1;
- (TSKUIDStructVectorTemplate_de88e035)columnUIDsForViewColumnIndexes:(id)arg1;
- (TSKUIDStructVectorTemplate_de88e035)rowUIDsForBaseRowIndexes:(id)arg1;
- (TSKUIDStructVectorTemplate_de88e035)columnUIDsForBaseColumnIndexes:(id)arg1;
