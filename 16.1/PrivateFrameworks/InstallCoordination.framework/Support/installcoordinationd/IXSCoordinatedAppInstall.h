...
@interface IXSCoordinatedAppInstall : NSObject
{
    ...
    _Bool _complete;
    _Bool _isTracked;
    unsigned char _coordinatorScope;
    _Bool _loadingPhaseIsComplete;
    _Bool _sentBeginRestoringUserData;
    _Bool _expectTermAssertionCallback;
    _Bool _appAssetPromiseSetterCanInstallLocalProvisionedContent;
    struct os_unfair_lock_s _externalPropertyLock;
    ...
    IXSPromisedOutOfBandTransfer *_deviceSecurityPromise;
    IXSPromisedOutOfBandTransfer *_preparationPromise;
    IXSOwnedDataPromise *_installOptionsPromise;
    NSUUID *_targetGizmoPairingID;
    unsigned long long _importance;
    unsigned long long _newRemovability;
    unsigned long long _newRemovabilityClient;
    unsigned long long _savedRemovability;
    unsigned long long _savedRemovabilityClient;
    CDUnknownBlockType _priorityBoostCompletion;
    NSString *_priorityBoostSourceInfo;
    LSRecordPromise *_completedRecordPromise;
    unsigned long long _effectiveIntent;
    IXSClientConnection *_scopedToConnection;
    unsigned long long _placeholderDisposition;
    ...
    NSUUID *_deviceSecurityPromiseUUID;
    NSUUID *_preparationPromiseUUID;
    NSProgress *_cachedCurrentLoadingProgress;
    NSMutableArray *_pendingLoadingProgressRequests;
    ...
    NSDate *_firstAppExtensionBusyTime;
    IXSCoordinatorProgress *_coordinatorProgress;
    NSArray *_installOptionsSetterAllowedLinkedParentBundleIDs;
    NSObject<OS_os_transaction> *_transaction;
    NSObject<OS_os_transaction> *_assertionTransaction;
}
...
- (unsigned long long)transactionStepForPromise:(id)arg1;
...
- (void)_onQueue_resumeLoadingProgress;
- (void)_onQueue_pauseLoadingProgress;
- (void)_pauseProgressObject:(id)arg1;
- (void)_onQueue_fetchLoadingProgressAndRun:(CDUnknownBlockType)arg1;
- (void)_limitedConcurrency_fetchLoadingProgressForPlaceholderInstallType:(unsigned long long)arg1 andRun:(CDUnknownBlockType)arg2;
- (void)_runWithLoadingProgress:(id)arg1 block:(CDUnknownBlockType)arg2;
...
- (void)setPlaceholderInstallState:(unsigned long long)arg1 withLSRecordPromiseForCompletion:(id)arg2;
...
- (void)_onQueue_internal_cancelForReason:(id)arg1 client:(unsigned long long)arg2 needsLSDatabaseSync:(_Bool *)arg3;
- (id)_onQueue_localizedAppName;
- (void)_onQueue_cancelForReason:(id)arg1 client:(unsigned long long)arg2;
- (void)_onQueue_cancelForReason:(id)arg1 client:(unsigned long long)arg2 needsLSDatabaseSync:(_Bool *)arg3;
- (void)cancelForReason:(id)arg1 client:(unsigned long long)arg2;
- (void)cancelForReason:(id)arg1 client:(unsigned long long)arg2 needsLSDatabaseSync:(_Bool *)arg3;
- (void)_onQueue_cancelPlaceholderIfNeededForReason:(id)arg1 client:(unsigned long long)arg2 needsLSDatabaseSync:(_Bool *)arg3;
- (_Bool)_onQueue_shouldDeletePlaceholderOnCancelationForReason:(id)arg1 client:(unsigned long long)arg2;
- (void)_onQueue_removeParallelPlaceholder:(_Bool *)arg1;
...
- (_Bool)_placeholderOrParallelPlaceholderIsInstalledWithRecord:(id *)arg1;
...
- (void)setPriorityBoostCompletion:(CDUnknownBlockType)arg1 withSourceInfo:(id)arg2;
- (void)setNewRemovabilityState:(unsigned long long)arg1 removabilityClient:(unsigned long long)arg2;
...
- (void)_onQueue_doAddReference:(id)arg1;
- (void)_finishAppInstallAtURL:(id)arg1 result:(_Bool)arg2 recordPromise:(id)arg3 error:(id)arg4;
...
- (void)_finishPlaceholderInstallAtURL:(id)arg1 result:(_Bool)arg2 recordPromise:(id)arg3 error:(id)arg4;
- (id)_limitedConcurrency_installApplication:(id)arg1 isPlaceholder:(_Bool)arg2 options:(id)arg3 retries:(unsigned long long)arg4 error:(id *)arg5;
- (_Bool)_limitedConcurrency_doRetryingInstallOperationForPlaceholder:(_Bool)arg1 installTargetURL:(id)arg2 retries:(unsigned long long)arg3 error:(id *)arg4 installAttemptBlock:(CDUnknownBlockType)arg5;
- (void)_onQueue_acquireAssertionIfNeededForPlaceholder:(_Bool)arg1;
- (void)_onQueue_handleAssertionAcquisitionFailureForPlaceholder:(_Bool)arg1 withError:(id)arg2;
- (void)_onQueue_runAssertionHandlerForPlaceholder:(_Bool)arg1;
- (long long)_onQueue_assertionRetrySeconds;
- (_Bool)_onQueue_acquireTerminationAssertionWithPredicate:(id)arg1 description:(id)arg2 terminationResistance:(unsigned char)arg3 error:(id *)arg4;
- (void)_runAsyncBlockWithDescription:(id)arg1 onLaunchServicesQueue:(CDUnknownBlockType)arg2;
- (void)_onQueue_checkState;
- (_Bool)_onQueue_isPlaceholderUnnecessary;
...
- (void)dealloc;
- (id)initWithSeed:(id)arg1 scopedToConnection:(id)arg2;
- (void)_internalInitWithSeed:(id)arg1 scopedToConnection:(id)arg2;
- (id)initWithCoder:(id)arg1;
- (void)_initInternalState;
- (oneway void)_remote_removabilityWithCompletion:(CDUnknownBlockType)arg1;
- (oneway void)_remote_setRemovability:(unsigned long long)arg1 byClient:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
- (oneway void)_remote_getPlaceholderDispositionWithCompletion:(CDUnknownBlockType)arg1;
- (oneway void)_remote_setPlaceholderDisposition:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
- (oneway void)_remote_convertToGloballyScopedWithCompletion:(CDUnknownBlockType)arg1;
- (oneway void)_remote_getCoordinatorScopeWithCompletion:(CDUnknownBlockType)arg1;
...
- (oneway void)_remote_getHasDeviceSecurityPromise:(CDUnknownBlockType)arg1;
- (oneway void)_remote_getDeviceSecurityPromise:(CDUnknownBlockType)arg1;
- (oneway void)_remote_setDeviceSecurityPromiseUUID:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (oneway void)_remote_targetGizmoPairingIDWithCompletion:(CDUnknownBlockType)arg1;
- (oneway void)_remote_setTargetGizmoPairingID:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (oneway void)_remote_conveyPriorityReplacingExisting:(_Bool)arg1 forConnection:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;
...
- (oneway void)_remote_setInstallOptionsPromiseUUID:(id)arg1 forConnection:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (oneway void)_remote_setAppAssetPromiseUUID:(id)arg1 fromConnection:(id)arg2 completion:(CDUnknownBlockType)arg3;
