...
- (void)coordinatorDidCompleteSuccessfully:(id)arg1 forRecordPromise:(id)arg2;
- (void)coordinatorDidInstallPlaceholder:(id)arg1 forRecordPromise:(id)arg2;
...
- (void)shouldPrioritizeAppWithIdentity:(id)arg1 forClientIDs:(id)arg2;
