...
@optional
- (_Bool)isPointInPathWithX:(double)arg1 y:(double)arg2 __JS_EXPORT_AS__isPointInPath:(id)arg3;
...
- (void)arcWithX:(double)arg1 y:(double)arg2 radius:(double)arg3 startAngle:(double)arg4 endAngle:(double)arg5 anticlockwise:(_Bool)arg6 __JS_EXPORT_AS__arc:(id)arg7;
@end
