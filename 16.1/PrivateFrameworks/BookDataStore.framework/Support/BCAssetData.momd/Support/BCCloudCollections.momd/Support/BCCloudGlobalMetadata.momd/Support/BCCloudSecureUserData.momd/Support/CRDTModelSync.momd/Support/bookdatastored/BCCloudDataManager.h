...
@class BCCloudDataSource, BCCloudDataSyncManager, BCCloudKitController, MISSING_TYPE, NSManagedObjectContext, NSString;
...
@interface BCCloudDataManager : NSObject
{
    ...
    id <BDSCloudDataManagerMonitor> _monitor;
...
- (void)transformedCloudDatasWithPredicate:(id)arg1 transformer:(CDUnknownBlockType)arg2 limit:(long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)cloudDatasWithPredicate:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)cloudDatasWithPredicate:(id)arg1 sortDescriptors:(id)arg2 maximumResultCount:(unsigned long long)arg3 filter:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;
...
- (MISSING_TYPE *)deleteCloudDataForPredicate:completion: /* Error: Ran out of types for this method. */;
