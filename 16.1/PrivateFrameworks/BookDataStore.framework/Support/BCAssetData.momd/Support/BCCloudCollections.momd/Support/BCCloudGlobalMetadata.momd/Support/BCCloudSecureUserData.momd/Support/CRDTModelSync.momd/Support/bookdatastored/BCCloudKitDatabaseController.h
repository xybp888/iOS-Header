...
{
    struct os_unfair_lock_s _zoneObserversLock;
...
- (void)zonesTemporarilyUnreadableWithError:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)p_informObserversOfSaltVersionIdentifierChanged:(id)arg1 forZones:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)detachWithError:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)detach;
