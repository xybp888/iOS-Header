...
- (void)getStreamingURLForResource:(CPLResource *)arg1 intent:(unsigned long long)arg2 hints:(NSDictionary *)arg3 timeRange:(CDStruct_e83c9415)arg4 clientBundleID:(NSString *)arg5 completionHandler:(void (^)(NSURL *, NSData *, NSDate *, NSError *))arg6;
