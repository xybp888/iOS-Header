...
- (_Bool)_setIsOriginal:(_Bool *)arg1 markedForDelete:(_Bool *)arg2 onDestinationURL:(id)arg3 clearFlags:(_Bool)arg4 error:(id *)arg5;
- (void)_clearFlagsOnURL:(id)arg1;
- (void)_clearFlagsOnFd:(int)arg1 url:(id)arg2;
