...
- (void)purgeAllAssetsForApplications:(id)arg1 withRequestCompletion:(CDUnknownBlockType)arg2;
...
- (void)expireAssetURLSForBundleIDs:(id)arg1 withReply:(CDUnknownBlockType)arg2;
- (void)assetsForBundleID:(id)arg1 withReply:(CDUnknownBlockType)arg2;
- (void)allRegisteredODRAppsWithReply:(CDUnknownBlockType)arg1;
