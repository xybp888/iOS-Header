...
- (id)initWithFaceIDModel:(shared_ptr_d8728072)arg1 entityPrintOriginatingRequestSpecifier:(id)arg2 entityUniqueIdentifiers:(id)arg3 entityPrintCounts:(id)arg4;
