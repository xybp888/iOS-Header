...
- (struct __CVBuffer *)_createPixelBufferFromImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 maximumIntermediateSideLength:(unsigned long long)arg3 options:(id)arg4 error:(id *)arg5;
