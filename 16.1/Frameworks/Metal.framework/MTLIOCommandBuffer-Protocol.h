...
- (void)loadTexture:(id <MTLTexture>)arg1 slice:(unsigned long long)arg2 level:(unsigned long long)arg3 size:(CDStruct_da2e99ad)arg4 sourceBytesPerRow:(unsigned long long)arg5 sourceBytesPerImage:(unsigned long long)arg6 destinationOrigin:(CDStruct_da2e99ad)arg7 sourceHandle:(id <MTLIOFileHandle>)arg8 sourceHandleOffset:(unsigned long long)arg9;
