...
- (void)_startNetworkActivityUsingTaskInfo:(id)arg1 withTask:(id)arg2;
...
- (id)_findSessionUsingTaskInfo:(id)arg1 withProperties:(id)arg2;
- (void)_completeNetworkActivityWithReason:(int)arg1 usingTaskInfo:(id)arg2;
