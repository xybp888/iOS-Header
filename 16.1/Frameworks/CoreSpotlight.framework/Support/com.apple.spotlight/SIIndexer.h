...
- (id)resultsForSodiumUserQuery:(id)arg1 withFields:(id)arg2 maxCount:(long long)arg3 languages:(id)arg4 liftingRules:(id)arg5 scope:(id)arg6 sodiumBundles:(id)arg7;
- (void)bulkSetCSAttributes:(id)arg1 bundle:(id)arg2;
- (void)waitFor:(int)arg1;
- (id)allQueryTasks;
