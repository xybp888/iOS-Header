...
- (CDUnknownBlockType)provideItemForKernelRequestWithInfo:(id)arg1 atURL:(id)arg2 forProcess:(CDStruct_4c969caf)arg3 withOptions:(unsigned long long)arg4 completionHandler:(CDUnknownBlockType)arg5;
