...
- (id)_generateNotificationRequestForFailedDelivery:(struct _IMDMessageRecordStruct *)arg1 isCarouselUITriggered:(_Bool)arg2;
- (id)_generateNotificationRequestForMessageRecord:(struct _IMDMessageRecordStruct *)arg1 isUrgentMessage:(_Bool)arg2 downTimeEnabled:(_Bool)arg3 isCarouselUITriggered:(_Bool)arg4 isMostActive:(_Bool)arg5;
