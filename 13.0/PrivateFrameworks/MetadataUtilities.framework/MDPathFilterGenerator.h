...
- (void)addNamed:(id)arg1 field:(int)arg2 value:(int)arg3 forPath:(id)arg4 permitLink:(_Bool)arg5;
- (void)addNamed:(id)arg1 field:(int)arg2 value:(int)arg3 hasAuxValue:(_Bool)arg4 auxValue:(unsigned long long)arg5 forPath:(id)arg6 permitLink:(_Bool)arg7 copyParentWildcardLink:(_Bool)arg8;
