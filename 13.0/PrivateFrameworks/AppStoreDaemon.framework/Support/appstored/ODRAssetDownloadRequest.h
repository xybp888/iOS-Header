...
@class AMSPromise, AssetPromise, IXPromisedOutOfBandTransfer, KeepAlive, NSDictionary, NSMutableArray, NSProgress, NSString, NSURL, NSUUID, ODRApplication, ODRTagsRequest;
