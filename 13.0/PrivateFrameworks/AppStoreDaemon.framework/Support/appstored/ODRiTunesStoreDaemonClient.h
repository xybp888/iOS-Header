...
- (void)applicationDownloadInitiatedForApplication:(id)arg1 manifestURL:(id)arg2 reason:(long long)arg3 jobID:(long long)arg4 replyBlock:(CDUnknownBlockType)arg5;
- (id)interface;
