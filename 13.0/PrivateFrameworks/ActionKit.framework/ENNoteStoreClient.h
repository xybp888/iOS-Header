...
- (void)fetchSearchTextForNoteWithGuid:(id)arg1 noteOnly:(_Bool)arg2 tokenizeForIndexing:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)fetchNoteWithGuid:(id)arg1 includingContent:(_Bool)arg2 resourceOptions:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)findNoteCountsWithFilter:(id)arg1 includingTrash:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)fetchSyncChunkForLinkedNotebook:(id)arg1 afterUSN:(int)arg2 maxEntries:(int)arg3 fullSyncOnly:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)fetchSyncChunkAfterUSN:(int)arg1 maxEntries:(int)arg2 fullSyncOnly:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
