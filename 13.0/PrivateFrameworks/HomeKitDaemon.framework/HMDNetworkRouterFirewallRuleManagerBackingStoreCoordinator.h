...
- (void)_fetchCloudChangesWithQualityOfService:(long long)arg1 forceChangeNotifications:(_Bool)arg2 xpcActivity:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)fetchCloudChangesWithQualityOfService:(long long)arg1 forceChangeNotifications:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
