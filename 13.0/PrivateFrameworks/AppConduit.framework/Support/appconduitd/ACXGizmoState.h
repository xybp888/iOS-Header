...
- (void)processNewStatusUpdates:(id)arg1 updatedStatusUpdates:(id)arg2 removedStatusUpdates:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (_Bool)_onQueue_pendingInstallStateShouldBeIgnoredForApp:(id)arg1 existingState:(id)arg2 newState:(id)arg3;
- (void)noteNewApps:(id)arg1 updatedApps:(id)arg2 removedApps:(id)arg3 newlyIndependentAppBundleIDs:(id)arg4 completion:(CDUnknownBlockType)arg5;
