...
- (TSBridgedNewsActivity *)unrealizedHeadlineWithArticleID:(NSString *)arg1 articleContext:(TSArticleContext *)arg2 articlePresentationStyle:(long long)arg3 showShareSheet:(_Bool)arg4 forceArticleUpdate:(_Bool)arg5;
- (TSBridgedNewsActivity *)headlineWithHeadlineProviding:(id <FCHeadlineProviding>)arg1 articleContext:(TSArticleContext *)arg2 articlePresentationStyle:(long long)arg3 showShareSheet:(_Bool)arg4 forceArticleUpdate:(_Bool)arg5;
