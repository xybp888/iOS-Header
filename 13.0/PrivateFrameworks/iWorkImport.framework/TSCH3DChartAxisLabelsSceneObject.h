...
- (void)p_renderLabels:(id)arg1 labelType:(int)arg2 part:(id)arg3 positioner:(id)arg4 offset:(const tvec3_17f03ce0 *)arg5 offset2DBlock:(CDUnknownBlockType)arg6 strideBlock:(CDUnknownBlockType)arg7 skipFirst:(_Bool)arg8 showLast:(_Bool)arg9;
