...
@class Legacy_VOTUIItemChooserController, NSString, VOTUIBrailleViewController, VOTUICaptionPanelViewController, VOTUICursorViewController, VOTUIMapsExplorationViewController, VOTUIRotorViewController, VOTUIScreenCurtainViewController, VOTUISwipeOrderViewController;

@interface VOTUIServer : NSObject <Legacy_VOTUIItemChooserDelegate, AXUIService, AXUIContentViewControllerDelegate>
{
