...
@class CADisplayLink, CloudTabItemView, HighlightRecognizer, NSArray, NSIndexSet, NSMutableArray, NSString, NSTimer, ReorderingAutoscroller, TabExplanationView, TabOverviewInterpolatedLocation, TabOverviewItem, UIButton, UILongPressGestureRecognizer, UIPanGestureRecognizer, UISearchBar, UITapGestureRecognizer, UITextInputPasswordRules, UIVisualEffectView;
@protocol TabOverviewDelegate;

@interface TabOverview : UIView <CloudTabTableDelegate, ReorderingAutoscrollerDelegate, _UIBasicAnimationFactory, _UIScrollToTopView, UIGestureRecognizerDelegate, UISearchBarDelegate, UISearchBarDelegate_Private, UIKeyInput, TabThumbnailCollectionView>
{
