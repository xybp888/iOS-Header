...
@class BookmarkFavoritesViewController, NSArray, NSMutableDictionary, NSString, NSTimer, SidebarInteractionReporter, UIBarButtonItem, UISegmentedControl, WebBookmarkCollection, _UINavigationBarPalette;
...
- (void)readingListViewController:(id)arg1 didProduceNavigationIntent:(id)arg2;
...
- (void)historyTableViewController:(id)arg1 didProduceNavigationIntent:(id)arg2;
...
- (void)bookmarksTableViewController:(id)arg1 didProduceNavigationIntent:(id)arg2;
- (void)bookmarkFavoritesViewController:(id)arg1 commitPreviewedViewController:(id)arg2;
- (id)bookmarkFavoritesViewController:(id)arg1 previewViewControllerForNavigationIntent:(id)arg2;
...
- (void)bookmarkFavoritesViewController:(id)arg1 didProduceNavigationIntent:(id)arg2;
- (void)dealloc;
@property(nonatomic, getter=isContentDirty) _Bool contentDirty;
...
- (void)setPinnedPaletteForViewController:(id)arg1;
