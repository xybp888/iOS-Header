...
- (void)updateMinimumDeviceWidthForDocument:(id)arg1;
@property(readonly, nonatomic) _Bool isShowingInOneThirdMode;
- (_Bool)_isShowingEmbeddedSidebar;
- (double)_minimumEffectiveDeviceWidthWithFullScreen:(_Bool)arg1;
...
- (void)_updateDesktopClassBrowserProperties;
