...
@class AutomationController, BookmarksDatabaseHealthReporter, BrowserContainerViewController, BrowserController, BrowserWindowController, ForYouRecommendationMediator, NSArray, NSMutableArray, NSString, ReadingListLeadImageCache, SBSAssertion, UIWindow, WBDatabaseLockAcquisitor, WBSCloudHistory, WBSCyclerConnectionManager, WBSForYouRecentParsecResultsManager, WBSFormAutoFillCorrectionsHistoryObserver;

@interface Application : UIApplication <PageLoadTestRunnerDelegate, TabSnapshotCacheStressTestRunnerDelegate, MCProfileConnectionObserver, _SFUIApplicationModifierFlagsProviding, WBDatabaseLockAcquisitorDelegate, _SFDownloadDelegate, UIApplicationDelegatePrivate, UIApplicationDelegate, _SFNavigationIntentHandling>
{
