...
@class EKDayOccurrenceView, EKEventGestureController, NSOperationQueue, NSString, TimerOperation;
...
- (void)_displayEventDetailsViewControllerForSelectedEventWithOccurrenceView:(id)arg1 showComments:(_Bool)arg2 context:(struct NSDictionary *)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_displayEventDetailsViewControllerForEvent:(id)arg1 showComment:(_Bool)arg2 context:(struct NSDictionary *)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)showEvent:(id)arg1 animated:(_Bool)arg2 showDetails:(_Bool)arg3 showComments:(_Bool)arg4 context:(struct NSDictionary *)arg5 completion:(CDUnknownBlockType)arg6;
