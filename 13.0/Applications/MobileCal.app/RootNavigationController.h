...
@class CalendarModel, CalendarToolbarButton, CompactMonthDividedListSwitchButton, ListViewSwitchButton, NSAttributedString, NSLayoutConstraint, NSMutableDictionary, NSString, NSUserActivity, PaletteView, UIActivityIndicatorView, UIBarButtonItem, UIButton, UIFont, UILabel, UISegmentedControl, UITraitCollection, UIWindow, _UINavigationControllerPalette;
...
@interface RootNavigationController : UINavigationController <UIPopoverPresentationControllerDelegate, EKEventViewDelegatePrivate, EKEventEditViewDelegate, CalendarDebugReportProblemViewControllerDelegate, NSUserActivityDelegate, SearchResultsViewControllerDelegate, UIWindowDelegate, UINavigationControllerDelegate, WeekViewControllerDelegate, FutureTraitEnvironment>
{
    ...
    CalendarToolbarButton *_calendarsButton;
    ...
    CDUnknownBlockType _shortcutAction;
...
@property(copy, nonatomic) CDUnknownBlockType shortcutAction; // @synthesize shortcutAction=_shortcutAction;
...
- (void)handleURL:(id)arg1 context:(struct NSDictionary *)arg2;
...
- (_Bool)_oldTraitCollection:(id)arg1 differsOnlyInUserInterfaceStyleFromNewTraitCollection:(id)arg2;
