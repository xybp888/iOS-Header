...
@class CalendarModel, EKCalendarDate, EKDayOccurrenceView, EKEventGestureController, NSDateComponents, NSDateIntervalFormatter, NSMutableArray, NSString, NSTimer, UIScrollView, UITraitCollection, UIView, WeekTimeView;
@protocol WeekViewControllerDelegate;

@interface WeekViewController : MainViewController <EKDayTimeViewDelegate, MainViewControllerOptionalMethods, UIScrollViewDelegate, WeekViewDataSource, WeekGroupViewDelegate, EKEventGestureControllerDelegate, EKEventViewDelegatePrivate>
{
