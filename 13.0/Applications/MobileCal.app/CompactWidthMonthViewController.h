...
- (void)_showDetailsForEvent:(id)arg1 animated:(_Bool)arg2 showComments:(_Bool)arg3 context:(struct NSDictionary *)arg4;
- (void)_showDetailsForEvent:(id)arg1 animated:(_Bool)arg2 context:(struct NSDictionary *)arg3;
