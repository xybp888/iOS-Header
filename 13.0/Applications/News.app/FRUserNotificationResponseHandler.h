...
- (void)showArticleWithID:(id)arg1 notificationID:(id)arg2 channelID:(id)arg3 forceArticleUpdate:(_Bool)arg4 userActionDate:(id)arg5;
- (void)shareArticleWithID:(id)arg1 notificationID:(id)arg2 channelID:(id)arg3 forceArticleUpdate:(_Bool)arg4 userActionDate:(id)arg5;
