...
+ (id)headerLayoutAttributesWithIndexPath:(id)arg1 headerDisplayable:(id)arg2 muteFavoriteOptions:(long long)arg3 feedGutter:(double)arg4 feedWidth:(double)arg5 isPad:(_Bool)arg6;
