...
@class LKUsers, LUIPaneHeaderView, LUIPrivacyView, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, SBUIVibrantButton, UIImage, UITableView, UIView;
@protocol LKClassProviding, LUIProgressAnimationProtocol;

@interface LUIClassTableViewController : UIViewController <CATCollectionControllerDelegate, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate, LUIAuthenticationControllerDelegate, LUIClassDisplaying, LUINavigationViewControllerProtocol, LUIRecentUsersViewing>
{
    _Bool _firstUpdate;
