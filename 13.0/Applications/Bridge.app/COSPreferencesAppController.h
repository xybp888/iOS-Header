...
@class BKSApplicationStateMonitor, COSGetStartedViewController, COSPreferencesRootController, COSSetupController, COSUnpairingViewController, COSWatchAppStoreSplashViewController, NPSDomainAccessor, NRActiveDeviceAssertion, NRDevice, NSMutableDictionary, NSObject, NSString, NSTimer, PBBridgeCompanionController, PSSplitViewController, UIAlertController, UINavigationController, UITabBarController, UIViewController, UIWindow;
