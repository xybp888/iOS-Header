...
@interface PBKAppDelegate : UIResponder <SBSHardwareButtonEventConsuming, PKForegroundActiveArbiterObserver, CLLocationManagerDelegate, UIApplicationDelegate>
{
    UIWindow *_window;
...
- (_Bool)_handleWalletUniversalLinkableURLWithHost:(id)arg1 pathComponents:(id)arg2 referrerIdentifier:(id)arg3;
