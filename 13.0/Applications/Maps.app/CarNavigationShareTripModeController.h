...
@class CarChromeViewController, CarMapTrackingController, CarTableView, ChromeViewController, NSArray, NSDictionary, NSMapTable, NSString, NSTimer, PassThroughViewController, SharedTripSuggestionsDataSource, SharedTripsContactController, UIView;
