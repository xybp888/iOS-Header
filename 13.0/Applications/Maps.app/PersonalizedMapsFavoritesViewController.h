...
@class FavoritesDataSource, MKMapView, NSString, RAPQuestion, UITableViewCell;

__attribute__((visibility("hidden")))
@interface PersonalizedMapsFavoritesViewController : UITableViewController <DataSourceDelegate, RAPInstrumentableTarget, MapsActivityViewControllerDelegate>
{
...
@property(readonly, nonatomic) MKMapView *mapsActivityMapView; // @synthesize mapsActivityMapView;
- (void).cxx_destruct;
