...
@interface CarChromeViewController : StackedChromeViewController <UIGestureRecognizerDelegate, CarZoomButtonViewDelegate, CarCardViewDelegate, _UIFocusEnvironmentPrivate, CarMapSettingsDelegate, LightLevelObserver, PassThroughViewDelegate, CarMapControlsDelegate, CarOverlayControllerDelegate, CarOverlayHosting>
{
...
@property(readonly, nonatomic) double availableCardWidth;
@property(readonly, nonatomic) CarChromeState *currentOverlayState;
...
- (void)viewDidLoad;
- (id)cardsOverlayForMode:(id)arg1;
