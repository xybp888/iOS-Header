...
@interface _TransitDirectionsInstructionsCellConstraints : NSObject
{
    ...
    NSLayoutConstraint *_primaryAccessoryToDisclosureArrowConstraint;
...
@property(retain, nonatomic) NSLayoutConstraint *primaryAccessoryToDisclosureArrowConstraint; // @synthesize primaryAccessoryToDisclosureArrowConstraint=_primaryAccessoryToDisclosureArrowConstraint;
