...
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 hasPriorityOverride:(_Bool)arg4 priorityOverride:(long long)arg5 matchInfo:(id)arg6;
- (id)initWithServerCompletion:(id)arg1 hasPriorityOverride:(_Bool)arg2 priorityOverride:(long long)arg3 serverResultScoreMetadata:(id)arg4;
- (id)init;
