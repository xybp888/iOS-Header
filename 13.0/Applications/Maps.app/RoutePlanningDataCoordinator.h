...
@class DrivePreferences, NSDate, NSHashTable, NSString, NavigationSession, PlatformController, RideBookingPlanningSession, RideBookingRideOptionStateObserverProxy, RouteCollection, RoutePlanningError, RoutePlanningSession, RoutePlanningWaypointRequest, TransitRouteOptions, WaypointSet;
@protocol RoutePlanningDataCoordinatorPresentationDelegate;

__attribute__((visibility("hidden")))
@interface RoutePlanningDataCoordinator : NSObject <PlatformControllerObserver, RoutePlanningSessionObserver, RideBookingPlanningSessionObserver, NavigationSessionObserver, RoutePlanningDataCoordination>
{
...
- (void)_notifyDidUdpateWaypointSet;
...
- (void)_reloadingUsingNewTransitOptions:(id)arg1;
