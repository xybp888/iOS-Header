...
@class CarFocusableButton, GEOSharedNavState, NSArray, NSDictionary, NSString, PassThroughViewController, UILabel, UILayoutGuide, UIStackView;
@protocol CarCardContentDelegate, CarSharedTripDetailCardDelegate;
