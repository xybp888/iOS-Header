...
@class BackgroundColorButton, MapsProgressButton, MapsThemeMultiPartLabel, NSArray, NSLayoutConstraint, TransitArtworkListView, UIButton, UIImage, UIImageView, UILabel, UILayoutGuide, UIStackView;
...
- (void)_updateConstraintsForArtworkListVisible:(_Bool)arg1 tertiaryLabelVisible:(_Bool)arg2 detailsButtonVisible:(_Bool)arg3 automaticSharingButtonVisible:(_Bool)arg4;
