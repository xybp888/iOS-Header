...
@interface StepActionCoordinator : NSObject <TransitDirectionsListViewControllerDelegate, DirectionsStepsTableViewControllerDelegate, PlaceCardViewControllerDelegate, PPTTestGuidanceStepProtocol, PPTTestNavigationProtocol, PPTTestChromeTrayProtocol, GEOLogContextDelegate, StepActionCoordination>
{
...
- (void)_presentClusteredRouteSelectionFromViewController:(id)arg1 forClusteredLeg:(id)arg2 fromView:(id)arg3 popoverDirections:(unsigned long long)arg4;
