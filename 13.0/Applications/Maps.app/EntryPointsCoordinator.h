...
- (void)continueUserActivity:(id)arg1 windowSize:(struct CGSize)arg2;
- (void)didFailToContinueUserActivityWithType:(id)arg1 error:(id)arg2;
- (void)willContinueUserActivityWithType:(id)arg1;
- (void)openURL:(id)arg1 sceneOptions:(id)arg2 mkOptions:(id)arg3 windowSize:(struct CGSize)arg4;
