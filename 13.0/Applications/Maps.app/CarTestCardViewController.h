...
@class CarCardTestConfig, CarFocusableButton, NSArray, NSDictionary, NSLayoutConstraint, NSString, NSUUID, UIColor, UILabel, UIView;
...
@property(readonly, nonatomic) CDStruct_fd467f33 layout;
