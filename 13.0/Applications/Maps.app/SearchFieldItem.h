...
@class AddressBookAddress, CRRecentContact, DirectionsWaypoint, ExternalURLQuery, GEOMapItemChildPlace, GEORelatedSearchSuggestion, GEORetainedSearchMetadata, GEOSearchCategory, HistoryEntryRecentsItem, MKLocalSearchCompletion, MKMapItem, NSData, NSString, RoutePlanningWaypointRequest, SearchResult, VenueCategoryItem;
