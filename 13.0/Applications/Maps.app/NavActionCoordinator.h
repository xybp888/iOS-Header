...
@class AppCoordinator, AudioSettingsViewController, CustomPOIsController, GEOMapServiceTraits, GuidanceObserver, GuidanceSearchCategoriesViewModel, MapSelectionManager, MapViewZoomController, NSString, NavContainerViewController, NavTrafficIncidentContaineeViewController, NavTrafficIncidentCoordinator, NavigationDisplay, NavigationFeaturesViewModel, NavigationTrayContaineeViewController, PlaceCardViewController, SearchInfo, SharedTripsContactController, SimpleResultsViewController, TrafficCameraContaineeViewController, UIScrollView;
...
{
    SharedTripsContactController *_sharedTripsContactController;
