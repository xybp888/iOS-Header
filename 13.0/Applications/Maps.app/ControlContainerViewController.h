...
@class ActionCoordinator, CardAnimation, FloatingControlsViewController, MapGestureCardDismissalHelper, NSArray, NSString, PlatformController, StatusIndicatorManager, StatusIndicatorView, UIView;
...
@interface ControlContainerViewController : OverlayContainerViewController <MKMapViewDelegate, PassThroughViewControllerDelegate, StatusIndicatorDelegate, ControlContainerProtocol, MapViewResponderHandling>
{
