...
@class AnalyticsMonitor, AppStateManager, BaseModeController, IOSChromeViewController, MKMapView, MapsActivityViewController, MapsSceneDelegate, MuninModeController, NSString, NavModeController, NavigationSession, PlatformController, RidesharingModeController, StepModeController, UIScrollView, UIViewController;
...
@interface AppCoordinator : NSObject <PPTTestCoordinatorProtocol, PlatformControllerObserver, NavigationSessionObserver, MapsActivityViewControllerDelegate, ShareDelegate, PlaceCardActionDelegate, ParkedCarActionDelegate, MuninPresentation>
{
    ...
    MuninModeController *_muninModeController;
...
@property(readonly, nonatomic) MuninModeController *muninModeController; // @synthesize muninModeController=_muninModeController;
...
- (void)_popNavModeWhenLockScreenWindowIsHiddenWithCompletion:(CDUnknownBlockType)arg1;
