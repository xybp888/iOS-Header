...
+ (id)_parseTLVs:(const char **)arg1 end:(const char *)arg2 simple:(_Bool)arg3 definite:(_Bool)arg4;
...
+ (id)TLVSsWithBytes:(const void *)arg1 length:(unsigned long long)arg2 requireDefiniteEncoding:(_Bool)arg3;
+ (id)simpleTLVsWithData:(id)arg1;
+ (id)TLVsWithData:(id)arg1 requireDefiniteEncoding:(_Bool)arg2;
