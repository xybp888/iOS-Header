...
@property(nonatomic) _Bool isLEHID; // @synthesize isLEHID=_isLEHID;
@property(nonatomic) _Bool inEar; // @synthesize inEar=_inEar;
...
@property(nonatomic) _Bool inEarDetect; // @synthesize inEarDetect=_inEarDetect;
