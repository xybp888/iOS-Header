...
- (void)fetchParentsForItemID:(id)arg1 recursively:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)_fetchHierarchyForItemID:(id)arg1 recursively:(_Bool)arg2 depth:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)_fetchHierarchyForItemID:(id)arg1 recursively:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
