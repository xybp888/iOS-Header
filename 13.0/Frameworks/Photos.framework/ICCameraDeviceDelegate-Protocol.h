...
- (_Bool)cameraDevice:(ICCameraDevice *)arg1 shouldGetMetadataOfItem:(ICCameraItem *)arg2;
- (_Bool)cameraDevice:(ICCameraDevice *)arg1 shouldGetThumbnailOfItem:(ICCameraItem *)arg2;
@end
