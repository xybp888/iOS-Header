...
@class NSData, NSDictionary, Request;
...
- (void)evaluateACL:(NSData *)arg1 operation:(id)arg2 options:(NSDictionary *)arg3 uiDelegate:(id <LAUIDelegate>)arg4 originator:(id <LAOriginatorProt>)arg5 request:(Request *)arg6 reply:(void (^)(NSDictionary *, NSError *))arg7;
- (void)evaluatePolicy:(long long)arg1 options:(NSDictionary *)arg2 uiDelegate:(id <LAUIDelegate>)arg3 originator:(id <LAOriginatorProt>)arg4 request:(Request *)arg5 reply:(void (^)(NSDictionary *, NSError *))arg6;
@end
