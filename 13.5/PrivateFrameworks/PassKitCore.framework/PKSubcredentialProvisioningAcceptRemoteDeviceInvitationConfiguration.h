...
- (id)transitionTable;
- (id)initWithInvitation:(id)arg1 canRequestInvitation:(_Bool)arg2 localDeviceWebService:(id)arg3 remoteDeviceWebService:(id)arg4 configurationType:(long long)arg5;
