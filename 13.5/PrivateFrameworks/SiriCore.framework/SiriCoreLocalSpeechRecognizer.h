...
- (void)startSpeechRecognitionWithLanguage:(id)arg1 interactionIdentifier:(id)arg2 task:(id)arg3 context:(id)arg4 narrowband:(_Bool)arg5 detectUtterances:(_Bool)arg6 maximumRecognitionDuration:(double)arg7 farField:(_Bool)arg8 secureOfflineOnly:(_Bool)arg9 censorSpeech:(_Bool)arg10 originalAudioFileURL:(id)arg11 overrides:(id)arg12 modelOverrideURL:(id)arg13 didStartHandler:(CDUnknownBlockType)arg14;
