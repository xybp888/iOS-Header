...
- (id)makeQueryForPersonsWithRole:(long long)arg1 searchString:(id)arg2 sortingGivenNameFirst:(_Bool)arg3 pageSize:(long long)arg4;
...
- (id)makeInstructorQueryForSearchString:(id)arg1 sortingGivenNameFirst:(_Bool)arg2 pageSize:(long long)arg3;
- (id)makeStudentQueryForSearchString:(id)arg1 sortingGivenNameFirst:(_Bool)arg2 pageSize:(long long)arg3;
