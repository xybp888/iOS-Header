...
@class CustomSearchManager, DefaultTransportTypeFinder, EnvironmentObserver, InterruptionManager, LoadingIndicatorController, MapCameraController, MapSelectionManager, MapViewResponder, MapsActionController, MapsScreenshotService, MapsUserLocationView, NSArray, NSString, OverlayManager, ParkedCarManager, PersonalizedItemManager, RidesharingAnnotationsManager, RouteAnnotationsController, SearchPinsManager, SettingsController, ToolbarController, UITapGestureRecognizer;
@protocol ViewModeDelegate;

__attribute__((visibility("hidden")))
@interface IOSChromeViewController : StackedChromeViewController <LightLevelObserver, MapSelectionManagerDelegate, SearchPinsManagerDelegate, MapTypeSource, MapsScreenshotServiceDelegate, MapsUIImageCacheUserInterfaceDelegate, MapsDebugViewControllerDelegate, InterruptionManagerProtocol, LockScreenProtocol, GEOLogContextDelegate>
{
...
- (_Bool)prepareSecureLockScreenUI:(_Bool)arg1;
