...
@class NSArray, NSString, RecentsDataProvider, SearchResult;

__attribute__((visibility("hidden")))
@interface PersonalizedMapsRecentsDataSource : DataSource <CustomSearchManagerObserver, DataProvidingObserver, UITableViewDelegate, UITableViewDataSource>
{
...
- (void)dealloc;
- (id)initWithTableView:(id)arg1 includeSignificantLocationSuggestions:(_Bool)arg2 delegate:(id)arg3;
