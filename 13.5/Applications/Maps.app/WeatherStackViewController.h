...
@class AirQualityConditionsViewController, NSNumber, NSObject, NSString, UIStackView, UIView, UIVisualEffectView, WFLocation, WeatherConditionsViewController, _UIContextMenuInteraction;
@protocol OS_dispatch_source;

__attribute__((visibility("hidden")))
@interface WeatherStackViewController : MapsThemeViewController <_UIContextMenuInteractionDelegate, WeatherLocationDataProviderObserver, WeatherConditionsViewControllerDelegate, AirQualityConditionsViewControllerDelegate>
{
