...
- (_Bool)updateiTunesMetadataWithData:(id)arg1 forApplicationAtURL:(id)arg2 error:(id *)arg3;
- (_Bool)updateiTunesMetadataWithData:(id)arg1 forApplication:(id)arg2 options:(id)arg3 error:(id *)arg4;
- (_Bool)updateSINFWithData:(id)arg1 forApplicationAtURL:(id)arg2 error:(id *)arg3;
- (_Bool)_getBundleIdentifierForBundleAtURL:(id)arg1 invokeUpdateBlockAndReregister:(CDUnknownBlockType)arg2 error:(id *)arg3;
...
- (void)relaxApplicationTypeRequirements:(_Bool)arg1 forApplicationRecord:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
