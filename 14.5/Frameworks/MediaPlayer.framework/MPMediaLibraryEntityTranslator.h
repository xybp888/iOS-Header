...
- (map_a9534c58)_propertyMapForKeyPath:(id)arg1 includePropertiesToSort:(_Bool)arg2;
- (struct ModelPropertyBase *)_propertyForKeyPath:(id)arg1;
- (id)_propertyTranslatorForKeyPath:(id)arg1;
- (map_a9534c58)propertiesToFetchForPropertyKey:(id)arg1;
...
- (void)mapRelationshipKey:(id)arg1 toModelClass:(Class)arg2 transient:(_Bool)arg3 usingForeignPropertyBase:(struct ModelPropertyBase *)arg4 relationshipValidationProperties:(const map_a9534c58 *)arg5 isValidRelationshipHandler:(CDUnknownBlockType)arg6;
...
- (void)mapPropertyKey:(id)arg1 withPropertiesToFetch:(const map_a9534c58 *)arg2 propertiesToSort:(const map_a9534c58 *)arg3 sortTransformer:(CDUnknownBlockType)arg4 valueTransformer:(CDUnknownBlockType)arg5;
- (void)mapPropertyKey:(id)arg1 withPropertiesToFetch:(const map_a9534c58 *)arg2 valueTransformer:(CDUnknownBlockType)arg3;
- (void)mapPropertyKey:(id)arg1 toMLProperty:(struct ModelPropertyBase *)arg2;
- (void)mapIdentifierMLProperties:(const map_a9534c58 *)arg1 identifierCreationBlock:(CDUnknownBlockType)arg2;
