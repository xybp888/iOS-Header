...
@property(readonly, copy, nonatomic) NSString *hlsKeyCertificateURL; // @dynamic hlsKeyCertificateURL;
@property(readonly, copy, nonatomic) NSString *hlsKeyServerURL; // @dynamic hlsKeyServerURL;
