...
- (id)collectMetricsFromTaskContext:(id)arg1 isInCallBack:(_Bool)arg2;
...
- (_Bool)setWeightsOrBiasesForLayer:(id)arg1 layerType:(unsigned long long)arg2 value:(id)arg3 error:(id *)arg4;
- (_Bool)updateWeightsAndBiasesFromConfigParams:(id)arg1 error:(id *)arg2;
