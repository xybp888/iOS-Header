...
+ (_Bool)computeLabelsAndConfidence:(struct ImageClassifierAbstract *)arg1 usingDescriptorBuffer:(struct ImageDescriptorBufferAbstract *)arg2 populateLabelsAndConfidence:(vector_1ec05455 *)arg3 options:(id)arg4 metalContext:(id)arg5 error:(id *)arg6;
