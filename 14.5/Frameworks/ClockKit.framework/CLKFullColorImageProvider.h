...
- (id)initWithFullColorImage:(id)arg1 tintedImageProvider:(id)arg2 applyScalingAndCircularMasking:(_Bool)arg3;
- (id)initWithFullColorImage:(id)arg1 monochromeFilterType:(long long)arg2 applyScalingAndCircularMasking:(_Bool)arg3;
- (id)initWithFullColorImage:(id)arg1 applyScalingAndCircularMasking:(_Bool)arg2;
