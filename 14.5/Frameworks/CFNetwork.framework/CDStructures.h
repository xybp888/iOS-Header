...
struct HTTPConnectionCacheKey {
    ...
    struct shared_ptr<NetworkProxy> _field13;
    struct shared_ptr<const __CFString> _field14;
    int _field15;
    int _field16;
    struct unique_ptr<const __CFDictionary, Deleter_CFRelease> _field17;
    struct unique_ptr<const __CFString, Deleter_CFRelease> _field18;
    double _field19;
};
