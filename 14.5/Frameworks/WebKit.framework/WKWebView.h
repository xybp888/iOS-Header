...
@class NSArray, NSData, NSNumber, NSString, NSURL, UIScrollView, WKBackForwardList, WKBrowsingContextHandle, WKPasswordView, WKWebViewConfiguration, WKWebViewContentProviderRegistry, _UIEventAttribution, _WKFrameHandle, _WKInspector, _WKSessionState, _WKWebViewPrintFormatter;
@protocol WKHistoryDelegatePrivate, WKNavigationDelegate, WKUIDelegate, _WKDiagnosticLoggingDelegate, _WKFindDelegate, _WKFullscreenDelegate, _WKIconLoadingDelegate, _WKInputDelegate, _WKResourceLoadDelegate, _WKTextManipulationDelegate, _WKWebViewPrintProvider;
...
@interface WKWebView : UIView <UIScrollViewDelegate, UIResponderStandardEditActions>
{
    ...
    struct RetainPtr<WKBlankOverlayView> _blankOverlayView;
    ...
    OptionSet_7e3fdc04 _viewStabilityWhenVisibleContentRectUpdateScheduled;
...
@property(nonatomic, setter=_setHasBlankOverlay:) _Bool _hasBlankOverlay;
...
- (void)_evaluateJavaScript:(id)arg1 asAsyncFunction:(_Bool)arg2 withSourceURL:(id)arg3 withArguments:(id)arg4 forceUserGesture:(_Bool)arg5 inFrame:(id)arg6 inWorld:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)requestMediaPlaybackState:(CDUnknownBlockType)arg1;
- (void)resumeAllMediaPlayback:(CDUnknownBlockType)arg1;
- (void)suspendAllMediaPlayback:(CDUnknownBlockType)arg1;
- (void)pauseAllMediaPlayback:(CDUnknownBlockType)arg1;
...
- (void)resumeDownloadFromResumeData:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)startDownloadUsingRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)_setupPageConfiguration:(Ref_2324e752 *)arg1;
...
- (void)_setPrivateClickMeasurementConversionURLForTesting:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_setPrivateClickMeasurementOverrideTimerForTesting:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)_suspendMediaPlaybackCounter;
- (void)_doAfterActivityStateUpdate:(CDUnknownBlockType)arg1;
...
- (void)_setContinuousSpellCheckingEnabledForTesting:(_Bool)arg1;
- (double)_pageScale;
...
- (OptionSet_7e3fdc04)_viewStabilityState:(id)arg1;
- (void)_scheduleForcedVisibleContentRectUpdate;
- (void)_scheduleVisibleContentRectUpdate;
- (void)safeAreaInsetsDidChange;
- (_Bool)_scrollViewIsRubberBanding:(id)arg1;
...
- (double)_initialScaleFactor;
- (void)_zoomToFocusRect:(const struct FloatRect *)arg1 selectionRect:(const struct FloatRect *)arg2 fontSize:(float)arg3 minimumScale:(double)arg4 maximumScale:(double)arg5 allowScaling:(_Bool)arg6 forceScroll:(_Bool)arg7;
...
- (RefPtr_a6359d05)_takeViewSnapshot;
...
- (_Bool)_restoreScrollAndZoomStateForTransaction:(const struct RemoteLayerTreeTransaction *)arg1;
...
@property(copy, nonatomic, setter=_setEventAttribution:) _UIEventAttribution *_eventAttribution;
...
- (_Bool)_mayContainEditableElementsInRect:(struct CGRect)arg1;
