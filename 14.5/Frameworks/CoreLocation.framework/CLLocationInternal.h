...
- (id)initWithClientLocation:(CDStruct_f6588c5f)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4 fusionInfo:(id)arg5 rawHorizontalAccuracy:(double)arg6 rawCourseAccuracy:(double)arg7 positionContextStateType:(int)arg8 probabilityPositionContextStateIndoor:(double)arg9 probabilityPositionContextStateOutdoor:(double)arg10;
