...
@interface _MFMailCompositionContext : NSObject <EMCollectionChangeObserver, MFMailCompositionAdditionalDonating, MFMailCompositionShareSheetRecipients>
{
    ...
    _Bool _fetchingAutosavedContent;
...
@property(readonly, nonatomic) _Bool fetchingAutosavedContent; // @synthesize fetchingAutosavedContent=_fetchingAutosavedContent;
