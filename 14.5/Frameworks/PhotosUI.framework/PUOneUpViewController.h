...
- (struct CGImage *)livePhotoVideoPlaybackTileViewControllerCurrentGainMapImage:(id)arg1 outGainMapAvailable:(_Bool *)arg2 outGainMapValue:(float *)arg3;
...
- (void)_hideOverlays;
- (struct CGRect)_currentFrameForTileController:(id)arg1;
