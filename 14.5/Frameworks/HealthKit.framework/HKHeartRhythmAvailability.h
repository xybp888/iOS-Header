...
+ (id)atrialFibrillationDetectionNilAdjustedOnboardingCountryCode:(id)arg1 onboardingCompleted:(_Bool)arg2;
...
+ (_Bool)isECG1SupportedOnlyForCountryCode:(id)arg1;
...
@property(retain, nonatomic) HKActiveWatchRemoteFeatureAvailabilityDataSource *atrialFibrillationDetectionAvailabilityDataSource; // @synthesize atrialFibrillationDetectionAvailabilityDataSource=_atrialFibrillationDetectionAvailabilityDataSource;
...
- (void)_resetIsAtrialFibrillationDetectionRescindedStatusCacheWithLock:(_Bool)arg1;
...
- (void)_resetElectrocardiogramRescindedStatusCacheWithLock:(_Bool)arg1;
