...
- (id)initWithName:(id)arg1 roleId:(long long)arg2 roleEmoji:(id)arg3 keyStatus:(id)arg4 collaborativeKeyC3:(id)arg5 signatureS4:(id)arg6 isZeus:(_Bool)arg7 batteryLevel:(long long)arg8;
