...
- (_Bool)_chatHasDNDSetBasedOnChatGUID:(id)arg1 chatIdentifier:(id)arg2 groupID:(id)arg3 handles:(id)arg4 lastAddressedHandleString:(id)arg5 originalGroupID:(id)arg6 style:(long long)arg7;
...
- (id)_messageDictionaryForMessageRecord:(struct _IMDMessageRecordStruct *)arg1 copyThreadOriginator:(_Bool)arg2;
...
- (_Bool)areMyTokens:(id)arg1 inMessage:(id)arg2;
...
- (_Bool)_messageIsBusiness:(id)arg1;
...
- (_Bool)_fileURLIsActuallyAnimated:(id)arg1;
- (_Bool)_UTITypeMightBeAnimated:(id)arg1;
