...
- (void)_asynchronouslyWriteData:(id)arg1 orPlistDictionary:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)dealloc;
- (id)_initWithName:(id)arg1 fileURL:(id)arg2 writerBlock:(CDUnknownBlockType)arg3 dataSourceQueue:(id)arg4 dataSourceBlock:(CDUnknownBlockType)arg5 plistDictionarySourceBlock:(CDUnknownBlockType)arg6 plistFormat:(unsigned long long)arg7 writeDelayInterval:(double)arg8 fileResourceValues:(id)arg9;
...
- (id)initWithName:(id)arg1 writerBlock:(CDUnknownBlockType)arg2 dataSourceQueue:(id)arg3 plistFormat:(unsigned long long)arg4 plistDictionarySourceBlock:(CDUnknownBlockType)arg5;
- (id)initWithName:(id)arg1 fileURL:(id)arg2 dataSourceQueue:(id)arg3 plistFormat:(unsigned long long)arg4 plistDictionarySourceBlock:(CDUnknownBlockType)arg5;
