...
- (_Bool)_indexPathIsSectionAppendingIndexPath:(id)arg1;
...
- (void)_performBatchUpdates:(CDUnknownBlockType)arg1 customAnimationsProvider:(CDUnknownBlockType)arg2;
- (void)_performBatchUpdates:(CDUnknownBlockType)arg1 viewPropertyAnimator:(id)arg2 customAnimationsProvider:(CDUnknownBlockType)arg3;
...
- (void)_focusedItem:(id)arg1 isMinX:(_Bool *)arg2 isMaxX:(_Bool *)arg3 isMinY:(_Bool *)arg4 isMaxY:(_Bool *)arg5 inSection:(long long)arg6 shouldSearchX:(_Bool)arg7 shouldSearchY:(_Bool)arg8;
...
- (id)_focusPromiseRegionsInRect:(struct CGRect)arg1 inCoordinateSpace:(id)arg2 inOrthogonalSection:(long long)arg3;
...
- (_Bool)_indexPathIsValidSectionIndexPath:(id)arg1;
...
- (void)_performBatchUpdates:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2 invalidationContext:(id)arg3 tentativelyForReordering:(_Bool)arg4 animator:(id)arg5 animationHandler:(CDUnknownBlockType)arg6;
...
- (void)_endUpdatesWithInvalidationContext:(id)arg1 tentativelyForReordering:(_Bool)arg2 animator:(id)arg3 collectionViewAnimator:(id)arg4;
...
- (void)_updateWithItems:(id)arg1 tentativelyForReordering:(_Bool)arg2 propertyAnimator:(id)arg3 collectionViewAnimator:(id)arg4;
...
- (void)_endItemAnimationsWithInvalidationContext:(id)arg1 tentativelyForReordering:(_Bool)arg2 animator:(id)arg3 collectionViewAnimator:(id)arg4;
...
- (id)_indexPathForEntryWithTitle:(id)arg1 atIndex:(long long)arg2 validateTitles:(_Bool)arg3;
...
- (void)_updateIndex;
- (void)_setShouldPreventFocusScrollPastContentSize:(_Bool)arg1;
...
- (_Bool)_isReorderingItemAtIndexPath:(id)arg1;
...
- (void)_setDefaultAlwaysBounceVertical:(_Bool)arg1 horizontal:(_Bool)arg2;
...
- (void)_setShouldPersistSelectionOnReloadDataWhenPossible:(_Bool)arg1;
...
- (void)_setDelaysUserInitiatedItemSelection:(_Bool)arg1;
...
- (void)_setSelected:(_Bool)arg1 animated:(_Bool)arg2 forCell:(id)arg3;
- (void)_selectItemAtIndexPath:(id)arg1 animated:(_Bool)arg2 scrollPosition:(unsigned long long)arg3 notifyDelegate:(_Bool)arg4 deselectPrevious:(_Bool)arg5 performCustomSelectionAction:(_Bool)arg6;
...
- (_Bool)_delegateAllowsHighlightingItemAtIndexPath:(id)arg1;
...
- (_Bool)_isIndexPathSelectedItem:(id)arg1;
