...
+ (double)heightForStyle:(long long)arg1 orientation:(long long)arg2 inWindow:(id)arg3 isAzulBLinked:(_Bool)arg4;
...
- (double)heightForOrientation:(long long)arg1 isAzulBLinked:(_Bool)arg2;
