...
- (void)_setAllowsHighContrastForBackgroundColor:(_Bool)arg1;
...
- (struct CGRect)_boundsForSceneDraggingConstrainedToSafeArea:(_Bool)arg1;
...
@property(readonly, nonatomic, getter=_focusGroupPriority) unsigned long long focusGroupPriority;
