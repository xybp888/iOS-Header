...
@class NSArray, UIFocusGuide, UIImage, UIView, _UIDebugIssueReport, _UIDebugLogReport, _UIFocusGroup, _UIFocusGroupMap, _UIFocusItemInfo, _UIFocusMapSearchInfo, _UIFocusMovementInfo;
...
@property(readonly, nonatomic, getter=_nextFocusedGroup) _UIFocusGroup *nextFocusedGroup; // @synthesize nextFocusedGroup=_nextFocusedGroup;
@property(readonly, nonatomic, getter=_previouslyFocusedGroup) _UIFocusGroup *previouslyFocusedGroup; // @synthesize previouslyFocusedGroup=_previouslyFocusedGroup;
