...
- (void)_updateDropStateForVisibleCellsForActiveDrop:(_Bool)arg1 dropTargetIndexPath:(id)arg2;
...
- (_Bool)_isRowMultiSelect:(id)arg1 followingMacBehavior:(_Bool)arg2;
