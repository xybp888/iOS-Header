...
- (void)setMultiplayerShouldAlwaysReloadCollectionView:(_Bool)arg1;
...
- (void)setBooleanValue:(_Bool)arg1 forKey:(id)arg2;
- (_Bool)booleanValueForKey:(id)arg1;
- (_Bool)booleanValueForKey:(id)arg1 defaultValue:(_Bool)arg2;
...
- (void)getMultiplayerAllowedPlayerTypeWithHandler:(CDUnknownBlockType)arg1;
