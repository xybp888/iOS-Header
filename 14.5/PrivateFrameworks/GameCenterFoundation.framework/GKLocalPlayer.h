...
@interface GKLocalPlayer : GKPlayer <NSCoding, NSSecureCoding, GKSavedGameListener>
{
    ...
    _Bool _isShowingAuthenticationUI;
...
- (void)_loadFriendPlayersWithFilter:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
...
- (void)setFriendListAuthorizationStatus:(long long)arg1 forBundleID:(id)arg2 handler:(CDUnknownBlockType)arg3;
...
- (void)_updatePerGameSettings:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (void)_loadFriendsListPerGameAuthorizedFlow:(CDUnknownBlockType)arg1;
- (void)_loadFriendsListPerGameNotDeterminedFlow:(CDUnknownBlockType)arg1;
- (void)_loadFriendsListGlobalAccessOptInFlow:(CDUnknownBlockType)arg1;
- (void)loadFriendsWithIdentifiers:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)loadFriends:(CDUnknownBlockType)arg1;
- (void)loadFriendsAuthorizationStatus:(CDUnknownBlockType)arg1;
