...
- (void)applySourceChangesToComposition:(id)arg1 source:(id)arg2 withBlock:(CDUnknownBlockType)arg3 executeSynchronously:(_Bool)arg4 completionBlock:(CDUnknownBlockType)arg5;
