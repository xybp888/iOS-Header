...
- (id)bindColorAndVelocityWithMetalContext:(id)arg1 shouldFillBackground:(_Bool)arg2;
- (struct CATransform3D)adjustTransformForMotionBlurBuffer:(struct CATransform3D)arg1;
- (struct CGSize)p_updateMaxVelocityInShadersWithScale:(double)arg1 isColorFBO:(_Bool)arg2;
