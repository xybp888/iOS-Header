...
@property(retain, nonatomic) ICPAAudioQualityDictionary *providedAudioQuality; // @synthesize providedAudioQuality=_providedAudioQuality;
@property(retain, nonatomic) ICPAAudioQualityDictionary *targetedAudioQuality; // @synthesize targetedAudioQuality=_targetedAudioQuality;
@property(retain, nonatomic) ICPAPlayModeDictionary *playMode; // @synthesize playMode=_playMode;
@property(retain, nonatomic) NSMutableArray *buildFeatures; // @synthesize buildFeatures=_buildFeatures;
...
@property(retain, nonatomic) ICPAPlayActivityEnqueuerProperties *enqueuerProperties; // @synthesize enqueuerProperties=_enqueuerProperties;
...
@property(readonly, nonatomic) _Bool hasProvidedAudioQuality;
@property(readonly, nonatomic) _Bool hasTargetedAudioQuality;
@property(nonatomic) _Bool hasPlaybackFormatPreference;
@property(nonatomic) int playbackFormatPreference; // @synthesize playbackFormatPreference=_playbackFormatPreference;
@property(nonatomic) _Bool hasAudioQualityPreference;
@property(nonatomic) int audioQualityPreference; // @synthesize audioQualityPreference=_audioQualityPreference;
@property(readonly, nonatomic) _Bool hasPlayMode;
