...
@class NSArray, NSAttributedString, NSDate, NSMutableArray, NSMutableAttributedString, NSObject, NSString, NSUndoManager, TTMergeableAttributedString, TTMergeableStringUndoGroup, TTMergeableStringVersionedDocument;
...
@property(nonatomic) long long ignoreTimestampUpdatesCount; // @synthesize ignoreTimestampUpdatesCount=_ignoreTimestampUpdatesCount;
...
- (void)updateTimestampIfNeededForRange:(struct _NSRange)arg1;
