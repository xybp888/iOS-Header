...
- (void)requestImageProcessingTask:(NSString *)arg1 withIdentifier:(unsigned long long)arg2 forAssetURLs:(NSArray *)arg3 withSandboxTokens:(NSArray *)arg4 options:(NSDictionary *)arg5 andReply:(void (^)(NSError *))arg6;
