...
- (void)updateOverrideFrequencyControlForIdentifier:(id)arg1 value:(_Bool)arg2;
- (_Bool)isOverrideFrequencyControlForIdentifier:(id)arg1;
- (void)updateOverrideHoldoutForIdentifier:(id)arg1 value:(_Bool)arg2;
- (_Bool)isOverrideHoldoutForIdentifier:(id)arg1;
