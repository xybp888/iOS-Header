...
@class CARSessionRequestClient, CRBluetoothManager, CRCarKitMonitoringServiceAgent, CRCarPlayPreferences, CRInstrumentClusterURLManager, CRVehicle, CRVehicleAccessory, CRVehicleAccessoryManager, CRVehicleStore, CRWiFiCarManager, CRWirelessSessionAssertionManager, NSMutableArray, NSMutableDictionary, NSNumber, NSString;
