...
@property(readonly, nonatomic) _Bool stillImageGeometricDistortionCorrectionInDCProcessorSupported;
@property(readonly, nonatomic) _Bool intelligentDistortionCorrectionSupported;
@property(readonly, nonatomic) int dcProcessorVersion;
...
- (struct CGSize)stabilizationOverscanFromSensorForFESCropDimensions:(CDStruct_79c71658)arg1 preferSIFRFormat:(_Bool)arg2 geometricDistortionCorrection:(_Bool)arg3 useFESCompanionIndex:(_Bool)arg4;
...
- (CDStruct_79c71658)postGDCCropDimensions;
- (CDStruct_79c71658)preGDCSensorCropDimensions;
- (CDStruct_79c71658)sensorCropDimensions;
- (CDStruct_79c71658)cinematicFramingOutputDimensions;
