...
- (void)_onQueue_removeParallelPlaceholder;
...
- (void)_finishAppInstallAtURL:(id)arg1 result:(_Bool)arg2 error:(id)arg3;
...
- (void)_finishPlaceholderInstallAtURL:(id)arg1 result:(_Bool)arg2 error:(id)arg3;
- (_Bool)_installApplication:(id)arg1 isPlaceholder:(_Bool)arg2 options:(id)arg3 retries:(unsigned long long)arg4 error:(id *)arg5;
- (_Bool)_doRetryingInstallOperationForPlaceholder:(_Bool)arg1 retries:(unsigned long long)arg2 error:(id *)arg3 installAttemptBlock:(CDUnknownBlockType)arg4;
- (void)_onQueue_acquireAssertionIfNeededForPlaceholder:(_Bool)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)_internalInitWithSeed:(id)arg1;
