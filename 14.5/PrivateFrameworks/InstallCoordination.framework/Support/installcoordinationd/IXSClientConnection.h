...
- (void)_remote_uninstallAppWithBundleID:(id)arg1 options:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_remote_createAppInstallCoordinatorWithSeed:(id)arg1 createIfNotExisting:(_Bool)arg2 requireMatchingIntent:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
