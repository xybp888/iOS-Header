...
- (void).cxx_destruct;
@property(readonly) _Bool transcodeFragment; // @synthesize transcodeFragment=_transcodeFragment;
...
@property(retain) HMICameraVideoAnalyzerRequest *currentRequest; // @synthesize currentRequest=_currentRequest;
