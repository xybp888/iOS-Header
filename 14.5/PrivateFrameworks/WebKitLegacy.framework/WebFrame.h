...
+ (Ref_50ba636d)_createSubframeWithOwnerElement:(struct HTMLFrameOwnerElement *)arg1 frameName:(const struct String *)arg2 frameView:(id)arg3;
+ (void)_createMainFrameWithPage:(struct Page *)arg1 frameName:(const struct String *)arg2 frameView:(id)arg3;
+ (Ref_50ba636d)_createFrameWithPage:(struct Page *)arg1 frameName:(const struct String *)arg2 frameView:(id)arg3 ownerElement:(struct HTMLFrameOwnerElement *)arg4;
...
- (Optional_19341aab)_convertToDOMRange:(struct _NSRange)arg1 rangeIsRelativeTo:(unsigned char)arg2;
- (Optional_19341aab)_convertToDOMRange:(struct _NSRange)arg1;
...
- (void)setSelectedDOMRange:(id)arg1 affinity:(unsigned long long)arg2 closeTyping:(_Bool)arg3 userTriggered:(_Bool)arg4;
- (void)setSelectedDOMRange:(id)arg1 affinity:(unsigned long long)arg2 closeTyping:(_Bool)arg3;
- (id)selectedDOMRange;
