...
- (id)_activationMatrixFromInferenceCache:(id)arg1 forDrawing:(id)arg2 outStrokeEndings:(vector_afed86a5 *)arg3;
...
- (long long)_classifyEdgeDrawingsFromContexts:(id)arg1 allEdges:(vector_6acbd301 *)arg2 segmentationNetwork:(struct Network *)arg3 candidateNetwork:(struct Network *)arg4 cachedEdgeSet:(set_aa516436 *)arg5 completeDrawing:(id)arg6 allowSmallerFinalBatch:(_Bool)arg7 shouldCancel:(CDUnknownBlockType)arg8;
