...
@property(readonly, nonatomic, getter=isAssistantHomeNameDropDisabled) _Bool assistantHomeNameDropDisabled;
@property(readonly, nonatomic, getter=isControlCenterEnabled) _Bool controlCenterEnabled;
