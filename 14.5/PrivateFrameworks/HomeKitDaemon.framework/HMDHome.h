...
+ (void)_initialize;
+ (_Bool)isCarPlayPaired;
- (void).cxx_destruct;
@property double homepodSettingsCreationTimestamp; // @synthesize homepodSettingsCreationTimestamp=_homepodSettingsCreationTimestamp;
@property double homepodSetupLatency; // @synthesize homepodSetupLatency=_homepodSetupLatency;
...
@property(retain, nonatomic) HMDBonjourBrowserHelper *borderRouterBrowser; // @synthesize borderRouterBrowser=_borderRouterBrowser;
...
- (int)multiUserSettingsValueTypeForKeyPath:(id)arg1;
- (id)logIdentifier;
...
- (_Bool)_enqueueRetrievalCompletionTuple:(id)arg1 forAccessory:(id)arg2;
...
- (id)_getLogEventsForOperation:(_Bool)arg1 accessories:(id)arg2 requestMap:(id)arg3 identifier:(id)arg4 source:(unsigned long long)arg5 bundleID:(id)arg6;
...
- (CDUnknownBlockType)__readWriteResponseHandler:(id)arg1;
...
- (_Bool)requiresUnlockToAccessCharacteristic:(id)arg1 withMessage:(id)arg2;
- (_Bool)isAccessAllowedForCharacteristic:(id)arg1 withMessage:(id)arg2;
...
- (void)_sendClientCharacteristicsChangedNotification:(id)arg1 identifier:(id)arg2 request:(id)arg3 entitledClientsOnly:(_Bool)arg4 multiPartResponse:(_Bool)arg5 moreMessagesInMultipart:(_Bool)arg6 withCompletionHandler:(CDUnknownBlockType)arg7;
...
- (void)_postInternalNotificationForChangedCharacterisitics:(id)arg1 modifiedCharacteristics:(id)arg2 changedByThisDevice:(_Bool)arg3 residentShouldNotifyPeers:(_Bool)arg4 message:(id)arg5;
...
- (CDUnknownBlockType)_handleRemoveAccessoryAfterUserConsentCompletion:(id)arg1 message:(id)arg2;
...
- (void)_registerForReachabilityChangeNotificationsEnabled:(_Bool)arg1;
- (void)__registerForRemoteAccessoryReachabilityNotifications:(_Bool)arg1;
...
- (void)setCameraReachabilityEventNotificationsEnabled:(_Bool)arg1 forAccessory:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (_Bool)configureWithHomeManager:(id)arg1 accessoriesPresent:(id)arg2 source:(unsigned long long)arg3;
...
- (void)dealloc;
- (void)unconfigure;
- (id)initWithName:(id)arg1 uuid:(id)arg2 defaultRoomUUID:(id)arg3 owner:(id)arg4 homeManager:(id)arg5 presenceAuth:(id)arg6 metricsDispatcherFactory:(id)arg7 currentUserFactory:(CDUnknownBlockType)arg8 residentDeviceManagerFactory:(CDUnknownBlockType)arg9;
