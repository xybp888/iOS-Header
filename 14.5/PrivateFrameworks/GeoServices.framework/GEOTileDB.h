...
- (void)_trackFailureOnDBQueueWithKey:(const struct _GEOTileKey *)arg1 tileSet:(unsigned int)arg2 shouldProactivelyLoad:(_Bool)arg3;
...
- (void)trackFailureForKey:(const struct _GEOTileKey *)arg1 tileSet:(unsigned int)arg2 shouldProactivelyLoad:(_Bool)arg3;
