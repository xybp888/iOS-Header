...
- (id)description;
@property(nonatomic) _Bool hasShouldUseDistanceFeatureServerResults;
@property(nonatomic) _Bool shouldUseDistanceFeatureServerResults;
@property(nonatomic) _Bool hasShouldEnableGrayscaleHighlighting;
