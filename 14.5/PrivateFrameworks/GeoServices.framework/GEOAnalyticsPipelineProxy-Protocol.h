...
@class GEOAnalyticsPipelineEvalStatus, GEOUserSessionEntity, NSArray, NSData, NSNumber, NSObject, NSString;
@protocol OS_dispatch_queue;

@protocol GEOAnalyticsPipelineProxy <NSObject>
- (void)runAggregationTasks;
- (GEOAnalyticsPipelineEvalStatus *)getEvalStatus;
- (void)showEvalDataWithVisitorBlock:(_Bool (^)(GEOLogMessage *))arg1;
