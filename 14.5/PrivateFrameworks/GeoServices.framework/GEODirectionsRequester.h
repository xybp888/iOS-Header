...
- (void)startRequest:(id)arg1 auditToken:(id)arg2 callbackQueue:(id)arg3 finished:(CDUnknownBlockType)arg4 networkActivity:(CDUnknownBlockType)arg5 error:(CDUnknownBlockType)arg6;
