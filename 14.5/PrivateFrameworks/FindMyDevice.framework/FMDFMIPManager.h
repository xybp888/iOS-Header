...
- (void)updatedConfigReceived:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)stopLocationMonitoring:(CDUnknownBlockType)arg1;
- (void)startLocationMonitoring:(CDUnknownBlockType)arg1;
- (void)fetchAPNSTokenWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)fetchAccessoryConfigurations:(CDUnknownBlockType)arg1;
