...
- (_Bool)changeVolume:(_Bool)arg1 forCategory:(id)arg2;
...
- (_Bool)changeVolumeForRoute:(_Bool)arg1 forCategory:(id)arg2 mode:(id)arg3 route:(id)arg4 deviceIdentifier:(id)arg5 andRouteSubtype:(id)arg6;
...
- (_Bool)changeActiveCategoryVolume:(_Bool)arg1 forRoute:(id)arg2 andDeviceIdentifier:(id)arg3;
...
- (_Bool)changeActiveCategoryVolume:(_Bool)arg1;
- (_Bool)changeActiveCategoryVolumeBy:(float)arg1;
- (_Bool)getVibeIntensity:(float *)arg1;
- (_Bool)setVibeIntensityTo:(float)arg1;
- (_Bool)changeActiveCategoryVolume:(_Bool)arg1 fallbackCategory:(id)arg2 resultVolume:(float *)arg3 affectedCategory:(id *)arg4;
