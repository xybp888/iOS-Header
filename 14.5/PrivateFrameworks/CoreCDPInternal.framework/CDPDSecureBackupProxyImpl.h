...
- (void)canUpdateDataPrivacyStatusWithCompletion:(CDUnknownBlockType)arg1;
- (void)dataPrivacyStatusWithCompletion:(CDUnknownBlockType)arg1;
- (void)setDataPrivacyEnabled:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)recoveryKeyAvailabilityWithCompletion:(CDUnknownBlockType)arg1;
