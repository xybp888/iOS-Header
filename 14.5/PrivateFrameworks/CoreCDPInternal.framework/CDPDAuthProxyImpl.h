...
- (void)setDataPrivacyStatusEnabled:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (void)getDevicesLosingAccountAccessWithCompletion:(CDUnknownBlockType)arg1;
