...
- (id)textMarkersForRange:(const Optional_19341aab *)arg1;
...
- (Optional_19341aab)rangeForTextMarkers:(id)arg1;
...
- (Optional_19341aab)rangeFromMarkers:(id)arg1 withText:(id)arg2;
