...
@property(retain, nonatomic) NSArray *colorSpecifiers; // @synthesize colorSpecifiers=_colorSpecifiers;
...
@property(retain, nonatomic) PSSpecifier *genderProto; // @synthesize genderProto=_genderProto;
