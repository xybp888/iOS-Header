...
- (struct CGImage *)_createUndecoratedAppIconForData:(id)arg1 ofSize:(struct CGSize)arg2 scale:(double)arg3;
- (id)processedPNGAppIconDataForData:(id)arg1 ofType:(id)arg2 size:(struct CGSize)arg3 scale:(double)arg4;
