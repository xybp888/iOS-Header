...
@interface NTKLabelCollectionNode : NTKCollectionNode
{
    ...
    double _fontSize;
    double _color;
    const CDStruct_068597b6 *_positions;
}

+ (void)applyLabelPositions:(const CDStruct_068597b6 *)arg1 withCenter:(struct CGPoint)arg2 toNodes:(id)arg3 forDevice:(id)arg4;
+ (void)applyLabelPositions:(const CDStruct_068597b6 *)arg1 toNodes:(id)arg2 forDevice:(id)arg3;
+ (void)applyLabelPosition:(const CDStruct_068597b6 *)arg1 withCenter:(struct CGPoint)arg2 toNode:(id)arg3 forDevice:(id)arg4;
+ (void)applyLabelPosition:(const CDStruct_068597b6 *)arg1 toNode:(id)arg2 forDevice:(id)arg3;
@property(nonatomic) const CDStruct_068597b6 *positions; // @synthesize positions=_positions;
