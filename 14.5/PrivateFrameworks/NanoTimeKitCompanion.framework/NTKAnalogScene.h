...
- (void)preRender;
- (id)displayTime;
- (void)applyLabelPositions:(const CDStruct_068597b6 *)arg1 withCenter:(struct CGPoint)arg2 toNodes:(id)arg3;
- (void)applyLabelPositions:(const CDStruct_068597b6 *)arg1 toNodes:(id)arg2;
