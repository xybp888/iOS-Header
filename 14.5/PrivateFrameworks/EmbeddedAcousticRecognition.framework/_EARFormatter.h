...
- (vector_2f7ba0dc)formatWords:(const vector_2f7ba0dc *)arg1 task:(id)arg2 language:(id)arg3 leftContext:(const vector_2f7ba0dc *)arg4 separateAutoEndPunctuation:(_Bool)arg5 partialResults:(vector_2f7ba0dc *)arg6 timestampOffset:(unsigned int)arg7 zeroTimestamp:(_Bool)arg8;
