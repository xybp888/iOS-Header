...
- (void)_kickOffWriteIfNeededForSyncType:(long long)arg1 completion:(CDUnknownBlockType)arg2 isUsingStingRay:(_Bool)arg3;
...
- (void)_processModifyPerRecordCallBack:(id)arg1 error:(id)arg2 isUsingStingRay:(_Bool)arg3 recordIDtoGUIDmap:(id)arg4;
