...
+ (_Bool)_shouldReloadAgentsForAccountChange:(id)arg1;
+ (id)clientsToInterrogate;
- (void).cxx_destruct;
@property(retain, nonatomic) NSCountedSet *simulatedCalDAVHostnames; // @synthesize simulatedCalDAVHostnames=_simulatedCalDAVHostnames;
