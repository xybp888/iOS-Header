...
@property(readonly, nonatomic) UIImage *blackA2AckImage;
@property(readonly, nonatomic) UIImage *blackA1AckImage;
@property(readonly, nonatomic) UIImage *blackH2AckImage;
@property(readonly, nonatomic) UIImage *blackH1AckImage;
@property(readonly, nonatomic) UIImage *blackHaAckImage;
@property(readonly, nonatomic) UIImage *blackQuestionMarkDotAckImage;
@property(readonly, nonatomic) UIImage *blackQuestionMarkGlyphAckImage;
@property(readonly, nonatomic) UIImage *blackExclamationLeftAckImage;
@property(readonly, nonatomic) UIImage *blackExclamationRightAckImage;
@property(readonly, nonatomic) UIImage *blackThumbsDownAckImage;
@property(readonly, nonatomic) UIImage *blackThumbsUpAckImage;
@property(readonly, nonatomic) UIImage *blackHeartAckImage;
...
@property(readonly, nonatomic) double businessExtensionBalloonMaximumHeight;
