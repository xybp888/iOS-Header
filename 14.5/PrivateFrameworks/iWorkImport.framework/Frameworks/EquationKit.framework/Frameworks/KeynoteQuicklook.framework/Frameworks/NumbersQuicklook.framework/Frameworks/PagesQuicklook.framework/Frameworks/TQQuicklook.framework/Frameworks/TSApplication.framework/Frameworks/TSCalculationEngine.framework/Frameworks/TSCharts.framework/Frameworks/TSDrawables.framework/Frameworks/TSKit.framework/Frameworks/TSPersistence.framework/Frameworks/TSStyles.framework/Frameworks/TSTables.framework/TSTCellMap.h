...
@interface TSTCellMap : TSPObject <NSCopying, TSTCellMapChangeDescriptorDelivering>
{
    ...
    struct unordered_map<TSKUIDStructCoord, TSTCell *, std::__1::hash<TSKUIDStructCoord>, std::__1::equal_to<TSKUIDStructCoord>, std::__1::allocator<std::__1::pair<const TSKUIDStructCoord, TSTCell *>>> _searchableUIDMap;
    _Bool _uidBased;
...
- (id)cellMapMaskedByUIDs:(const TSKUIDStructVectorTemplate_724280d5 *)arg1 inRows:(_Bool)arg2;
...
- (void)clearMerges;
- (void)remapUIDsByColumnMap:(const struct TSKUIDStructMap *)arg1 rowMap:(const struct TSKUIDStructMap *)arg2 ownerMap:(const struct TSKUIDStructMap *)arg3;
- (id)mergeActions;
...
- (void)addPrecopiedCells:(vector_73284f0b *)arg1 andCellUIDs:(vector_e52772ba *)arg2;
