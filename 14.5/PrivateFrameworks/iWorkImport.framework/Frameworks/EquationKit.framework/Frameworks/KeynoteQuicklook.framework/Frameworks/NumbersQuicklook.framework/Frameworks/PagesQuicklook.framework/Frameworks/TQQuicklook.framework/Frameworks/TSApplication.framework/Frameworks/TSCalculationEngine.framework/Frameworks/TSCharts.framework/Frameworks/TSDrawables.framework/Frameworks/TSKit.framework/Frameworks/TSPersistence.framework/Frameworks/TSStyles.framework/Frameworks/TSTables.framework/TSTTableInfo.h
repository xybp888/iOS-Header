...
+ (id)tableInfoForTableUID:(const struct TSKUIDStruct *)arg1 withCalcEngine:(id)arg2;
...
- (struct TSCECategoryRef)categoryRefReferringToCellRef:(const RefTypeHolder_ca5e87e3 *)arg1;
- (_Bool)isCategoryGroupOrParentsCollapsed:(struct TSKUIDStruct)arg1;
...
- (id)indexesForLabelRowsUpToGroupLevel:(unsigned char)arg1 omitGroupsWithUids:(const unordered_set_ab1e6361 *)arg2;
...
- (id)indexesForSummaryRowsUpToGroupLevel:(unsigned char)arg1 omitGroupsWithUids:(const unordered_set_ab1e6361 *)arg2;
...
- (int)insertRowsAtIndex:(unsigned int)arg1 uids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2 metadatas:(id)arg3 tableArea:(unsigned long long)arg4 unsetFilterHidingAction:(_Bool)arg5;
- (int)insertRowsAtIndex:(unsigned int)arg1 uids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2 metadatas:(id)arg3 tableArea:(unsigned long long)arg4;
- (int)insertColumnsAtIndex:(unsigned short)arg1 uids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2 metadatas:(id)arg3 tableArea:(unsigned long long)arg4;
...
- (id)changeDescriptorsForReorganizingFromRowUids:(const TSKUIDStructVectorTemplate_724280d5 *)arg1 toRowUids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2;
- (id)mappingFromRowUids:(const TSKUIDStructVectorTemplate_724280d5 *)arg1 toRowUids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2;
