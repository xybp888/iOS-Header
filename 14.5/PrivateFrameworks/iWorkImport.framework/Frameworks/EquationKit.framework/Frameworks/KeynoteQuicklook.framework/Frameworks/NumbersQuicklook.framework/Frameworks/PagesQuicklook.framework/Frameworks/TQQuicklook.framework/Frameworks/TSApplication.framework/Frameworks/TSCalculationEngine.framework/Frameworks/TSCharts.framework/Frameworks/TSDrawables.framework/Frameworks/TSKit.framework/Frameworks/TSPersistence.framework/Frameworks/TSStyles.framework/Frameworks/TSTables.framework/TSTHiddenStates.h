...
- (void)deleteColumnsFromBaseRange:(struct _NSRange)arg1 columnUids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2;
- (void)deleteRowsFromBaseRange:(struct _NSRange)arg1 rowUids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2;
...
- (id)initWithHiddenStatesOwner:(id)arg1 hiddenStatesUid:(const struct TSKUIDStruct *)arg2;
