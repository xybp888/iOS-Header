...
- (_Bool)evaluateAtCellID:(struct TSUCellCoord)arg1 inFormulaOwner:(const struct TSKUIDStruct *)arg2 calcEngine:(id)arg3;
...
- (void)getPrecedents:(struct TSCEReferenceSet *)arg1 calcEngine:(id)arg2 hostOwnerUID:(const struct TSKUIDStruct *)arg3 hostCellID:(const struct TSUCellCoord *)arg4;
