...
+ (id)tableModelForTableUID:(const struct TSKUIDStruct *)arg1 withCalcEngine:(id)arg2;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (void)validate;
- (void)validateTableStylesInSameStylesheetExpectingDocSS:(_Bool)arg1;
...
- (void)remapTableUIDsInFormulasWithMap:(const struct TSKUIDStructMap *)arg1 calcEngine:(id)arg2 bakeForBadRefs:(_Bool)arg3;
...
- (int)insertRowsAtIndex:(struct TSUModelRowIndex)arg1 uids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2 metadatas:(id)arg3 tableArea:(unsigned long long)arg4 unsetFilterHidingAction:(_Bool)arg5;
- (int)insertColumnsAtIndex:(struct TSUModelColumnIndex)arg1 uids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2 metadatas:(id)arg3 tableArea:(unsigned long long)arg4;
- (int)insertRowsInBaseRange:(struct _NSRange)arg1 uids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2 metadata:(id)arg3 unsetFilterHidingAction:(_Bool)arg4;
...
- (id)textStyleForCalcEngineAtBaseCellCoord:(struct TSUModelCellCoord)arg1 isDefault:(out _Bool *)arg2;
- (int)cellValueTypeAtBaseCellCoord:(struct TSUModelCellCoord)arg1;
- (id)formatForCalcEngineAtBaseCellCoord:(struct TSUModelCellCoord)arg1 formatIsExplicitOut:(_Bool *)arg2;
...
- (int)setCell:(id)arg1 atBaseCellCoord:(struct TSUModelCellCoord)arg2 ignoreFormula:(_Bool)arg3 clearImportWarnings:(_Bool)arg4 calcEngine:(id)arg5;
...
- (void)updateCalculationEngineForFormula:(id)arg1 inBaseCellCoord:(struct TSUModelCellCoord)arg2 usingCalcEngine:(id)arg3;
...
- (id)initWithContext:(id)arg1 rowUids:(const TSKUIDStructVectorTemplate_724280d5 *)arg2 columnUids:(const TSKUIDStructVectorTemplate_724280d5 *)arg3 styles:(id)arg4 stylePreset:(id)arg5 tableInfo:(id)arg6;
- (id)initWithContext:(id)arg1 tableUID:(struct TSKUIDStruct)arg2 columnRowUIDMap:(id)arg3 styles:(id)arg4 stylePreset:(id)arg5 tableInfo:(id)arg6;
- (id)newCell;
...
- (void)logTableTileAuditStatus:(_Bool)arg1 withVersion:(unsigned long long)arg2;
...
- (id)mutableIndexesForUIDs:(const TSKUIDStructVectorTemplate_724280d5 *)arg1 isRows:(_Bool)arg2;
- (TSKUIDStructVectorTemplate_724280d5)UIDsForIndexes:(id)arg1 isRows:(_Bool)arg2;
