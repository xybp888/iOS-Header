...
- (id)description;
- (_Bool)mergedFormatChangedByRemovingRowUID:(const struct TSKUIDStruct *)arg1;
- (_Bool)mergedFormatChangedByAddingRowUID:(const struct TSKUIDStruct *)arg1 andCellValue:(id)arg2;
