...
- (_Bool)containsStartOfSelection:(id)arg1;
- (void)viewDidAppear;
- (void)gesturesDidEnd;
...
- (struct _NSRange)rangeOfDropCapAdornmentAtPoint:(struct CGPoint)arg1;
...
- (Class)layerClass;
- (_Bool)p_hasRenderableTextCommentsLookingForHighlights:(_Bool)arg1;
...
- (CDStruct_f9ea3fe9)lineMetricsAtCharIndex:(unsigned long long)arg1;
- (CDStruct_f9ea3fe9)lineMetricsAtPoint:(struct CGPoint)arg1;
- (CDStruct_f9ea3fe9)p_lineMetricsAtPoint:(struct CGPoint)arg1 allowNotFound:(_Bool)arg2;
