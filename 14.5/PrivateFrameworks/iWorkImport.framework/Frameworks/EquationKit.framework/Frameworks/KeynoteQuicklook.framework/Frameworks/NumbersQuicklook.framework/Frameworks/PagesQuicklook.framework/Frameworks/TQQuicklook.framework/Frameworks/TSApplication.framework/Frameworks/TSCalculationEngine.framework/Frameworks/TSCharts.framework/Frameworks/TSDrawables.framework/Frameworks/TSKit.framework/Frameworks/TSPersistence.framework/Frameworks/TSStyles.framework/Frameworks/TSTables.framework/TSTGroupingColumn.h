...
- (id)initWithColumnUid:(struct TSKUIDStruct)arg1 groupingType:(int)arg2;
- (id)initWithGroupingColumnUid:(struct TSKUIDStruct)arg1 columnUid:(struct TSKUIDStruct)arg2 groupingType:(int)arg3;
