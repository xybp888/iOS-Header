...
- (vector_a1208d01)valuesForCategoryRef:(const struct TSCECategoryRef *)arg1 atRowUid:(const struct TSKUIDStruct *)arg2 error:(id *)arg3;
- (vector_0737b28f)unorderedCellRefsForCategoryRef:(const struct TSCECategoryRef *)arg1 atRowUid:(const struct TSKUIDStruct *)arg2;
- (vector_2431c21e)categoryRefsForSpanningCategoryRef:(const struct TSCECategoryRef *)arg1;
- (vector_0737b28f)cellRefsForCategoryRef:(const struct TSCECategoryRef *)arg1 atRowUid:(const struct TSKUIDStruct *)arg2;
- (unsigned char)aggregateTypeForCategoryRef:(const struct TSCECategoryRef *)arg1;
- (void)resetExternalReferencesToGroupNode:(struct TSKUIDStruct)arg1 inGroupBy:(const struct TSKUIDStruct *)arg2;
...
- (void)markCoordsDirty:(const struct TSCECellCoordSet *)arg1 inOwner:(const struct TSKUIDStruct *)arg2;
...
- (vector_38b190b0)formulaCoordsInRange:(const struct TSCERangeCoordinate *)arg1 inOwner:(const struct TSKUIDStruct *)arg2;
- (vector_38b190b0)formulaCoordsReferringToRange:(const struct TSCERangeRef *)arg1 fromOwner:(const struct TSKUIDStruct *)arg2 skipSpanning:(_Bool)arg3;
- (vector_38b190b0)formulaCoordsReferringToRange:(const struct TSCERangeRef *)arg1 fromOwner:(const struct TSKUIDStruct *)arg2;
...
- (void)replaceFormulaIfPrecedentsDifferAt:(const struct TSUCellCoord *)arg1 inOwner:(const struct TSKUIDStruct *)arg2 precedents:(id)arg3 replaceOptions:(const struct TSCEReplaceFormulaOptions *)arg4;
...
- (TSKUIDStructVectorTemplate_724280d5)allRefResolverOwnerUIDs;
- (_Bool)shouldForceRegisterAllTables;
- (_Bool)allOwnersRegistered;
- (struct TSCESubFormulaOwnerID)subOwnerIDForFormulaOwnerUID:(const struct TSKUIDStruct *)arg1;
- (struct TSKUIDStruct)formulaOwnerUIDForSubOwnerID:(const struct TSCESubFormulaOwnerID *)arg1;
