...
- (id)tableInfo;
- (id)tableModel;
- (id)initWithCalcEngine:(id)arg1 tableUID:(const struct TSKUIDStruct *)arg2 uidRange:(const struct TSKUIDStructTract *)arg3 preserveFlags:(unsigned char)arg4;
- (id)initWithCalcEngine:(id)arg1 baseRangeRef:(const RefTypeHolder_41ae741d *)arg2 preserveFlags:(unsigned char)arg3;
- (id)initWithCalcEngine:(id)arg1 chromeRangeRef:(const RefTypeHolder_b26a20d2 *)arg2 preserveFlags:(unsigned char)arg3;
- (id)initWithCalcEngine:(id)arg1 viewRangeRef:(const RefTypeHolder_7723cd4d *)arg2 preserveFlags:(unsigned char)arg3;
