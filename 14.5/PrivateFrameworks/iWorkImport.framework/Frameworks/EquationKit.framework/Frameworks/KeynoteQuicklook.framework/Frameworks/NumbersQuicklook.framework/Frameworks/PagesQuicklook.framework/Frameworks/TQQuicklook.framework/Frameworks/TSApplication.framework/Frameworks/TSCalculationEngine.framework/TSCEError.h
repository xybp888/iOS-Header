...
+ (void)raiseInvalidIntersectionError:(vector_99ef3555)arg1 hostTableUID:(const struct TSKUIDStruct *)arg2 calcEngine:(id)arg3;
...
+ (id)referenceToNonexistentTableError:(const struct TSKUIDStruct *)arg1;
