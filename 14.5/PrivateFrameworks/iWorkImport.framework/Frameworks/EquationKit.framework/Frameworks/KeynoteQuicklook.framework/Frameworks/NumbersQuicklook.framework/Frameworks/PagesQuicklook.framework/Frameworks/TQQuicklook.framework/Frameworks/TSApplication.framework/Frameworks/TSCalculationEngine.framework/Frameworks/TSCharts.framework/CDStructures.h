...
struct ChartAxisGenericPropertyMapArchive {
    ...
    struct ShadowArchive *_field13;
    struct StrokeArchive *_field14;
    struct FormatStructArchive *_field15;
    struct ChartsNSNumberDoubleArchive *_field16;
    struct ChartsNSNumberDoubleArchive *_field17;
    float _field18;
    int _field19;
    int _field20;
    int _field21;
...
struct GridRow {
    CDUnknownFunctionPointerType *_field1;
    struct InternalMetadata _field2;
    struct RepeatedPtrField<TSCH::GridValue> _field3;
    struct CachedSize _field4;
};
...
struct ObjectBounds {
    ...
    struct vector<TSCH3D::Math::ExtendedTypesDetails::box<glm::detail::tvec3<float>>, std::__1::allocator<TSCH3D::Math::ExtendedTypesDetails::box<glm::detail::tvec3<float>>>> _boxes;
};

struct ObjectState {
    struct ObjcSharedPtr<NSSet> _effects;
    struct vector<TSCH3D::ObjectState::Lookup<TSCH3D::AttributeSpecs>, std::__1::allocator<TSCH3D::ObjectState::Lookup<TSCH3D::AttributeSpecs>>> _attributes;
    struct vector<TSCH3D::ObjectState::Lookup<TSCH3D::TextureAttributes>, std::__1::allocator<TSCH3D::ObjectState::Lookup<TSCH3D::TextureAttributes>>> _textures;
};

struct ObjectStateMatchObject {
    struct ObjcSharedPtr<NSSet> _effects;
    struct vector<TSCH3D::ResourceAttributeState, std::__1::allocator<TSCH3D::ResourceAttributeState>> _attributes;
    struct vector<TSCH3D::TextureAttributeState, std::__1::allocator<TSCH3D::TextureAttributeState>> _textures;
};
...
struct StyleSwapUndoTuplesArchive {
    CDUnknownFunctionPointerType *_field1;
    struct InternalMetadata _field2;
    RepeatedPtrField_6c786866 _field3;
    struct CachedSize _field4;
};
...
struct vector<TSCH3D::Math::ExtendedTypesDetails::plane<glm::detail::tvec3<float>>, std::__1::allocator<TSCH3D::Math::ExtendedTypesDetails::plane<glm::detail::tvec3<float>>>> {
    plane_2e9f056b *_field1;
    plane_2e9f056b *_field2;
