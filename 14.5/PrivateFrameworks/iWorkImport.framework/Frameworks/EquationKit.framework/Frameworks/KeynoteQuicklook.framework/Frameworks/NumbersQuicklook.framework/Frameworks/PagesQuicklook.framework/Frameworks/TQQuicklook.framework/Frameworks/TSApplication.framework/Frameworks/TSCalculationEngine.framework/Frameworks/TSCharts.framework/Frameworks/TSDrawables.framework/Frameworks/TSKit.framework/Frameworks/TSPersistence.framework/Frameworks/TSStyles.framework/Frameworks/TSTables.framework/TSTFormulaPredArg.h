...
- (void)setBaseCellRef:(const RefTypeHolder_cdce8eef *)arg1 preserveColumn:(_Bool)arg2 preserveRow:(_Bool)arg3;
- (void)setBaseCellRef:(const RefTypeHolder_cdce8eef *)arg1 preserveFlags:(const struct TSUPreserveFlags *)arg2;
- (void)setBaseCellRef:(const RefTypeHolder_cdce8eef *)arg1;
- (struct TSCECellRef)cellRefForHostCoord:(struct TSUModelCellCoord)arg1;
- (const RefTypeHolder_cdce8eef *)baseCellRef;
- (id)initWithBaseCellRef:(const RefTypeHolder_cdce8eef *)arg1 preserveFlags:(const struct TSUPreserveFlags *)arg2;
