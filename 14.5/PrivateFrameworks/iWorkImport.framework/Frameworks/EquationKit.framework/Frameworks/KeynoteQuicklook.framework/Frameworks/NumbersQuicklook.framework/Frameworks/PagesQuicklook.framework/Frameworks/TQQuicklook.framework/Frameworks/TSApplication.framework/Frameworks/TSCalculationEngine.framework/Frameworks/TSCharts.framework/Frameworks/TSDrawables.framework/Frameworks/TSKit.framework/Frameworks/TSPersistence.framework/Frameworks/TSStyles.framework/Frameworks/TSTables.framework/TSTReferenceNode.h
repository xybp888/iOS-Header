...
+ (struct TSUCellRect)p_cellRangeForSingleCategoryRefInViewRangeRef:(const RefTypeHolder_7723cd4d *)arg1 inTable:(id)arg2 rangeContext:(unsigned char)arg3;
+ (RefTypeHolder_7723cd4d)p_expandedViewRangeRefForViewRangeRef:(const RefTypeHolder_7723cd4d *)arg1 forLabelRowsInTable:(id)arg2;
+ (struct TSCECategoryRef)p_spanningCategoryRefForViewRangeRef:(const RefTypeHolder_7723cd4d *)arg1 groupByUid:(struct TSKUIDStruct)arg2 categoryLevel:(unsigned char)arg3 calculationEngine:(id)arg4;
+ (struct TSCECategoryRef)p_singleCategoryRefForViewRangeRef:(const RefTypeHolder_7723cd4d *)arg1 rangeContext:(unsigned char)arg2 calculationEngine:(id)arg3 hostCellRef:(const struct TSCECellRef *)arg4;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (void)setBaseRangeRef:(const RefTypeHolder_41ae741d *)arg1 preserveFlags:(unsigned char)arg2;
- (void)setChromeRangeRef:(const RefTypeHolder_b26a20d2 *)arg1 preserveFlags:(unsigned char)arg2;
- (void)setViewRangeRef:(const RefTypeHolder_7723cd4d *)arg1 preserveFlags:(unsigned char)arg2;
- (id)viewTractRef;
...
- (id)initWithContext:(id)arg1 calculationEngine:(id)arg2 baseRangeRef:(const RefTypeHolder_41ae741d *)arg3 preserveFlags:(unsigned char)arg4 hostCellRef:(const struct TSCECellRef *)arg5 referenceColorHelper:(id)arg6 suppressAutomaticNamedReferenceInvalidation:(_Bool)arg7;
- (id)initWithContext:(id)arg1 calculationEngine:(id)arg2 chromeRangeRef:(const RefTypeHolder_b26a20d2 *)arg3 preserveFlags:(unsigned char)arg4 hostCellRef:(const RefTypeHolder_cdce8eef *)arg5 referenceColorHelper:(id)arg6 suppressAutomaticNamedReferenceInvalidation:(_Bool)arg7;
- (id)initWithContext:(id)arg1 calculationEngine:(id)arg2 viewRangeRef:(const RefTypeHolder_7723cd4d *)arg3 preserveFlags:(unsigned char)arg4 hostCellRef:(const RefTypeHolder_cdce8eef *)arg5 referenceColorHelper:(id)arg6 suppressAutomaticNamedReferenceInvalidation:(_Bool)arg7;
