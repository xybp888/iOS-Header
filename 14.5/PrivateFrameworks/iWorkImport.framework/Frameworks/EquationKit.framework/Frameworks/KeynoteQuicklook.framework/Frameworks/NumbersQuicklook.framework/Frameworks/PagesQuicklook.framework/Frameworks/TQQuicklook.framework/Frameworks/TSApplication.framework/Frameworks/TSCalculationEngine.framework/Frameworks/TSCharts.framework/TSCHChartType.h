...
@class NSArray, NSSet, NSString, TSCHChartFeature, TSSPropertySet, TSUIntToIntDictionary;
...
@property(readonly, nonatomic) TSSPropertySet *specificSeriesStrokeProperties;
@property(readonly, nonatomic) TSSPropertySet *specificSeriesFillProperties;
