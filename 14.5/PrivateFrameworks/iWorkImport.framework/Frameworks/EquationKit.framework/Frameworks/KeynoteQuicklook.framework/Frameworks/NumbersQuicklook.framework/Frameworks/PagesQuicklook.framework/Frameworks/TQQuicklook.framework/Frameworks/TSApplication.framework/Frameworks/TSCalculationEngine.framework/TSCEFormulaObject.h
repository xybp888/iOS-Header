...
- (id)copyByRewritingGroupUid:(const struct TSKUIDStruct *)arg1;
...
- (id)copyByRemappingUids:(const struct TSKUIDStructMap *)arg1 rowMap:(const struct TSKUIDStructMap *)arg2 ownerMap:(const struct TSKUIDStructMap *)arg3 clearIfMissing:(_Bool)arg4;
- (id)copyByForceSettingOwnerUIDs:(const struct TSKUIDStruct *)arg1 calcEngine:(id)arg2;
- (id)copyByRemappingOwnerUIDs:(const struct TSKUIDStructMap *)arg1 calcEngine:(id)arg2 badRefFound:(_Bool *)arg3;
- (id)copyByRemappingHostCellAgnosticOwnerUIDs:(const struct TSKUIDStructMap *)arg1 calcEngine:(id)arg2 containingCell:(const struct TSCECellRef *)arg3 outError:(_Bool *)arg4;
- (id)copyByRemappingOwnerUIDs:(const struct TSKUIDStructMap *)arg1 calcEngine:(id)arg2 containingCell:(const struct TSCECellRef *)arg3 outBadRefFound:(_Bool *)arg4;
...
- (void)appendExternalTableUIDs:(unordered_set_e73d2375 *)arg1 groupByUIDs:(unordered_set_e73d2375 *)arg2;
