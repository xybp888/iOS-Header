...
@interface TSTSummaryCellVendor : TSPObject
{
    ...
    map_eaed564a _cellUIDMap;
}

- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) _Bool hasCustomFormatsToPaste; // @synthesize hasCustomFormatsToPaste=_hasCustomFormatsToPaste;
@property(readonly, nonatomic) map_eaed564a *cellUIDMap; // @synthesize cellUIDMap=_cellUIDMap;
...
- (id)p_cellSpecForAggregateType:(unsigned char)arg1 forColumnUID:(struct TSKUIDStruct)arg2 atGroupLevel:(unsigned char)arg3;
