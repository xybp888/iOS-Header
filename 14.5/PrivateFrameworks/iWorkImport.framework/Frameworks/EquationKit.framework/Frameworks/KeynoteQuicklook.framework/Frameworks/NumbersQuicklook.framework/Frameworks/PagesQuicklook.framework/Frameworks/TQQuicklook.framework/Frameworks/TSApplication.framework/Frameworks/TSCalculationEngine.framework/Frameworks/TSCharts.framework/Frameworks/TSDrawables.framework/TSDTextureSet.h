...
- (_Bool)canReuseMetalTexturesWith:(id)arg1;
- (id)description;
...
- (_Bool)shouldAnimateBackgroundTexturesWithStage:(long long)arg1 isBuildIn:(_Bool)arg2;
...
- (id)visibleTexturesForStage:(long long)arg1 isBuildIn:(_Bool)arg2 isContentBuild:(_Bool)arg3 shouldFlatten:(_Bool)arg4 flattenKey:(id)arg5 shouldIncludeCaptions:(_Bool)arg6;
