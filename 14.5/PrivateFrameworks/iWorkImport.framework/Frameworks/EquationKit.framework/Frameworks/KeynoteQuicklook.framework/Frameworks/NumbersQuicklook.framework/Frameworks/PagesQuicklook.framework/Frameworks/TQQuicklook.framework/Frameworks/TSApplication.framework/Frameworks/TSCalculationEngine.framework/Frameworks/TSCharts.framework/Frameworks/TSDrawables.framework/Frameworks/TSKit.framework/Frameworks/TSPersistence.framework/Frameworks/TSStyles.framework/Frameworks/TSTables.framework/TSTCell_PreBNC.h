...
- (id)spareFormatOfType:(unsigned int)arg1 allowMismatchedSpare:(_Bool)arg2;
- (id)p_spareFormatOfType:(unsigned int)arg1 allowMismatchedSpare:(_Bool)arg2 explicitOnly:(_Bool)arg3;
@property(readonly, nonatomic) _Bool currentFormatIsExplicit;
@property(readonly, nonatomic) _Bool hasCurrentFormat;
- (void)p_setFormatExplicit:(_Bool)arg1 fromFormatType:(unsigned int)arg2 setMostRecentlySet:(_Bool)arg3;
...
- (void)setFormula:(id)arg1 clearingID:(_Bool)arg2;
