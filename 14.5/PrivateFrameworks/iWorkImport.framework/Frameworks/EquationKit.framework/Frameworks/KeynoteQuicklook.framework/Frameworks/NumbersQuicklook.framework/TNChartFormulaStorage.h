...
- (unsigned long long)numberOfTotalCategoryLabelsWithCalcEngine:(id)arg1 inEntity:(const struct TSKUIDStruct *)arg2;
- (unsigned long long)numberOfGroupsWithCalcEngine:(id)arg1 inEntity:(const struct TSKUIDStruct *)arg2;
- (unsigned long long)p_calculateNumberOfGroupsWithCalcEngine:(id)arg1 inEntity:(const struct TSKUIDStruct *)arg2;
- (id)description;
