...
- (_Bool)shouldPrintCommentsOfAnnotationPrintingHelper:(id)arg1;
...
- (void)p_invalidateCachedAutoFitContentScaleForInfoProvider:(id)arg1 notify:(_Bool)arg2;
...
- (id)p_pageLayoutAtCoordinate:(struct TSUCellCoord)arg1 shouldCachePageLayout:(_Bool)arg2;
...
- (_Bool)_isPageAddendumAtPageIndex:(unsigned long long)arg1;
- (_Bool)_isPageAddendumAtPageCoordinate:(struct TSUCellCoord)arg1;
- (_Bool)shouldSuppressBackgroundsForPageIndex:(unsigned long long)arg1;
