...
- (void)dealloc;
- (void)willClose;
- (id)initWithContext:(id)arg1 dependencyTracker:(struct TSCEDependencyTracker *)arg2 ownerID:(unsigned short)arg3 ownerUID:(const struct TSKUIDStruct *)arg4 owner:(id)arg5 subOwnerID:(const struct TSCESubFormulaOwnerID *)arg6;
