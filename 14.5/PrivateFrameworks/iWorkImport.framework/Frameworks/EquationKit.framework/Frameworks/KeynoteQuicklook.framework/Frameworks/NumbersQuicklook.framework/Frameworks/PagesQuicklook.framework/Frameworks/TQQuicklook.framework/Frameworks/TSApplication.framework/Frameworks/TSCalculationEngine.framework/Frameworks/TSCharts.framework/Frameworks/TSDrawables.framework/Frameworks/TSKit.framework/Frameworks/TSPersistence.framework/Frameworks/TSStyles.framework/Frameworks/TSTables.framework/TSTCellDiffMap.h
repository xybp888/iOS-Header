...
- (id)cellDiffMapByRemovingColumns:(const TSKUIDStructVectorTemplate_724280d5 *)arg1;
- (id)cellDiffMapByRemovingRows:(const TSKUIDStructVectorTemplate_724280d5 *)arg1;
- (id)cellDiffMapByIntersectingUIDs:(const TSKUIDStructVectorTemplate_724280d5 *)arg1 inRows:(_Bool)arg2;
