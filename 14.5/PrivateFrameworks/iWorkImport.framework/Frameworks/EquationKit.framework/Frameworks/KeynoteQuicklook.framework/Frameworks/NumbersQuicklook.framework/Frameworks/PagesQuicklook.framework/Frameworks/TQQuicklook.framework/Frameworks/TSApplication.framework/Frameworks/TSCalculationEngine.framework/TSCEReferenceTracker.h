...
{
    struct TSKUIDStruct _ownerUUID;
...
- (void).cxx_destruct;
@property(nonatomic) struct TSKUIDStruct baseOwnerUID; // @synthesize baseOwnerUID=_baseOwnerUID;
...
- (void)trackedReferenceWasDeleted:(id)arg1 fromOwnerUID:(const struct TSKUIDStruct *)arg2;
