...
@interface TSTConcurrentCellMap : TSPObject <NSCopying, TSTCellMapChangeDescriptorDelivering>
{
    ...
    TSKUIDStructVectorTemplate_724280d5 _cachedRowUIDs;
    TSKUIDStructVectorTemplate_724280d5 _cachedColumnUIDs;
}

- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) _Bool applyingToTable; // @synthesize applyingToTable=_applyingToTable;
@property(nonatomic) TSKUIDStructVectorTemplate_724280d5 cachedColumnUIDs; // @synthesize cachedColumnUIDs=_cachedColumnUIDs;
@property(nonatomic) TSKUIDStructVectorTemplate_724280d5 cachedRowUIDs; // @synthesize cachedRowUIDs=_cachedRowUIDs;
