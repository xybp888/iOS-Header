...
+ (long long)documentTypeAtURL:(id)arg1 hasNativeUTI:(_Bool)arg2 nestedDocumentFilename:(id)arg3;
...
- (_Bool)readObjectForIdentifier:(long long)arg1 isWeakReference:(_Bool)arg2 ignoreUnknownContentWhileReading:(_Bool)arg3 rootObjectComponent:(id)arg4 object:(id *)arg5 error:(id *)arg6;
...
- (id)initWithDelegate:(id)arg1 registry:(id)arg2 resourceContext:(id)arg3 isLoadingDocument:(_Bool)arg4;
