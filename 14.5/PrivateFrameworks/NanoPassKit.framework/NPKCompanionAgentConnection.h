...
- (void)_shouldShowApplePaySettingsForTinkerWithCompletion:(CDUnknownBlockType)arg1;
- (void)_shouldShowApplePaySettingsWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)credentialedPassUniqueIDsSynchronous:(_Bool)arg1 reply:(CDUnknownBlockType)arg2;
