...
- (_Bool)_getDisplayVideoRange:(id *)arg1 displaySize:(struct CGSize *)arg2 refreshRate:(id *)arg3;
...
- (void)setPlayerRole:(id)arg1 synchronously:(_Bool)arg2;
- (id)playerRole;
...
- (_Bool)_rateUpdatedDuringTransition;
...
- (_Bool)interstitialPlaybackAllowed;
