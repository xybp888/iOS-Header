...
- (void)_setIsPartOfForegroundScene:(_Bool)arg1;
...
- (void)setLegibleContentInsets:(struct NSEdgeInsets)arg1;
...
- (void)_setShowInterstitialInstead:(_Bool)arg1;
...
- (void)_setPlayer:(id)arg1 forPIP:(_Bool)arg2;
