...
@interface AVCaptureDevice : NSObject
{
    ...
    _Bool _inUseByAnotherApplication;
    int _transportType;
...
+ (void)setCenterStageEnabled:(_Bool)arg1;
+ (_Bool)isCenterStageEnabled;
+ (void)setCenterStageControlMode:(long long)arg1;
+ (long long)centerStageControlMode;
+ (void)_setCenterStageSupportedOnce:(_Bool)arg1;
+ (void)_writeInitialCenterStageDefaultsReturningControlModeOut:(long long *)arg1 enabledOut:(_Bool *)arg2;
+ (id)_userDefaults;
...
+ (id)_defaultDeviceWithDeviceType:(id)arg1 mediaType:(id)arg2 position:(long long)arg3 prefersUnsuspendedAndAllowsAnyPosition:(_Bool)arg4;
