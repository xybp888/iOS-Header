...
- (void)_updateAllContextsUpdateGeneral:(_Bool)arg1 updateLimited:(_Bool)arg2 updateCurrentApplicationState:(_Bool)arg3 updateAllowedByContactsHandle:(_Bool)arg4 refreshContacts:(_Bool)arg5 refreshWhitelist:(_Bool)arg6 updateEmergencyMode:(_Bool)arg7;
- (void)_updateThirdPartyContext:(id)arg1 forHandles:(id)arg2;
- (void)_updateContext:(id)arg1 forHandles:(id)arg2 updateGeneral:(_Bool)arg3 updateLimited:(_Bool)arg4 updateCurrentApplicationState:(_Bool)arg5 updateAllowedByContactsHandle:(_Bool)arg6 refreshContacts:(_Bool)arg7 refreshWhitelist:(_Bool)arg8 updateEmergencyMode:(_Bool)arg9;
