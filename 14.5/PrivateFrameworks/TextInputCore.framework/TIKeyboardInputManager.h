...
@class NSArray, NSCharacterSet, NSDictionary, NSMutableDictionary, NSMutableSet, NSMutableString, NSString, TIAutocorrectionList, TIAutoshiftRegularExpressionLoader, TICharacterSetDescription, TICoreAnalyticsEventDispatcher, TICounterChangeCache, TIDPEventDispatcher, TIEmojiCandidateGenerator, TIInputContextHistory, TIKBUserModel, TIKeyboardCandidate, TIKeyboardFeatureSpecialization, TIKeyboardInputManagerConfig, TIKeyboardInputManagerState, TIKeyboardLayout, TIKeyboardLayoutState, TIKeyboardState, TILRUDictionary, TILanguageSelectionController, TIRevisionHistory, TISKMetricCollector, TISmartPunctuationOptions, TISmartSelector, TITextCheckerExemptions, TITypingSessionMonitor;
...
@property(retain, nonatomic) TIDPEventDispatcher *differentialPrivacyEventDispatcher; // @synthesize differentialPrivacyEventDispatcher=_differentialPrivacyEventDispatcher;
