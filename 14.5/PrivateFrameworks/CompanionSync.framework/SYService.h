...
- (_Bool)_protocolVersion:(int)arg1 supportsEngineType:(unsigned int)arg2;
...
- (void)dealloc;
- (id)initWithService:(id)arg1 priority:(long long)arg2 qos:(unsigned int)arg3 asMasterStore:(_Bool)arg4 options:(id)arg5;
- (id)initWithService:(id)arg1 priority:(long long)arg2 asMasterStore:(_Bool)arg3 options:(id)arg4;
- (id)init;
