...
- (_Bool)isTodayViewOrAppLibraryVisibleWithServerInstance:(id)arg1;
...
- (_Bool)isLockScreenVisibleWithServerInstance:(id)arg1;
...
- (_Bool)isBannerVisibleWithServerInstance:(id)arg1;
