...
- (id)an_firstWhere:(CDUnknownBlockType)arg1;
- (id)an_filter:(CDUnknownBlockType)arg1;
- (id)an_flatMap:(CDUnknownBlockType)arg1;
- (id)an_compactMap:(CDUnknownBlockType)arg1;
- (id)an_map:(CDUnknownBlockType)arg1;
