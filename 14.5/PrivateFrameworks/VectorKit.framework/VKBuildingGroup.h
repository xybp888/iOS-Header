...
- (_Bool)addPointyRoofForBuilding:(CDStruct_1636c0da *)arg1 buildingModel:(unsigned char)arg2 scaleThreshold:(float)arg3 styleIndex:(float)arg4;
- (_Bool)canConstructPointyRoofForPolygon:(CDStruct_887e071c *)arg1 building:(CDStruct_1636c0da *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4;
- (void)addExtrusionForBuilding:(CDStruct_1636c0da *)arg1 index:(unsigned long long)arg2 ofTotal:(unsigned long long)arg3;
- (void)addBuilding:(CDStruct_1636c0da *)arg1 index:(unsigned long long)arg2 ofTotal:(unsigned long long)arg3 accessor:(struct ResourceAccessor *)arg4 triangulator:(Triangulator_edf345a1 *)arg5 prepareExtrusion:(_Bool)arg6 forRoofStyle:(unsigned char)arg7 scaleThreshold:(float)arg8;
