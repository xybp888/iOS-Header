...
@property(copy, nonatomic) NSUUID *endpointId; // @synthesize endpointId=_endpointId;
...
@property(retain, nonatomic) CSMediaPlayingMonitor *mediaPlayingMonitor; // @synthesize mediaPlayingMonitor=_mediaPlayingMonitor;
...
@property(nonatomic) unsigned long long numAudioPacketToSiriClient; // @synthesize numAudioPacketToSiriClient=_numAudioPacketToSiriClient;
@property(retain, nonatomic) NSMutableDictionary *endpointerLatencyContext; // @synthesize endpointerLatencyContext=_endpointerLatencyContext;
