...
@class FPCTLTermDumper, FPItem, FPItemID, FPProviderDomain, FPSandboxingURLWrapper, NSArray, NSData, NSDate, NSDictionary, NSFileHandle, NSFileProviderDomain, NSFileProviderItemVersion, NSFileProviderRequest, NSProgress, NSString, NSURL;
...
- (void)beginRequestWithDomain:(NSFileProviderDomain *)arg1 alternateContentsDictionary:(NSDictionary *)arg2 usesFPFS:(_Bool)arg3 providerDomain:(FPProviderDomain *)arg4;
@end
