...
@class NSMutableDictionary, NSString, SBHAddWidgetSheetViewController, SBIconListView, SBIconView, SBRootFolderController, SBViewControllerTransitionContext, SBWidgetIcon, UIView, UIViewController, UIViewPropertyAnimator;
@protocol SBHWidgetSheetViewControlling, UIViewImplicitlyAnimating;
