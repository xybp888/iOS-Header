...
- (_Bool)stringContainsCJKCharacters:(id)arg1;
...
- (id)initWithContainer:(id)arg1 preferredLocalizations:(id)arg2 currentRegion:(id)arg3 performExpensiveFetchOperations:(_Bool)arg4;
- (id)init;
