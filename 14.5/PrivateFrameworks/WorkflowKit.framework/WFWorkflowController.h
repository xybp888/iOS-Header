...
@class NSDate, NSDictionary, NSMapTable, NSProgress, NSString, RBSAssertion, WFAction, WFContentCollection, WFOutOfProcessWorkflowController, WFRemoteQuarantinePolicyEvaluator, WFWorkflow, WFWorkflowControllerState, WFWorkflowRunningContext;
