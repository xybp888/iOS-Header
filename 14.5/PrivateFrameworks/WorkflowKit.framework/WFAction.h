...
- (void)processParameterStates:(id)arg1 withInput:(id)arg2 skippingHiddenParameters:(_Bool)arg3 askForValuesIfNecessary:(_Bool)arg4 workQueue:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
