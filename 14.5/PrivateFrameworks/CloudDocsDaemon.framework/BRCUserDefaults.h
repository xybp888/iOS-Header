...
- (_Bool)aggressivelyPCSChainWithSession:(id)arg1;
- (_Bool)optimisticallyPCSChainDuringResetWithSession:(id)arg1;
- (_Bool)optimisticallyPCSChainWithSession:(id)arg1;
- (_Bool)_shouldRampForKey:(id)arg1 session:(id)arg2;
