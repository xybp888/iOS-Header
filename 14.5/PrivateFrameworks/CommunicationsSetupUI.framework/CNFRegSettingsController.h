...
- (void)showFaceTimeSpecifiers:(id)arg1 afterGroupId:(id)arg2 animated:(_Bool)arg3;
...
- (void)refreshBlocklistSettingsAnimated:(_Bool)arg1;
- (void)showBlocklistSettings:(_Bool)arg1 animated:(_Bool)arg2;
...
- (void)refreshFaceTimeVPCSettingsAnimated:(_Bool)arg1;
- (void)showFaceTimeVPCSpecifiers:(_Bool)arg1 animated:(_Bool)arg2;
...
- (void)refreshTemporaryPhoneAnimated:(_Bool)arg1;
...
- (_Bool)refreshiMessageAccountFooterText:(_Bool)arg1;
