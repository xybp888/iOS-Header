...
- (void)setNextTrackButtonEnabled:(_Bool)arg1;
- (void)setRate:(double)arg1;
- (void)setIsPlaying:(_Bool)arg1 waiting:(_Bool)arg2;
- (void)setArtwork:(id)arg1 backgroundImage:(id)arg2 animated:(_Bool)arg3;
- (void)setArtwork:(id)arg1 backgroundImage:(id)arg2;
- (void)setArtwork:(id)arg1 animated:(_Bool)arg2;
