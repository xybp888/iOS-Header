...
- (id)_predicateForBundleID:(id)arg1 withPurgeability:(_Bool)arg2 lastUsedMoreThan:(id)arg3;
- (void)_enumerateAssetPacksMatchingPredicate:(id)arg1 orderingProperties:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (void)_enumerateAssetPacksForBundleID:(id)arg1 withPurgeability:(_Bool)arg2 lastUsedMoreThan:(id)arg3 usingBlock:(CDUnknownBlockType)arg4;
...
- (id)totalSizeOfUnpurgeableAssetPacksForBundleID:(id)arg1;
- (id)totalSizeOfDownloadedAssetPacksForBundleID:(id)arg1;
...
- (void)enumeratePurgeableAssetPacksUsingBlock:(CDUnknownBlockType)arg1;
- (void)enumerateAssetPacksForBundleID:(id)arg1 withPurgeability:(_Bool)arg2 lastUsedMoreThan:(id)arg3 usingBlock:(CDUnknownBlockType)arg4;
...
- (id)appBundleIDToBundlePathMapping;
