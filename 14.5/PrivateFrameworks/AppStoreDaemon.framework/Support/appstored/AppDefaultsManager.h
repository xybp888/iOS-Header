...
+ (_Bool)externalManifestSkipLocalCheck;
+ (_Bool)externalDownloadSkipATSCheck;
...
+ (void)setRevokedApps:(id)arg1;
+ (id)revokedApps;
+ (void)setExpiredApps:(id)arg1;
+ (id)expiredApps;
+ (id)forceDrmMode;
...
+ (void)setAutomaticUpdatesEnabled:(_Bool)arg1;
...
+ (_Bool)automaticUpdatesEnabled;
+ (id)installAttributionPingbackDelay;
+ (_Bool)allowPurchaseRequestData;
+ (void)setManageSubsOnDeleteBlacklist:(id)arg1;
+ (id)manageSubsOnDeleteBlacklist;
+ (void)markInstallAsFailedWithCodeSigErrorForBundleID:(id)arg1 evid:(id)arg2;
+ (void)_setRestoreInstallsFailedWithCodeSigError:(id)arg1;
+ (id)_restoreInstallsFailedWithCodeSigError;
+ (id)restoreInstallsFailedWithCodeSigError;
...
+ (_Bool)shouldUseASDForPushNotificationRequests;
+ (id)userAgentSuffix;
...
+ (id)appUsageTaskSpreadPeriodOverride;
...
+ (void)setDictionaryForKey:(id)arg1 forKey:(struct __CFString *)arg2;
+ (void)setArrayForKey:(id)arg1 forKey:(struct __CFString *)arg2;
+ (double)doubleForKey:(struct __CFString *)arg1;
