...
+ (id)sharedInstance;
- (void).cxx_destruct;
- (void)_updateSubscriptionInfoForAppEntitlement:(id)arg1 logKey:(id)arg2;
- (void)_updateCachedAppSubscriptionEntitlement:(id)arg1 logKey:(id)arg2;
...
- (void)_handleAppSubscriptionChange:(id)arg1 logKey:(id)arg2;
- (void)_handleRepairBundleIDNotification:(id)arg1;
- (_Bool)_isSubscribedToArcadeIgnoringMemoryCache:(_Bool)arg1 logKey:(id)arg2 ignoresFsEntitlementCache:(_Bool)arg3 timeout:(double)arg4 outError:(id *)arg5;
...
- (void)_initBagKeys;
- (id)_defaultAllowedAnonymousKeys;
- (id)_defaultAllowedPayoutKeys;
- (_Bool)_arcadePayoutEnabled;
- (id)_allowedArcadeAnonymousKeysForContext:(id)arg1;
- (id)_allowedArcadePayoutKeysForContext:(id)arg1;
- (id)_katanaIDsForContext:(id)arg1;
...
- (void)handleAppStoreSubscriptionChange:(id)arg1 logKey:(id)arg2;
