...
@interface StoreItemResponse : NSObject
{
    ...
    NSString *_clientID;
    InstallAttributionPingback *_installAttributionPingback;
}
...
- (_Bool)getMultiTypeBoolValueForKey:(id)arg1 fromDictionary:(id)arg2;
- (id)_installAttributionPingbackFromDictionary:(id)arg1;
