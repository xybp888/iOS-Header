...
@class CKRecord, CKShare, ICCloudState, ICMergableDictionary, NSArray, NSData, NSMutableDictionary, NSString, TTOrderedSetVersionedDocument;
...
@property(readonly, nonatomic) ICMergableDictionary *replicaIDToNotesVersion; // @synthesize replicaIDToNotesVersion=_replicaIDToNotesVersion;
