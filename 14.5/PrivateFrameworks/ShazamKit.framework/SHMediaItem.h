...
+ (void)shazamIDsFromAppleMusicIDs:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
+ (void)mediaItemsForShazamIDs:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
+ (void)mediaItemsForAppleMusicIDs:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
