...
@interface HDDatabase : NSObject <HDAssertionObserver, HDContentProtectionObserver, HDDiagnosticObject, HDSQLiteDatabaseDelegate, HDSQLiteDatabasePoolDelegate, HDSQLiteDatabaseProvider, HDDatabaseJournalDelegate, HDHFDataStoreDelegate, HDDatabaseMigrationTransactionDelegate, HDAnalyticsSubmissionCoordinatorDelegate, HDHealthDaemonReadyObserver, HDDatabaseCorruptionEventStoreDelegate, HDHealthDatabase>
{
