...
- (id)_keyEntityForKey:(id)arg1 createIfNecessary:(_Bool)arg2 transaction:(id)arg3 error:(id *)arg4;
...
- (_Bool)_insertExternalSyncMetadata:(id)arg1 forObjectID:(id)arg2 sourceID:(id)arg3 externalSyncObjectCode:(long long)arg4 objectDeleted:(_Bool)arg5 transaction:(id)arg6 error:(id *)arg7;
- (id)_ignoredInsertedMetadataKeys;
- (_Bool)_skipInsertOfKey:(id)arg1 metadata:(id)arg2;
- (_Bool)_insertMetadata:(id)arg1 forObjectID:(id)arg2 transaction:(id)arg3 error:(id *)arg4;
