...
- (void)database_reportSQLiteCorruptionWithExtendedErrorCode:(int)arg1 type:(long long)arg2 profile:(id)arg3 description:(id)arg4 sqlStatement:(id)arg5 failedObliterationAttempt:(_Bool)arg6;
