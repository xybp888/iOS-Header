...
- (_Bool)performWork:(CDUnknownBlockType)arg1 error:(id *)arg2;
- (void)performWork:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (_Bool)_performWork:(CDUnknownBlockType)arg1 error:(id *)arg2;
...
- (_Bool)work_insertNewKeyIfNeededWithKeyID:(long long)arg1 error:(id *)arg2;
...
- (_Bool)work_enumerateNodesForSQL:(id)arg1 loadAttributes:(_Bool)arg2 loadRelationshipsWithDepth:(long long)arg3 error:(id *)arg4 bindingHandler:(CDUnknownBlockType)arg5 enumerationHandler:(CDUnknownBlockType)arg6;
- (id)work_nodesForSQL:(id)arg1 loadAttributes:(_Bool)arg2 loadRelationshipsWithDepth:(long long)arg3 error:(id *)arg4 bindingHandler:(CDUnknownBlockType)arg5;
