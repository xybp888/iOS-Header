...
+ (_Bool)migrateDataFromDataStore:(const struct DataStore *)arg1 to:(struct DataStore *)arg2 transaction:(id)arg3 recoveryAnalytics:(id)arg4 error:(id *)arg5;
...
+ (_Bool)replaceObjectID:(id)arg1 replacementObjectID:(id)arg2 deleteOriginalHFDData:(_Bool)arg3 profile:(id)arg4 transaction:(id)arg5 error:(id *)arg6;
+ (_Bool)deleteSeriesWithID:(id)arg1 deleteHFDData:(_Bool)arg2 profile:(id)arg3 transaction:(id)arg4 error:(id *)arg5;
