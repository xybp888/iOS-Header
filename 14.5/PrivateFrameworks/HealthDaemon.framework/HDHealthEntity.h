...
+ (id)transactionContextForWriting:(_Bool)arg1 baseContext:(id)arg2;
...
+ (id)backwardsCompatibleEncoderForEntityClass:(Class)arg1 profile:(id)arg2 transaction:(id)arg3 purpose:(long long)arg4 encodingOptions:(id)arg5 authorizationFilter:(CDUnknownBlockType)arg6;
