...
- (void)registerGenerationWithPreResponseItems:(id)arg1 language:(id)arg2 isCached:(_Bool)arg3 responseTimePerf:(unsigned long long)arg4 promptMessage:(id)arg5 generationStatus:(int)arg6;
- (id)responsesCache;
