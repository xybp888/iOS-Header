...
{
    _Bool _interactiveVideoFormatControlSupported;
    _Bool _interactiveVideoFormatControlAlwaysEnabled;
    _Bool _backCameraSupported;
    _Bool _frontCameraSupported;
    _Bool _captureOnTouchDown;
    _Bool _responsiveShutterSupported;
    _Bool _mirroredFrontCapturesSupported;
    _Bool _mirroredFrontVideosSupported;
    ...
    _Bool _HDR10BitVideoSupported;
    _Bool _HDR10BitVideoSupports60FPS;
    ...
    _Bool _variableFramerateVideoSupported;
    ...
    _Bool _deferredPortraitRenderingSupported;
    _Bool _ctmSupported;
    ...
    _Bool _imagePickerUsesModernLayout;
    ...
    _Bool _contentAwareDistortionCorrectionSupported;
    _Bool _linearDNGSupported;
    ...
    _Bool _backTimeOfFlightSupported;
    _Bool _frontTimeOfFlightSupported;
    _Bool _depthEffectApertureSupported;
    _Bool _portraitEffectIntensitySupported;
    _Bool _neuralEngineSupported;
    _Bool _semanticDevelopmentSupported;
    _Bool _enableSemanticDevelopmentFilterDebugging;
    _Bool _internalInstall;
    _Bool _lockButtonAppropriateForShutter;
    _Bool _lowEndHardware;
    _Bool _allowHaptics;
    _Bool _allowHapticsOnConfigurationTaps;
    _Bool _shotBufferSupported;
    _Bool _exposureSliderSupported;
    _Bool __backStageLightPortaitEffectsSupported;
    _Bool __frontStageLightPortaitEffectsSupported;
    _Bool __wideDualPortraitLowLightSupported;
    _Bool __processZoomWithoutUpscaleBack;
    _Bool __processZoomWithoutUpscaleFront;
    _Bool __tripleCamera1080p60Supported;
    _Bool __forceEnableExposureClippingIndicator;
    _Bool __forceDisableExposureClippingIndicator;
    ...
    _Bool _featureDevelopmentForceSingleCamera;
    _Bool _forceAllowAllInterfaceOrientations;
...
+ (_Bool)isPALVideoConfiguration:(long long)arg1;
+ (id)capabilities;
- (void).cxx_destruct;
...
- (_Bool)isLinearDNGSupportedForMode:(long long)arg1;
- (_Bool)isContentAwareDistortionCorrectionSupportedForMode:(long long)arg1;
...
- (_Bool)processZoomWithoutUpscaleForDevicePosition:(long long)arg1;
...
- (double)maximumZoomFactorForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3 shouldResolveDevice:(_Bool)arg4;
- (double)maximumZoomFactorForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3;
- (_Bool)shouldAdjustZoomOnOrientationChangeForDevicePosition:(long long)arg1;
...
- (_Bool)isSemanticDevelopmentSupportedForMode:(long long)arg1;
- (_Bool)isExposureClippingIndicatorSupportedForMode:(long long)arg1 videoConfiguration:(long long)arg2;
- (_Bool)isExposureSliderSupportedForMode:(long long)arg1;
- (_Bool)isTapAndBiasSupportedForMode:(long long)arg1;
...
- (_Bool)isTimeOfFlightSupportedForDevicePosition:(long long)arg1;
...
- (_Bool)isHDR10BitVideoSupportedForVideoConfiguration:(long long)arg1 videoEncodingBehavior:(long long)arg2;
- (_Bool)isHDR10BitVideoSupportedForMode:(long long)arg1;
- (_Bool)isAutoFPSVideoSupportedForMode:(long long)arg1 videoConfiguration:(long long)arg2;
...
- (_Bool)_isVariableFramerateVideoSupportedForResolvedVideoConfiguration:(long long)arg1;
- (_Bool)isVariableFramerateVideoSupportedForMode:(long long)arg1 videoConfiguration:(long long)arg2;
...
- (_Bool)isTorchSupportedForMode:(long long)arg1 devicePosition:(long long)arg2;
- (_Bool)isFlashSupportedForMode:(long long)arg1 devicePosition:(long long)arg2;
...
- (unsigned long long)lowLightPreviewOverlayStyleForDevicePosition:(long long)arg1 sensitiveToChangingDisplayFeedback:(_Bool)arg2;
...
- (_Bool)isSpatialOverCaptureSupportedForMode:(long long)arg1 device:(long long)arg2 ctmCaptureType:(long long)arg3 photoEncodingBehavior:(long long)arg4;
- (_Bool)isSpatialOverCaptureSupportedForCTMCaptureType:(long long)arg1;
...
- (_Bool)isLivePhotoSupportedForMode:(long long)arg1 devicePosition:(long long)arg2;
...
- (_Bool)isTimerSupportedForMode:(long long)arg1;
...
- (_Bool)isResponsiveShutterSupportedForMode:(long long)arg1;
- (_Bool)mirroredFrontCapturesSupportedForMode:(long long)arg1;
- (_Bool)allowCaptureWhileViewfinderIsOpeningForMode:(long long)arg1 devicePosition:(long long)arg2;
