...
- (void)_remotelyPersistVideoJob:(id)arg1 forRequest:(id)arg2 loggingIdentifier:(id)arg3 withSendHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)_remotelyPersistStillImageJob:(id)arg1 forRequest:(id)arg2 loggingIdentifier:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
