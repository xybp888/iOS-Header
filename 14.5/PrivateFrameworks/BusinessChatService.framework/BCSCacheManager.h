...
@class NSString;
@protocol BCSDomainItemCacheManaging, BCSDomainItemCaching, BCSItemCaching><BCSLinkItemCacheClearing, BCSShardCacheQueryable;
...
@interface BCSCacheManager : NSObject <BCSCacheClearing, BCSConfigCaching, BCSConfigCacheSkipping, BCSShardCacheQueryable, BCSShardCacheSkipping, BCSItemCaching, BCSItemCacheSkipping, BCSBatchable, BCSDomainItemCaching>
{
    ...
    id <BCSDomainItemCacheManaging> _domainItemCacheManager;
}

- (void).cxx_destruct;
@property(retain, nonatomic) id <BCSDomainItemCacheManaging> domainItemCacheManager; // @synthesize domainItemCacheManager=_domainItemCacheManager;
@property(retain, nonatomic) id <BCSItemCaching><BCSLinkItemCacheClearing> itemCache; // @synthesize itemCache=_itemCache;
@property(retain, nonatomic) id <BCSDomainItemCaching> domainItemCache; // @synthesize domainItemCache=_domainItemCache;
@property(retain, nonatomic) id <BCSShardCacheQueryable> filterShardCache; // @synthesize filterShardCache=_filterShardCache;
