...
- (id)description;
- (struct _PASDBTransactionCompletion_)_transactionWithExclusivity:(_Bool)arg1 transaction:(CDUnknownBlockType)arg2;
- (void)_txnEnd;
- (void)_txnRollback;
...
- (_Bool)_isLikelySQLStatementContainedInString:(const char *)arg1;
