...
- (_Bool)forceAccurateAssetCollectionsIfNeeded:(id)arg1 reloadChanges:(_Bool)arg2;
- (_Bool)forceAccurateSectionsIfNeeded:(id)arg1 reloadChanges:(_Bool)arg2;
- (_Bool)forceAccurateSectionsIfNeeded:(id)arg1;
- (_Bool)_forceAccurateSection:(long long)arg1 andNumberOfSurroundingSectionsWithContent:(long long)arg2;
...
- (_Bool)_isResulTupleApplicable:(id)arg1 forAssetCollection:(id)arg2;
