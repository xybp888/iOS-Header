...
- (id)_fetchConfigurationForKeyAssetWithReferenceAsset:(id)arg1 referencePersons:(id)arg2 curated:(_Bool)arg3;
...
- (id)existingKeyAssetsFetchResultForAssetCollection:(id)arg1 referenceAsset:(id)arg2 referencePersons:(id)arg3 curated:(_Bool)arg4;
- (id)_fetchKeyAssetsInAssetCollection:(id)arg1 curated:(_Bool)arg2 referenceAsset:(id)arg3 referencePersons:(id)arg4;
