...
@class NSSet, NSString, NSURL, NSUUID, TUContactsDataProvider, TUConversationMember, TUConversationReport, TUHandle;
...
@property(copy, nonatomic) TUConversationReport *conversationReport; // @synthesize conversationReport=_conversationReport;
...
@property(copy, nonatomic) NSURL *debugLink; // @synthesize debugLink=_debugLink;
