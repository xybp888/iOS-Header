...
- (void)installTonightScheduled:(_Bool)arg1 operationID:(id)arg2;
...
- (_Bool)createInstallationKeybagWithOptions:(id)arg1;
...
- (void)areUpdatesDownloadableWithOptions:(id)arg1 alternateUpdateOptions:(id)arg2 preferredUpdateDownloadable:(_Bool *)arg3 alternateUpdateDownloadable:(_Bool *)arg4 preferredUpdateError:(id *)arg5 alternateUpdateError:(id *)arg6;
...
- (void)scanForUpdates:(id)arg1 withScanResults:(CDUnknownBlockType)arg2;
