...
+ (id)copySuAssetInCatalogMatchingDescriptor:(id)arg1 exactAssetIdMatch:(_Bool)arg2 installedOnly:(_Bool)arg3;
...
+ (void)cleanupAllInstalledAssets:(CDUnknownBlockType)arg1;
