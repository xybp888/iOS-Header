...
@class MAAsset, NSDate, NSDictionary, NSHashTable, NSMutableArray, NSMutableDictionary, NSString, NSTimer, SUAnalyticsManager, SUAutoInstallFailureNotification, SUAutoUpdatePasscodePolicy, SUCoreReporter, SUDownload, SUInstallPolicy, SUManagedDeviceManager, SUOperationProgress, SUSFollowUpController, SUScanOptions, SUState;
@protocol OS_dispatch_queue, SUManagerDelegate;

@interface SUManager : NSObject <SUKeybagInterfaceObserver, SUManagerInterface, SUNetworkObserver, SUManagedDeviceManagerDelegate>
{
...
- (id)slaVersion;
- (void)updateInstallPolicyDarkBootEnabled:(_Bool)arg1;
...
- (void)isUpdateReadyForInstallationWithReplyHandler:(CDUnknownBlockType)arg1;
...
- (void)purgeDownloadUserRequested:(_Bool)arg1 withResult:(CDUnknownBlockType)arg2;
- (_Bool)_cancelDownload:(_Bool)arg1 userRequested:(_Bool)arg2 error:(id *)arg3;
- (void)cancelDownloadUserRequested:(_Bool)arg1 withResult:(CDUnknownBlockType)arg2;
- (_Bool)isDownloadHalted;
- (void)_sendDownloadInvalidatedForNewDescriptors:(id)arg1;
