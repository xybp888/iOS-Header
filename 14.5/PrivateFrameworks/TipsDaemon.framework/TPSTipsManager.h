...
@class NSArray, NSBundle, NSDictionary, NSMutableArray, NSString, TPSExperiment, TPSMetadata, TPSNotificationController, TPSOfflineContentManager, TPSTipStatusController, TPSWidgetController;
...
- (void)processTipDocumentsDictionary:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)contentWithMetaDictionary:(id)arg1 documents:(id)arg2 isRemote:(_Bool)arg3 processOfflineContent:(_Bool)arg4 contextualEligibility:(_Bool)arg5 widgetEligibility:(_Bool)arg6 notificationEligibility:(_Bool)arg7 preferredNotificationIdentifiers:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;
- (void)contentFromOrigin:(_Bool)arg1 contextualEligibility:(_Bool)arg2 widgetEligibility:(_Bool)arg3 notificationEligibility:(_Bool)arg4 preferredNotificationIdentifiers:(id)arg5 shouldDeferBlock:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;
...
- (_Bool)isContentIdentifierHoldoutCamp:(id)arg1;
