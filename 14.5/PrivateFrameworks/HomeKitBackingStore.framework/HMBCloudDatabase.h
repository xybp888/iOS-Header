...
@class APSConnection, CKContainer, CKContainerID, CKDatabase, HMBCloudCredentialsAvailabilityListener, HMBCloudDatabaseConfiguration, HMBCloudDatabaseStateModel, HMBLocalDatabase, HMBLocalZone, HMFUnfairLock, NAFuture, NSMutableDictionary, NSOperationQueue, NSSet, NSString;
