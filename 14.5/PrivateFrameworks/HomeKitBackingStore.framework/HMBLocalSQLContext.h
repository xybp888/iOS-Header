...
- (_Bool)_updateRecordWithRow:(unsigned long long)arg1 pushBlockRow:(id)arg2 pushData:(id)arg3 pushEncoding:(unsigned long long)arg4 error:(id *)arg5;
...
- (_Bool)_updateRecordWithZoneRow:(unsigned long long)arg1 modelID:(id)arg2 pushEncoding:(unsigned long long)arg3 pushData:(id)arg4 pushBlockRow:(id)arg5 error:(id *)arg6;
