...
+ (void)preheat;
+ (_Bool)isContentWordQuery:(id)arg1 queryTermCount:(long long)arg2 keyboardLanguage:(id)arg3;
...
- (void)updateScoresForPreparedItems:(id)arg1 isCJK:(_Bool)arg2 clientBundle:(id)arg3 thresholdValue:(double)arg4;
