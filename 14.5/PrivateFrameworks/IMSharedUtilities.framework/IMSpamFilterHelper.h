...
+ (_Bool)senderIsChinaHandle:(id)arg1;
+ (_Bool)senderIsCandidateForSMSDowngrade:(id)arg1;
+ (_Bool)accountCountryIsCandidateForSMSFilter:(id)arg1;
+ (_Bool)accountCountryIsCandidateForHawking:(id)arg1;
+ (_Bool)accountRegionIsCandidateForHawking:(id)arg1;
+ (_Bool)receivingID:(id)arg1 isCountryCode:(id)arg2;
+ (_Bool)receiverIsCandidateForSMSFilter:(id)arg1;
