...
#import <CoverSheet/CSFaceOcclusionMonitorDelegate-Protocol.h>
...
- (_Bool)phoneUnlockWithWatchControllerShowRawErrorCodes:(id)arg1;
...
- (void)_setComponentsHiddenForLandscape:(_Bool)arg1;
