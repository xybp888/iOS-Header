...
- (_Bool)clearUserInfoForClientUUIDs:(id)arg1;
...
- (void)setValue:(id)arg1 forSetting:(id)arg2 passcode:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)setFingerprintUnlockAllowed:(_Bool)arg1 passcode:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)setFingerprintUnlockAllowed:(_Bool)arg1 passcode:(id)arg2;
...
- (_Bool)isRemovalRestrictedByPolicyForApp:(id)arg1;
...
- (void)retrieveCloudConfigurationWithoutValidationCompletionBlock:(CDUnknownBlockType)arg1;
...
- (_Bool)applySingleAppModeConfiguration:(id)arg1 clientType:(id)arg2 clientUUID:(id)arg3 localizedClientDescription:(id)arg4 outError:(id *)arg5;
