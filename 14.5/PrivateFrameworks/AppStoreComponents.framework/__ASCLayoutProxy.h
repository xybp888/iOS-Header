...
+ (struct CGSize)smallOfferButtonLockupEstimatedSizeFittingSize:(struct CGSize)arg1 compatibleWithTraitCollection:(id)arg2;
...
+ (struct CGSize)estimatedMediaContentSizeWithScreenshots:(id)arg1 trailers:(id)arg2 fitting:(struct CGSize)arg3 in:(id)arg4;
