...
- (unsigned int)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 heap:(id)arg3 offset:(unsigned long long)arg4 useOffset:(_Bool)arg5 allocator:(id)arg6;
- (unsigned int)newTextureWithDescriptor:(id)arg1 heap:(id)arg2 offset:(unsigned long long)arg3 useOffset:(_Bool)arg4 allocator:(id)arg5;
