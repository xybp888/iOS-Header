...
@interface VCSessionParticipantRemote : VCSessionParticipant <VCSessionDownlinkBandwidthAllocatorClient>
{
    ...
    _Bool _didSubmitSymptomReportForExtendedPoorConnection;
    double _lastVideoDegradedTime;
    struct _VCSessionParticipantSourceIO _sourceIO;
    _Bool _isParticipantVersionPeace;
}
...
@property(readonly, nonatomic) _Bool isParticipantVersionPeace; // @synthesize isParticipantVersionPeace=_isParticipantVersionPeace;
