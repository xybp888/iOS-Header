...
- (id)initWithDelegate:(id)arg1 initialTranslationAdjustment:(struct CGPoint)arg2 startingEnvironmentMode:(long long)arg3 continuingGesture:(_Bool)arg4 dockModifier:(id)arg5;
