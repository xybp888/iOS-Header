...
- (void)showStartingFingersForGesture:(id)arg1 animated:(_Bool)arg2 startPointForAnimation:(struct CGPoint)arg3;
- (void)showStartingFingersForGesture:(id)arg1;
- (id)_handleStartingFingersForGesture:(id)arg1 animated:(_Bool)arg2 startPointForAnimation:(struct CGPoint)arg3 midpoint:(struct CGPoint *)arg4 showFingers:(_Bool)arg5;
- (id)_showStartingFingersForGesture:(id)arg1 animated:(_Bool)arg2 startPointForAnimation:(struct CGPoint)arg3;
...
- (void)_showFingerModels:(id)arg1 animated:(_Bool)arg2 startPointForAnimation:(struct CGPoint)arg3 shouldShowPinchChain:(_Bool)arg4 shouldReuseFingers:(_Bool)arg5;
