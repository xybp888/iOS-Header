...
@class NSArray, NSMutableDictionary, NSString, PKAccountService, PKContactAvatarManager, PKContactFormatValidator, PKExpressPassController, PKInboxDataSource, PKPaymentPreference, PKPaymentPreferenceCard, PKPaymentPreferencesViewController, PKPaymentVerificationController, PKPaymentWebService, PKPeerPaymentAccount, PKPeerPaymentAccountResolutionController, PKPeerPaymentAssociatedAccountsController, PKPeerPaymentWebService, PSSpecifier;
...
- (_Bool)canShareCompanionPass:(id)arg1;
