...
@class NSArray, NSDateFormatter, NSString, NSTimeZone, PKAccount, PKAccountServiceAccountResolutionController, PKAccountUserCollection, PKCoarseLocationMonitor, PKContactResolver, PKDashboardTransactionFetcher, PKFamilyMemberCollection, PKPaymentTransaction, PKPaymentTransactionCellController, PKPaymentTransactionDetailHeaderView, PKPeerPaymentController, PKPeerPaymentStatusResponse, PKPeerPaymentWebService, PKTransactionReceipt, PKTransactionSourceCollection, UIImage;
