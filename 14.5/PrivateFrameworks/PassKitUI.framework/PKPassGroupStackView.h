...
- (void)_updateGroupStateForGroupViewInModalPresentation:(id)arg1 withState:(long long)arg2 animated:(_Bool)arg3 withContext:(id)arg4;
...
- (void)_updatePassFooterViewWithConfiguration:(id)arg1 context:(id)arg2 animated:(_Bool)arg3 reload:(_Bool)arg4 delay:(double)arg5;
...
- (void)_presentModalGroupView:(id)arg1 withState:(long long)arg2 animated:(_Bool)arg3 context:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)_tileGroupsForState:(long long)arg1 eager:(_Bool)arg2 withContext:(id)arg3;
...
- (_Bool)_pauseStateForGroupView:(id)arg1 atIndex:(unsigned long long)arg2;
- (void)_updatePausedState;
- (void)setPresentationState:(long long)arg1 withContext:(id)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
