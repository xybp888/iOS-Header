...
- (_Bool)setPrefersMultichannelAudio:(_Bool)arg1 error:(id *)arg2;
...
- (_Bool)setPrefersToVibeWhenVibrationsAreDisabled:(_Bool)arg1 error:(id *)arg2;
- (_Bool)prefersToVibeWhenVibrationsAreDisabled;
- (_Bool)setParticipatesInVolumePolicy:(_Bool)arg1 error:(id *)arg2;
- (_Bool)participatesInVolumePolicy;
- (_Bool)setPrefersNoDucking:(_Bool)arg1 error:(id *)arg2;
- (_Bool)prefersNoDucking;
- (_Bool)setPrefersNoInterruptionsFromSystemAlerts:(_Bool)arg1 error:(id *)arg2;
...
- (_Bool)setPrefersNoMicrophoneUsageIndicator:(_Bool)arg1 error:(id *)arg2;
