...
+ (_Bool)videoTrackContainsDolbyVisionMetadata:(id)arg1;
...
+ (_Bool)isAVAssetDolbyProfile5:(id)arg1 error:(out id *)arg2;
+ (_Bool)isAVAssetHDR:(id)arg1 error:(out id *)arg2;
...
+ (id)defaultVideoSettingsForAVAssetReaderWithHDR:(_Bool)arg1;
