...
@property __weak id <DEDUploadStatusDelegate> uploadDelegate; // @synthesize uploadDelegate=_uploadDelegate;
...
- (void)cleanupFinishedUploads:(_Bool)arg1;
- (void)cleanup;
- (void)didStart;
...
- (void)finallyStartDiagnosticWithIdentifier:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_startDiagnosticExtensionWithDEDIdentifier:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;
