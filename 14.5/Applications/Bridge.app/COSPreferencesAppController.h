...
#import "NTKGreenfieldB640ViewControllerDelegate-Protocol.h"
...
@class BKSApplicationStateMonitor, BKSProcessAssertion, COSDiscoverListViewController, COSGetStartedViewController, COSPreferencesRootController, COSProfileInstallHelper, COSSetupController, COSUnpairingViewController, COSWatchAppStoreSplashViewController, NPSDomainAccessor, NRActiveDeviceAssertion, NRDevice, NSMutableDictionary, NSObject, NSString, NSTimer, NSUserActivity, PBBridgeCompanionController, PSSplitViewController, UIAlertController, UITabBarController, UIViewController, UIWindow;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface COSPreferencesAppController : UIApplication <PBBridgeConnectionDelegate, PSSplitViewControllerNavigationDelegate, UISplitViewControllerDelegate, COSGetStartedViewControllerDelegate, NRDevicePropertyObserver, UITabBarControllerDelegate, COSGlobalAlertPresentationCoordinatorObserver, PBBridgeIDSReachabilityObserver, UIScreenshotServiceDelegate, NTKGreenfieldB640ViewControllerDelegate, UIApplicationDelegate, MCProfileConnectionObserver, UNUserNotificationCenterDelegate>
{
    _Bool _isLocked;
    _Bool _loadingExternalURL;
    _Bool _processingProfileURL;
    long long _networkStartCount;
    double _timeoutLimit;
    _Bool _settingsWasResigned;
    _Bool _devicePickerPresented;
    ...
    COSDiscoverListViewController *_discoverViewController;
    ...
    COSProfileInstallHelper *_profileInstallHelper;
    NSUserActivity *_galleryTTRUserActivity;
    CDUnknownBlockType _appDelegateOnDismissalBlock;
...
- (_Bool)onlySatellitePairedAndInactive;
...
- (void)_showTinkerSwitchFailureModalForDevice:(id)arg1;
...
- (void)cancelTinkerSwitch:(id)arg1;
...
- (void)_testScrollTest:(id)arg1 onScrollView:(id)arg2;
...
- (id)_topViewControllerWithRootViewController:(id)arg1;
...
- (void)updateNRStatus:(unsigned long long)arg1;
...
- (void)_scrollToTopOfSettingsAnimated:(_Bool)arg1;
- (void)_popToTopLevelSettingsAnimated:(_Bool)arg1 dismissPresentedViewController:(_Bool)arg2;
...
- (unsigned long long)waitToLoadBeforeProcessingURL:(id)arg1;
- (void)processURL:(id)arg1 animated:(_Bool)arg2 fromSearch:(_Bool)arg3;
- (void)processURL:(id)arg1;
- (void)_activateTinkerWatchWithCSN:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
...
- (void)removeActiveDeviceAssertionFor:(id)arg1;
...
- (void)remoteDidFailActivation:(unsigned long long)arg1 description:(id)arg2 userActionable:(_Bool)arg3;
- (void)remoteDidFailActivation:(unsigned long long)arg1 description:(id)arg2;
...
- (_Bool)_isProductKitUrl:(id)arg1;
- (void)didTapOnLoadingFaceLibraryButton:(id)arg1;
- (void)presentGreenfieldViewControllerWithUrl:(id)arg1 options:(id)arg2;
