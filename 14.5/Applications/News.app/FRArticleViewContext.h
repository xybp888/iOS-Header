...
+ (id)articleContextForFeed:(id)arg1 feedContext:(id)arg2 sourceChannel:(id)arg3 isVideoInFeed:(_Bool)arg4 isSubscribedToFeed:(_Bool)arg5 isPaidSubscriberToSourceChannel:(_Bool)arg6 userActionDate:(id)arg7;
