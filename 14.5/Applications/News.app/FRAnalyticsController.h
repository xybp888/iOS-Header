...
@interface FRAnalyticsController : NSObject <FREventCenterObserving, FCUserInfoObserving, FCNetworkReachabilityObserving, FCNewsAppConfigurationObserving, NSSNewsAnalyticsSessionManager, NSSNewsAnalyticsPBEventStreamObserver, NYSessionAccessing>
{
    ...
    _Bool _protobufSubmissionEnabled;
...
- (id)_updateValueWithDictionary:(id)arg1 key:(id)arg2 newValue:(id)arg3 forceUpdate:(_Bool)arg4;
...
- (_Bool)eventShouldTriggerSubmission:(id)arg1;
...
- (void)_startSessionWithReferral:(id)arg1 notificationSettings:(id)arg2 mainThreadProperties:(id)arg3 sceneID:(id)arg4 resetUserID:(_Bool)arg5;
