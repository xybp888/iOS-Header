...
@interface ProximityPairingViewController : SVSBaseViewController <UIGestureRecognizerDelegate>
{
    ...
    int _testMode;
    UILabel *_titleLabel;
    ControlCenterTrainingView *_controlerCenterTrainingView;
    _Bool _hasSkippedFeatureShowcase;
    ...
    NSArray *_avViewConstraints;
    UILabel *_featuresTitleLabel;
    UILabel *_featuresDescriptionLabel;
    UIButton *_featuresSkipButton;
    UIView *_featuresGradient;
...
- (void)handleSkipTutorialButtonTapped:(id)arg1;
