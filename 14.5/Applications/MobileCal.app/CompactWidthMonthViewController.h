...
#import "CompactMonthListViewControllerDelegate-Protocol.h"
...
@interface CompactWidthMonthViewController : CompactMonthViewController <CompactMonthListViewControllerDelegate, EKEventViewDelegate, EKEventViewDelegatePrivate, UIGestureRecognizerDelegate>
{
...
- (void)_showDetailsForEvent:(id)arg1 animated:(_Bool)arg2 showComments:(_Bool)arg3 context:(id)arg4;
- (void)_showDetailsForEvent:(id)arg1 animated:(_Bool)arg2 context:(id)arg3;
