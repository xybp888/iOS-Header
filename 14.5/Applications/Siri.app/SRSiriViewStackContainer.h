...
- (void)setBottomPadding:(double)arg1 animatedWithDuration:(double)arg2 animationOptions:(unsigned long long)arg3 alongsideAnimations:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;
