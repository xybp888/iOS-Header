...
@protocol BookmarkFavoritesViewControllerDelegate, LinkPreviewProvider, OS_dispatch_queue, WBBookmarkProvider, _SFNavigationIntentHandling;
...
@interface BookmarkFavoritesViewController : UIViewController <BookmarkFavoritesGridViewDelegate, _SFWebBookmarkActionHandler, BookmarksFolderViewController>
{
    ...
    struct {
        _Bool contentDidBecomeDirty;
        _Bool contentInset;
        _Bool didTapOutside;
        _Bool favoritesGridViewLayoutType;
        _Bool isPresentedInsideBlankTab;
        _Bool provideContextResponseWithBlock;
    } _delegateFlags;
...
- (void)bookmarkFavoritesGridViewDidReceiveTapOutside:(id)arg1;
