...
@class BookmarkFavoritesGridView, BrowserController, CompletionDetailViewController, CompletionList, CompletionListTableViewController, NSMutableSet, NSString, PopoverCatalogViewController, UIColor, UIImage, UIPopoverPresentationController, UIView, UIViewController, UnifiedField, UniversalSearchFirstTimeExperienceViewController, UniversalSearchSession;
@protocol CatalogViewControllerDelegate, CompletionItem, LoadProgressObserver, _SFNavigationBarCommon;
