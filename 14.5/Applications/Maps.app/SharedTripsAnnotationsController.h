...
- (void)setMapView:(id)arg1 mapCameraController:(id)arg2 personalizedItemManager:(id)arg3 searchPinsManager:(id)arg4 routeAnnotationsController:(id)arg5 animated:(_Bool)arg6;
- (void)dealloc;
- (id)init;
