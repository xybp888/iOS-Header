...
- (void)_updateConstraintsForArtworkListVisible:(_Bool)arg1 elevationGraphViewVisible:(_Bool)arg2 advisoriesViewVisible:(_Bool)arg3 tertiaryLabelVisible:(_Bool)arg4 detailsButtonVisible:(_Bool)arg5 automaticSharingButtonVisible:(_Bool)arg6;
