...
+ (id)statusWithApplication:(id)arg1 rideOption:(id)arg2 startingWaypointCoordinate:(struct CLLocationCoordinate2D)arg3 origin:(id)arg4 destination:(id)arg5 loadingRequestRideStatus:(_Bool)arg6 etaMinutesAtStartWaypoint:(id)arg7;
