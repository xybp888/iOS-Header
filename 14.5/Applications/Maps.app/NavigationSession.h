...
@interface NavigationSession : NSObject <CarRouteSelectableSession, NavigationStateProviderDelegate, RouteCollectionUpdateProviderDelegate, MNNavigationServiceObserver, MapsSession>
{
