...
- (void)_configureCardsForMode:(id)arg1 animated:(_Bool)arg2;
- (void)reloadCardsForMode:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)reloadCardsForMode:(id)arg1 animated:(_Bool)arg2;
- (id)_desiredCards;
- (_Bool)canShowCards;
...
- (void)reloadAccessoriesForMode:(id)arg1 animated:(_Bool)arg2;
