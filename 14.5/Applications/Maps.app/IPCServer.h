...
@class BannerSource, CLInUseAssertion, GuidanceETA, IPCLoadDirectionsMessage, MKJunction, MKServerFormattedString, MNTrafficIncidentAlert, NSArray, NSString, NSTimer, NSUUID, NSXPCConnection, NSXPCListenerEndpoint, NavSignLaneGuidanceInfo, NavSignShieldInfo, UNNotificationSettings;
