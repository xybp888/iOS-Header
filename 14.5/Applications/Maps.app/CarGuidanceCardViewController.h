...
#import "CarDynamicBlurViewDelegate-Protocol.h"
#import "CarGuidanceCardDelegate-Protocol.h"
#import "GuidanceDisplay-Protocol.h"

@class CarArrivedGuidanceSign, CarDynamicBlurView, CarLoadingGuidanceSign, CarNavigationGuidanceSign, CarReroutingGuidanceSign, CarToggledGuidanceSign, NSArray, NSString, NSTimer, NSUUID, NavJunctionViewInfo, NavSignLaneGuidanceInfo, NavSignManeuverGuidanceInfo, UIView;
@protocol CarGuidanceCard, CarGuidanceCardDelegate, CarGuidanceCardViewDelegate;

__attribute__((visibility("hidden")))
@interface CarGuidanceCardViewController : UIViewController <CarGuidanceCardDelegate, CarCardStyleProviding, CarDynamicBlurViewDelegate, GuidanceDisplay, CarCardContent>
{
