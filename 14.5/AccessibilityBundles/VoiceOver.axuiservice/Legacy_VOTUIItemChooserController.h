...
@protocol BSInvalidatable, Legacy_VOTUIItemChooserDelegate;

@interface Legacy_VOTUIItemChooserController : UIViewController <SBSHardwareButtonEventConsuming, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate>
{
    ...
    id <BSInvalidatable> _homeButtonIntercept;
    id <Legacy_VOTUIItemChooserDelegate> _delegate;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <Legacy_VOTUIItemChooserDelegate> delegate; // @synthesize delegate=_delegate;
