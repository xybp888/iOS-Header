...
@interface AXTouchAccommodationsEventProcessor : AXEventProcessor
{
    ...
    _Bool _canBeginIgnoreRepeatTimer;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool canBeginIgnoreRepeatTimer; // @synthesize canBeginIgnoreRepeatTimer=_canBeginIgnoreRepeatTimer;
...
- (_Bool)_shouldPassAlongWithoutHandlingEvent:(id)arg1;
...
- (void)_trackUpdateStatusForEvent:(id)arg1;
