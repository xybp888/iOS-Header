...
- (void)updateSiriVoiceListWithGender:(id)arg1 language:(id)arg2 assetName:(id)arg3 add:(_Bool)arg4 isNeural:(_Bool)arg5;
- (void)updateSiriVoiceUsageForIdentifier:(id)arg1 add:(_Bool)arg2;
