...
+ (_Bool)hasRawLocationsNeededToComputeSmoothedLocationAtDate:(id)arg1 workingVisitExit:(id)arg2 rawLocations:(id)arg3 kernelWidth:(double)arg4 smallestSignificantWeightExponent:(double)arg5;
