...
- (_Bool)sendNewMessage:(int)arg1 error:(id *)arg2 replyQueue:(struct dispatch_queue_s *)arg3 timeout:(unsigned long long)arg4 handler:(CDUnknownBlockType)arg5;
- (_Bool)send:(id)arg1 error:(id *)arg2;
- (_Bool)send:(id)arg1 error:(id *)arg2 replyQueue:(struct dispatch_queue_s *)arg3 timeout:(unsigned long long)arg4 handler:(CDUnknownBlockType)arg5;
