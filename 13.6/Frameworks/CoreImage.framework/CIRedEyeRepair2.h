...
- (void)initChoiceRecord:(CDStruct_85f69347 *)arg1 type:(int)arg2 title:(char *)arg3 plusWhiteTitle:(char *)arg4 name:(char *)arg5 canPlusWhite:(_Bool)arg6 canSpecular:(_Bool)arg7 metrics:(CDStruct_3882bc9d)arg8;
...
- (_Bool)findProminenceWithSide:(int)arg1 record:(CDStruct_85f69347 *)arg2;
- (void)freeBitmaps;
