...
- (void)appendSize:(float)arg1 minimumSize:(float)arg2 withIconMode:(unsigned char)arg3 lowQuality:(_Bool)arg4 badgeType:(unsigned long long)arg5 iconVariant:(long long)arg6 interpolationQuality:(int)arg7;
- (void)dealloc;
