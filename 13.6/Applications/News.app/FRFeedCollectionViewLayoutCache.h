...
- (long long)yOriginOfLayoutTileInfoID:(id)arg1 searchUnderlyingTileInfos:(_Bool)arg2;
- (id)indexPathForLayoutTileInfoID:(id)arg1 searchUnderlyingTileInfos:(_Bool)arg2;
- (id)layoutTileInfoForID:(id)arg1 searchUnderlyingTileInfos:(_Bool)arg2;
