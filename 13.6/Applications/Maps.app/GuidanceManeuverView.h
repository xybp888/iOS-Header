...
@class GuidanceManeuverArtwork, NSArray, UIBezierPath, UIColor, UIImage;
...
- (void)_drawImageWithManeuverType:(int)arg1 inRect:(struct CGRect)arg2;
...
- (_Bool)_maneuverTypeRequiresDrawingPaths:(int)arg1;
