...
@property _Bool cook_sqf_fallback_qi_cep; // @synthesize cook_sqf_fallback_qi_cep=_cook_sqf_fallback_qi_cep;
@property _Bool cook_sqf_topdown; // @synthesize cook_sqf_topdown=_cook_sqf_topdown;
@property _Bool cook_sqf; // @synthesize cook_sqf=_cook_sqf;
...
@property _Bool text_features_demotion; // @synthesize text_features_demotion=_text_features_demotion;
...
@property _Bool use_server_default_score; // @synthesize use_server_default_score=_use_server_default_score;
...
@property _Bool didGetKnobValues; // @synthesize didGetKnobValues=_didGetKnobValues;
- (id)init;
