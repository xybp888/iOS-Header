...
+ (_Bool)version21DataUsingAdapter:(id)arg1 containsData:(id)arg2;
+ (_Bool)version30DataUsingAdapter:(id)arg1 containsData:(id)arg2;
+ (_Bool)version30CardForPerson:(id)arg1 containsString:(id)arg2;
+ (_Bool)version30CardForPerson:(id)arg1 containsLine:(id)arg2;
...
+ (id)complexValueWithValue:(id)arg1 label:(id)arg2 isPrimary:(_Bool)arg3;
+ (id)resultWithProperty:(id)arg1 value:(id)arg2 label:(id)arg3 isPrimary:(_Bool)arg4;
