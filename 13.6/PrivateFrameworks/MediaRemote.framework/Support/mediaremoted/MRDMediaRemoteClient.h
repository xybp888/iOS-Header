...
@interface MRDMediaRemoteClient : NSObject
{
    ...
    NSObject<OS_dispatch_queue> *_connectionSerialQueue;
    ...
    unsigned long long _maxPendingMessageCountBeforeConenctionSuspension;
    double _timeoutBeforeConnectionSuspension;
...
- (void)_onConnectionQueue_postNotification:(id)arg1;
- (void)_onConnectionQueue_connectionResumed;
- (void)_onConnectionQueue_connectionSuspended;
