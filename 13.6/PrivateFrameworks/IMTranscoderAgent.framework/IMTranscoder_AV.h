...
- (void)_transcodeVideoAsync:(id)arg1 target:(long long)arg2 maxBytes:(unsigned long long)arg3 removeAlpha:(_Bool)arg4 userInfo:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
