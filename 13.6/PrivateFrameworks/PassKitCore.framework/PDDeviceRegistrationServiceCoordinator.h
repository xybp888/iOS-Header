...
- (void)performDeviceRegistrationForReason:(id)arg1 action:(long long)arg2 forceApplePayRegister:(_Bool)arg3 forcePeerPaymentRegister:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
