...
@property(readonly, nonatomic, getter=isEligibleAccountSignedIn) _Bool eligibleAccountSignedIn;
- (void)executeQuery:(id <CRKClassKitQuery>)arg1;
- (id <CRKClassKitQuery>)makeInstructorQueryForSearchString:(NSString *)arg1 sortingGivenNameFirst:(_Bool)arg2 pageSize:(long long)arg3;
- (id <CRKClassKitQuery>)makeStudentQueryForSearchString:(NSString *)arg1 sortingGivenNameFirst:(_Bool)arg2 pageSize:(long long)arg3;
