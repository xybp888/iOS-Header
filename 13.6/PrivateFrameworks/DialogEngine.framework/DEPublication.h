...
+ (_Bool)write:(id)arg1 tag:(id)arg2 date:(id)arg3 disabled:(_Bool)arg4 toURL:(id)arg5 keyId:(unsigned long long)arg6 multipart:(_Bool)arg7;
...
- (id)getPublicationId;
- (id)init;
- (id)initWithDistributions:(id)arg1 tag:(id)arg2 lastModified:(id)arg3 disabled:(_Bool)arg4;
