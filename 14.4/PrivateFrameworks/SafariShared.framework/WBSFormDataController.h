...
- (void)updateLastUsedUsernameAndExtractUsernameAndPasswordFromForm:(id)arg1 shouldPreferAnnotatedCredentials:(_Bool)arg2 atURL:(id)arg3 username:(id *)arg4 password:(id *)arg5;
- (void)willSubmitFormWithCredentials:(id)arg1 shouldPreferAnnotatedCredentials:(_Bool)arg2 atURL:(id)arg3 username:(id *)arg4 password:(id *)arg5;
