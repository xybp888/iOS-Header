...
- (_Bool)_ensureVisitHasID:(id)arg1;
- (_Bool)_ensureItemHasID:(id)arg1;
...
- (_Bool)shouldEmitLegacyTombstones;
...
- (void)_addOrUpdateItemsOnDatabaseQueue:(id)arg1 userInitiated:(_Bool)arg2;
