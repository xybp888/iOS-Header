...
- (void).cxx_destruct;
@property(retain, nonatomic) NSDictionary *firmwareUpdateAutoApplyPolicies; // @synthesize firmwareUpdateAutoApplyPolicies=_firmwareUpdateAutoApplyPolicies;
@property(retain, nonatomic) NSDictionary *firmwareUpdateStagingPolicies; // @synthesize firmwareUpdateStagingPolicies=_firmwareUpdateStagingPolicies;
...
- (_Bool)policyConfigurationAvailableForAllHAPServices;
