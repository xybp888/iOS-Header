...
- (_Bool)_updateTransactionSourceIdentifiersDuringMigration:(id)arg1;
...
- (void)_saveTransaction:(id)arg1 forTransactionSourceIdentifier:(id)arg2 withPaymentCredentialType:(long long)arg3 shouldTrim:(_Bool)arg4;
