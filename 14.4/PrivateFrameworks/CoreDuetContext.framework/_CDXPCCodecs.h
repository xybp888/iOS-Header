...
+ (_Bool)parseNotificationEvent:(id)arg1 registrationIdentifier:(id *)arg2 info:(id *)arg3 error:(id *)arg4;
...
+ (_Bool)keepAliveFromKeepAliveEvent:(id)arg1 error:(id *)arg2;
+ (id)keepAliveEventWithKeepAlive:(_Bool)arg1 error:(id *)arg2;
+ (id)unsubscribeFromContextValueNotificationsReplyWithEvent:(id)arg1 error:(id)arg2;
+ (_Bool)parseUnsubscribeFromContextValueNotificationsEvent:(id)arg1 registration:(id *)arg2 deviceIDs:(id *)arg3 error:(id *)arg4;
...
+ (_Bool)parseSubscribeToContextValueNotificationsEvent:(id)arg1 registration:(id *)arg2 deviceIDs:(id *)arg3 error:(id *)arg4;
...
+ (_Bool)addKeyPaths:(id)arg1 toDictionary:(id)arg2 error:(id *)arg3;
+ (id)deviceIDsFromDictionary:(id)arg1 error:(id *)arg2;
+ (_Bool)addDeviceIDs:(id)arg1 toDictionary:(id)arg2 error:(id *)arg3;
+ (id)registrationFromDictionary:(id)arg1 error:(id *)arg2;
+ (_Bool)addRegistration:(id)arg1 toDictionary:(id)arg2 error:(id *)arg3;
