...
- (void)_sendMessageWithProtobuf:(id)arg1 destination:(id)arg2 currentUser:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_sendCloudStoreInvitationRequest:(id)arg1 currentUser:(id)arg2 type:(unsigned short)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)sendCloudStoreZoneInvitation:(id)arg1 forHandle:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)dealloc;
