...
- (id)getLegacyTrackEncodedPixelFormatMetadataForStream:(id)arg1 fromMap:(map_d85c7ab5 *)arg2;
- (id)getLegacyTrackInputPixelFormatMetadataForStream:(id)arg1 fromMap:(map_d85c7ab5 *)arg2;
...
- (id)getLegacyTrackMetadataForAttachmentsSerializationMode:(id)arg1 fromMap:(map_d85c7ab5 *)arg2;
...
- (_Bool)marksOutputTracksAsEnabledForStream:(basic_string_a1f69cfb)arg1 fromMap:(map_d85c7ab5 *)arg2;
