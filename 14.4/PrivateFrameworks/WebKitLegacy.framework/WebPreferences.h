...
- (id)init;
- (void)setUserGesturePromisePropagationEnabled:(_Bool)arg1;
- (_Bool)userGesturePromisePropagationEnabled;
- (void)setWebSQLEnabled:(_Bool)arg1;
- (_Bool)webSQLEnabled;
@property(nonatomic) _Bool aspectRatioOfImgFromWidthAndHeightEnabled;
- (void)setInAppBrowserPrivacyEnabled:(_Bool)arg1;
- (_Bool)isInAppBrowserPrivacyEnabled;
@property(nonatomic) _Bool remotePlaybackEnabled;
- (void)setLayoutFormattingContextIntegrationEnabled:(_Bool)arg1;
- (_Bool)layoutFormattingContextIntegrationEnabled;
...
- (void)setLineHeightUnitsEnabled:(_Bool)arg1;
- (_Bool)lineHeightUnitsEnabled;
...
@property(nonatomic) _Bool useGPUProcessForMedia;
...
- (void)setCSSCustomPropertiesAndValuesEnabled:(_Bool)arg1;
- (_Bool)CSSCustomPropertiesAndValuesEnabled;
- (void)setWebAnimationsMutableTimelinesEnabled:(_Bool)arg1;
- (_Bool)webAnimationsMutableTimelinesEnabled;
- (void)setWebAnimationsCompositeOperationsEnabled:(_Bool)arg1;
- (_Bool)webAnimationsCompositeOperationsEnabled;
...
- (void)setDialogElementEnabled:(_Bool)arg1;
- (_Bool)dialogElementEnabled;
...
- (void)setHighlightAPIEnabled:(_Bool)arg1;
- (_Bool)highlightAPIEnabled;
...
- (void)setMaskWebGLStringsEnabled:(_Bool)arg1;
- (_Bool)maskWebGLStringsEnabled;
...
- (void)setModernUnprefixedWebAudioEnabled:(_Bool)arg1;
- (_Bool)modernUnprefixedWebAudioEnabled;
...
- (void)setAllowTopNavigationToDataURLs:(_Bool)arg1;
- (_Bool)allowTopNavigationToDataURLs;
