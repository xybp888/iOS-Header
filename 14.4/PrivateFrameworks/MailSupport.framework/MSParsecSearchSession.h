...
- (void)reportQueryWithRestrictedComponents:(id)arg1 triggerEvent:(unsigned long long)arg2 hasCurrentMailboxScope:(_Bool)arg3;
- (void)reportQueryWithRestrictedComponents:(id)arg1 triggerEvent:(unsigned long long)arg2 hasCurrentMailboxScope:(_Bool)arg3 searchViewAppeared:(_Bool)arg4;
- (void)reportSearchViewAppeared:(_Bool)arg1 currentMailboxScope:(_Bool)arg2;
