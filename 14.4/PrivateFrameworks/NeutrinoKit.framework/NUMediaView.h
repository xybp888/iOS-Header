...
- (void)_updateVideoPlayerAlpha:(_Bool)arg1;
...
- (id)_renderView;
- (id)_scrollView;
- (void)setVideoPlayerVisible:(_Bool)arg1 animated:(_Bool)arg2;
...
- (struct UIEdgeInsets)_edgeInsetsForContentSize:(struct CGSize)arg1 inFrame:(struct CGRect)arg2 alwaysCenterContent:(_Bool)arg3;
