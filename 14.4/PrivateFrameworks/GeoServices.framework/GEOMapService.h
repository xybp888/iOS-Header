...
- (id)_cachedMapItemForHandle:(id)arg1 enforceMaxAge:(_Bool)arg2;
...
- (id)ticketForBatchReverseGeocodeLocations:(id)arg1 locationShifter:(CDUnknownBlockType)arg2 additionalPlaceTypes:(int *)arg3 additionalPlaceTypesCount:(unsigned int)arg4 placeTypeLimit:(int)arg5 traits:(id)arg6;
- (id)ticketForBatchReverseGeocodeLocations:(id)arg1 shiftLocationsIfNeeded:(_Bool)arg2 additionalPlaceTypes:(int *)arg3 additionalPlaceTypesCount:(unsigned int)arg4 placeTypeLimit:(int)arg5 traits:(id)arg6;
...
- (id)ticketForReverseGeocodeLocation:(id)arg1 preserveOriginalLocation:(_Bool)arg2 placeTypeLimit:(int)arg3 traits:(id)arg4;
...
- (id)init;
- (id)_ticketForLegacyBatchReverseGeocodeLocations:(id)arg1 locationShifter:(CDUnknownBlockType)arg2 additionalPlaceTypes:(int *)arg3 additionalPlaceTypesCount:(unsigned int)arg4 placeTypeLimit:(int)arg5 traits:(id)arg6;
