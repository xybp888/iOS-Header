...
- (void)_setHDRSceneDetectedForPhotoOutput:(_Bool)arg1;
...
- (void)_setActiveFormat:(id)arg1 resetVideoZoomFactorAndMinMaxFrameDurations:(_Bool)arg2 sessionPreset:(id)arg3;
