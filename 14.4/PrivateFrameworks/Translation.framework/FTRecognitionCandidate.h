...
@interface FTRecognitionCandidate : NSObject <FLTBFBufferAccessor, NSCopying>
{
    ...
    NSData *_data;
    const struct RecognitionCandidate *_root;
}

- (void).cxx_destruct;
- (id)flatbuffData;
- (Offset_adec5a97)addObjectToBuffer:(struct FlatBufferBuilder *)arg1;
...
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionCandidate *)arg2 verify:(_Bool)arg3;
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionCandidate *)arg2;
