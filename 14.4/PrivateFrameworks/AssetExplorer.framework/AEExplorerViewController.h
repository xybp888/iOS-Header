...
- (void)_stageAsset:(id)arg1 withReference:(id)arg2 suppressLivePhotoContent:(_Bool)arg3 mediaOrigin:(long long)arg4 completionHandler:(CDUnknownBlockType)arg5;
