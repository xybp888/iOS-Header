...
- (_Bool)processStunErrorResponse:(id)arg1 packetBuffer:(CDStruct_78c9ccae *)arg2 headerOverhead:(unsigned long long)arg3;
...
- (_Bool)processSessionInfoResponse:(id)arg1 packetBuffer:(CDStruct_78c9ccae *)arg2 headerOverhead:(unsigned long long)arg3;
- (_Bool)processInfoResponse:(id)arg1 packetBuffer:(CDStruct_78c9ccae *)arg2 headerOverhead:(unsigned long long)arg3;
