...
- (_Bool)_paywallConfigDidChangeOldConfig:(id)arg1 newConfig:(id)arg2;
- (_Bool)_checkIfShouldIgnoreCache;
- (void)_loadConfigurationFromStore:(id)arg1;
- (void)_configurationDidChangeSignificantConfigChange:(_Bool)arg1 paywallConfigDidChange:(_Bool)arg2;
- (id)_storefrontID;
