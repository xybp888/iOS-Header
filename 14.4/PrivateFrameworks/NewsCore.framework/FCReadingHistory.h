...
- (_Bool)_markArticleAsSeenWithArticleID:(id)arg1 rememberForever:(_Bool)arg2 articleVersion:(long long)arg3 historyItem:(id)arg4 modifiedHistoryFeaturesOut:(unsigned long long *)arg5;
- (_Bool)_markArticleAsSeenWithHeadline:(id)arg1 rememberForever:(_Bool)arg2 historyItem:(id)arg3 modifiedHistoryFeaturesOut:(unsigned long long *)arg4;
- (_Bool)markArticle:(id)arg1 withCompletedListening:(_Bool)arg2;
- (_Bool)hasArticleCompletedListening:(id)arg1;
- (id)markArticlesAsSeenWithHeadlines:(id)arg1 rememberForever:(_Bool)arg2;
