...
+ (id)_findCompatibleDescriptorForDevice:(id)arg1 fromVariants:(id)arg2;
+ (id)_findCompatibleDescriptor:(id)arg1;
+ (id)_filterAndSortVariants:(id)arg1 compatibleWithDevice:(id)arg2;
...
+ (id)findCompatibleDescriptorForDevice:(id)arg1 fromVariants:(id)arg2;
