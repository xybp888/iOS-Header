...
- (void)_resetDB;
- (void)_removeAppsWithBundleIDs:(id)arg1 context:(id)arg2;
- (void)_removeAppWithBundleID:(id)arg1 context:(id)arg2;
...
- (void)_flushMetricsWithContext:(id)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;
