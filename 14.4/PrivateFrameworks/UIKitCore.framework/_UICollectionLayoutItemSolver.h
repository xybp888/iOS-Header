...
- (unsigned long long)_directionalEdgeForLayoutAxis:(unsigned long long)arg1 preEdge:(_Bool)arg2;
- (struct CGPoint)_layoutOffsetForContainer:(id)arg1;
- (struct CGSize)_effectiveContainerSizeForContainer:(id)arg1;
- (double)_additionalDimensionForEdgeSpacingAlongAxis:(unsigned long long)arg1 group:(id)arg2 trailingEdgeOnly:(_Bool)arg3;
...
- (void)_solve;
- (void)_solveForContainer:(id)arg1 layoutAxis:(unsigned long long)arg2 traitCollection:(id)arg3 maxFrameCount:(long long)arg4 layoutRTL:(_Bool)arg5 preferredSizes:(id)arg6 solutionRecursionDepth:(long long)arg7;
...
- (void)solveForContainer:(id)arg1 layoutAxis:(unsigned long long)arg2 traitCollection:(id)arg3 maxFrameCount:(long long)arg4 layoutRTL:(_Bool)arg5 preferredSizes:(id)arg6;
- (void)solveForContainer:(id)arg1 layoutAxis:(unsigned long long)arg2 traitCollection:(id)arg3 maxFrameCount:(long long)arg4 layoutRTL:(_Bool)arg5;
- (_Bool)canAccomodateItemWithSize:(struct CGSize)arg1;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (id)initWithItem:(id)arg1 supplementaryEnroller:(id)arg2;
- (id)initWithItem:(id)arg1;
- (id)initWithItem:(id)arg1 supplementaryEnroller:(id)arg2 container:(id)arg3 layoutAxis:(unsigned long long)arg4 traitCollection:(id)arg5 maxFrameCount:(long long)arg6 layoutRTL:(_Bool)arg7 preferredSizes:(id)arg8 solverResult:(id)arg9 solutionRecursionDepth:(long long)arg10;
