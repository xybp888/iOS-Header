...
- (_Bool)_forceDisplayOverridePlaceholder;
- (void)_setForceDisplayOverridePlaceholder:(_Bool)arg1;
...
- (void)_enabledDidChangeAnimated:(_Bool)arg1;
...
- (_Bool)fieldEditorShouldExtendCaretHeight:(id)arg1;
...
- (id)_fieldEditorHostAllowingCreation:(_Bool)arg1;
- (id)_fieldEditorHost;
...
- (void)_invalidateBackgroundProviderForced:(_Bool)arg1;
...
- (void)_setAttributedText:(id)arg1 setCaretSelectionAfterText:(_Bool)arg2;
...
- (void)_setAttributedTextOnFieldEditor:(id)arg1 setCaretSelectionAfterText:(_Bool)arg2;
...
- (void)_updateBaselineInformationDependentOnBoundsAllowingInvalidation:(_Bool)arg1;
