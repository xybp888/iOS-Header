...
- (_Bool)_addLanguageModelCompletionsForPartialWordRange:(struct _NSRange)arg1 language:(id)arg2 connection:(struct _PR_DB_IO *)arg3 sender:(id)arg4 encoding:(unsigned int)arg5 tagger:(id)arg6 taggerIndex:(unsigned long long)arg7 appIdentifier:(id)arg8 waitForLanguageModel:(_Bool)arg9 candidates:(id)arg10 tryTransliteration:(_Bool *)arg11;
...
- (unsigned long long)_contextLengthForRange:(struct _NSRange)arg1 language:(id)arg2 tagger:(id)arg3 taggerIndex:(unsigned long long)arg4 languageModel:(id)arg5 maxContextLength:(unsigned long long)arg6 context:(unsigned int *)arg7 cleanOffset:(unsigned long long *)arg8 lastTokenRange:(struct _NSRange *)arg9 lastTokenID:(unsigned int *)arg10;
- (id)backgroundMaintenanceQueue;
- (_Bool)shouldBlockWord:(id)arg1 language:(id)arg2 encoding:(unsigned int)arg3;
- (id)_stringForTokenIDs:(const unsigned int *)arg1 tokenCount:(unsigned long long)arg2 entryString:(id)arg3 languageModel:(id)arg4 language:(id)arg5 connection:(struct _PR_DB_IO *)arg6 sender:(id)arg7 encoding:(unsigned int)arg8 prefix:(id)arg9 capitalized:(_Bool)arg10;
...
- (_Bool)noSuggestForCompletion:(id)arg1 language:(id)arg2 appIdentifier:(id)arg3 alreadyCapitalized:(_Bool)arg4;
...
- (_Bool)_acceptWithoutAccentForString:(id)arg1 range:(struct _NSRange)arg2 inString:(id)arg3 language:(id)arg4;
- (id)_accentCorrectionResultForString:(id)arg1 range:(struct _NSRange)arg2 inString:(id)arg3 offset:(unsigned long long)arg4 language:(id)arg5 onlyAtInsertionPoint:(_Bool)arg6 capitalize:(_Bool)arg7 keyEventArray:(id)arg8 selectedRangeValue:(id)arg9;
...
- (char *)_validatedGuessWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 connection:(struct _PR_DB_IO *)arg4 sender:(id)arg5 checkUser:(_Bool)arg6 additionalBuffer:(char *)arg7;
...
- (_Bool)checkNegativeWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned int)arg4 alreadyCapitalized:(_Bool)arg5;
- (unsigned long long)acceptabilityOfWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned int)arg4 forPrediction:(_Bool)arg5 alreadyCapitalized:(_Bool)arg6;
- (unsigned long long)acceptabilityOfWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned int)arg4 forPrediction:(_Bool)arg5 alreadyCapitalized:(_Bool)arg6 depth:(unsigned long long)arg7;
