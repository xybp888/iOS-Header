...
+ (_Bool)isMetricKitClient:(id)arg1;
...
- (void)_extractBacktraceInfoUsingSymbolicator:(struct _CSTypeRef)arg1 usingCorpse:(_Bool)arg2 usingCatalog:(id)arg3;
...
- (void)_extractCrashReporterAnnotationsFromSymbolOwner:(struct _CSTypeRef)arg1 withMemory:(struct mapped_memory_t *)arg2 internal:(_Bool)arg3;
- (id)_readDataFromMemory:(struct mapped_memory_t *)arg1 atAddress:(unsigned long long)arg2 size:(unsigned long long)arg3;
- (struct _VMURange)_regionAtAddress:(unsigned long long)arg1 immutableOnly:(_Bool)arg2;
- (char *)_copyStringFromTask:(unsigned int)arg1 atAddress:(unsigned long long)arg2 immutableOnly:(_Bool)arg3 maxLength:(unsigned long long)arg4;
- (id)_readStringAtTaskAddress:(unsigned long long)arg1 immutableOnly:(_Bool)arg2 maxLength:(unsigned long long)arg3;
...
- (void)autopsyCorpse;
- (void)finishExtractionUsingCorpse:(_Bool)arg1;
- (struct _CSTypeRef)_getSymbolicator:(_Bool)arg1 forAutopsy:(_Bool)arg2;
