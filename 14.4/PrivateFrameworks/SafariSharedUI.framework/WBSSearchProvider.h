...
- (id)initWithShortName:(id)arg1 searchURLTemplate:(id)arg2 safeSearchURLTemplate:(id)arg3 safeSearchURLQueryParameters:(id)arg4 usesSearchTermsFromFragment:(_Bool)arg5 groupIdentifierQueryStringKey:(id)arg6 suggestionsURLTemplate:(id)arg7 hostSuffixes:(id)arg8 pathPrefixes:(id)arg9;
