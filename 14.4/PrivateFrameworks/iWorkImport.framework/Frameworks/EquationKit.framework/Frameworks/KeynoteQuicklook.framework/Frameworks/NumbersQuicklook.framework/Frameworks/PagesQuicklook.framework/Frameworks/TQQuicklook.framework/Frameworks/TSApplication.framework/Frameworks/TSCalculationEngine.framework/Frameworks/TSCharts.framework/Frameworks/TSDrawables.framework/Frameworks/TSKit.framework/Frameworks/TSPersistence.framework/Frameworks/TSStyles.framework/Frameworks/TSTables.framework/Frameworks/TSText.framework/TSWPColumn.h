...
+ (id)commentKnobBaseOriginForHighlightAtTextRange:(struct _NSRange)arg1 withColumns:(id)arg2 positionForRTL:(_Bool)arg3;
...
+ (CDStruct_f9ea3fe9)pencilAnnotationLineMetricsAtCharIndex:(unsigned long long)arg1 withColumns:(id)arg2;
...
- (CDStruct_f9ea3fe9)lineMetricsAtCharIndex:(unsigned long long)arg1 allowEndOfLine:(_Bool)arg2;
...
- (struct TSWPFontHeightInfo)fontHeightInfoAtCharIndex:(unsigned long long)arg1;
- (struct CGRect)rawGlyphRectOfRange:(struct _NSRange)arg1;
...
- (struct CGRect)boundsIncludingDropCapRectsForSelectionType:(int)arg1;
