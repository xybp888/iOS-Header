...
- (int)getCell:(id)arg1 atCellUID:(const struct TSTCellUID *)arg2 suppressCellBorder:(_Bool)arg3;
...
- (_Bool)writeCellIDsInCellUIDList:(id)arg1 toVector:(vector_38b190b0 *)arg2 prunedCellUIDs:(vector_0c3ec296 *)arg3;
...
- (id)textStyleAtCellUID:(const struct TSTCellUID *)arg1 isDefault:(out _Bool *)arg2;
- (id)cellStyleAtCellUID:(const struct TSTCellUID *)arg1 isDefault:(out _Bool *)arg2;
...
- (int)setCell:(id)arg1 atCellUID:(const struct TSTCellUID *)arg2 ignoreFormula:(_Bool)arg3 clearImportWarnings:(_Bool)arg4 formulaReplacer:(id)arg5;
