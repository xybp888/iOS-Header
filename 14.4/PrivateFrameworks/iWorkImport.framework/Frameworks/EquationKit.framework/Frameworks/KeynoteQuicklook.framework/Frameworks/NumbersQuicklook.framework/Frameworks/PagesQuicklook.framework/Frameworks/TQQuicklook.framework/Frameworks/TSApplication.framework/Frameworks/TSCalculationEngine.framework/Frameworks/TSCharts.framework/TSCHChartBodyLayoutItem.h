...
- (struct CGAffineTransform)p_transformForRenderingLabelForBarColSeries:(unsigned long long)arg1 forGroupIndex:(unsigned long long)arg2 outElementSize:(struct CGSize *)arg3 outClipRect:(struct CGRect *)arg4;
