...
- (_Bool)getTreatment:(id *)arg1 forExperiment:(id)arg2 systemCovariates:(id)arg3 userCovariates:(id)arg4 error:(id *)arg5;
- (_Bool)getTreatment:(id *)arg1 forExperiment:(id)arg2 paths:(id)arg3 error:(id *)arg4;
