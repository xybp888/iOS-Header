...
- (void)launchInfoForSuggestedEventWithUniqueIdentifier:(id)arg1 sourceURL:(id)arg2 clientLocale:(id)arg3 ignoreUserActivitySupport:(_Bool)arg4 ignoreMailCheck:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)_suggestionsFromMessageWithIdentifier:(id)arg1 options:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3 completionDelivery:(unsigned long long)arg4 providedBy:(CDUnknownBlockType)arg5 searchableItem:(id)arg6 dissectIfNecessary:(_Bool)arg7;
