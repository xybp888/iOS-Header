...
{
    _Bool _awaitingRemoteAlertConnectionToDismissPersistentMode;
...
@property(nonatomic) _Bool awaitingRemoteAlertConnectionToDismissPersistentMode; // @synthesize awaitingRemoteAlertConnectionToDismissPersistentMode=_awaitingRemoteAlertConnectionToDismissPersistentMode;
