...
+ (struct CGSize)_expectedSizeForControlStatusType:(long long)arg1 controlTitle:(id)arg2 hasControlImage:(_Bool)arg3 displayScale:(double)arg4 preferredHeight:(double)arg5 minTitleLength:(double)arg6;
- (void).cxx_destruct;
...
- (void)setControlStatus:(struct HUDownloadControlStatus)arg1 animated:(_Bool)arg2;
