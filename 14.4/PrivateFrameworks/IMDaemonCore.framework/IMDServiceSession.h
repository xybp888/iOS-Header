...
- (_Bool)_shouldBlackholeGroupChatFromSender:(id)arg1 toRecipient:(id)arg2 withOtherParticipants:(id)arg3 forAccount:(id)arg4;
...
- (void)didUpdateChatStatus:(int)arg1 chat:(id)arg2 style:(unsigned char)arg3 displayName:(id)arg4 groupID:(id)arg5 lastAddressedHandle:(id)arg6 lastAddressedSIMID:(id)arg7 handleInfo:(id)arg8 account:(id)arg9 category:(long long)arg10 spamExtensionName:(id)arg11 isBlackholed:(_Bool)arg12;
...
- (void)leaveAllChats;
- (void)requestGroupPhotoIfNecessary:(id)arg1 incomingGroupPhotoCreationTime:(id)arg2 toIdentifier:(id)arg3 fromIdentifier:(id)arg4 messageIsFromStorage:(_Bool)arg5;
- (void)_blastDoorProcessingWithIMMessageItem:(id)arg1 chat:(id)arg2 account:(id)arg3 fromToken:(id)arg4 fromIDSID:(id)arg5 fromIdentifier:(id)arg6 toIdentifier:(id)arg7 participants:(id)arg8 groupName:(id)arg9 groupID:(id)arg10 isEncrypted:(_Bool)arg11 isFromMe:(_Bool)arg12 isLastFromStorage:(_Bool)arg13 isFromStorage:(_Bool)arg14 hideLockScreenNotification:(_Bool)arg15 wantsCheckpointing:(_Bool)arg16 needsDeliveryReceipt:(id)arg17 messageBalloonPayloadAttachmentDictionary:(id)arg18 inlineAttachments:(id)arg19 attributionInfoArray:(id)arg20 nicknameDictionary:(id)arg21 messageContext:(id)arg22 completionBlock:(CDUnknownBlockType)arg23;
...
- (void)_messageStoreCompletion:(_Bool)arg1 inputMessage:(id)arg2 outputMessage:(id)arg3 originalMessage:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;
