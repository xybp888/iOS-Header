...
- (void)currentInflightCapturesStringWithCompletionHandler:(CDUnknownBlockType)arg1;
...
- (_Bool)_isSessionModificationRequiredByCommand:(id)arg1 logReason:(out id *)arg2 minimumExecutionTime:(out double *)arg3;
