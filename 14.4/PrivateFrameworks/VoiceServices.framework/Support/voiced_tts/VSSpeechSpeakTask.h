...
@class NSArray, NSError, NSObject, NSString, VSAudioData, VSAudioPlaybackService, VSCachingService, VSInstrumentMetrics, VSSpeechEngine, VSSpeechRequest, VSStreamAudioData, VSVoiceAssetSelection, VSVoiceBooster, VSVoiceResourceAsset;
...
@property(nonatomic) _Bool synthesisDidFallback; // @synthesize synthesisDidFallback=_synthesisDidFallback;
