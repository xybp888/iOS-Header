...
- (void)_enqueueCacheWithHash:(id)arg1 audioObject:(id)arg2 timingInfo:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)enqueueCacheWithHash:(id)arg1 streamAudio:(id)arg2 timingInfo:(id)arg3 completion:(CDUnknownBlockType)arg4;
