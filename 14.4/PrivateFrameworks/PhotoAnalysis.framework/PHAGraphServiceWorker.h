...
- (void)enrichmentManager:(id)arg1 didFinishEnrichmentSuccessfully:(_Bool)arg2;
...
- (void)enrichDataModelWithOptions:(id)arg1 isEnrichmentJob:(_Bool)arg2 context:(id)arg3 progressHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (_Bool)completedJobTodayForBackgroundJobUserDefaultsKey:(id)arg1;
