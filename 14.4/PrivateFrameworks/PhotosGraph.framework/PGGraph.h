...
- (id)addUniqueHighlightGroupNodeWithProperties:(id)arg1 didCreate:(_Bool *)arg2;
...
- (id)petNodes;
- (id)addUniqueSceneNodeWithSceneIdentifier:(id)arg1 relevance:(double)arg2 didCreate:(_Bool *)arg3;
