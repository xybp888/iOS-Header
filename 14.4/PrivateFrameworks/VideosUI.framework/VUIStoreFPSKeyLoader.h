...
- (id)_jsonDictionaryForRequest:(id)arg1 isStopRequest:(_Bool)arg2 locationAuthorizationStatus:(long long)arg3;
- (id)_bodyJSONDataForRequests:(id)arg1 isStopRequest:(_Bool)arg2 locationAuthorizationStatus:(long long)arg3;
