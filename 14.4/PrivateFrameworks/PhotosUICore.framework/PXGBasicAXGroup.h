...
- (_Bool)updateWithSelectedChildren:(id)arg1;
...
- (_Bool)_leafAtSpriteIndexIsVisible:(unsigned int)arg1;
- (_Bool)_leafAtSpriteIndexIsSelected:(unsigned int)arg1;
- (_Bool)_leafAtSpriteIndexIsAccessible:(unsigned int)arg1;
- (_Bool)_leafAtSpriteIndex:(unsigned int)arg1 passesFilter:(unsigned long long)arg2;
- (_Bool)_passesFilter:(unsigned long long)arg1;
...
- (_Bool)_loadOrUpdateLeafAtSpriteIndex:(unsigned int)arg1;
...
- (void)_unloadSubgroupAtIndex:(long long)arg1 shouldNotify:(_Bool)arg2;
