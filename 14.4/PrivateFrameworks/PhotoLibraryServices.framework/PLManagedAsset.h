...
+ (id)mainFileURLWithDirectory:(id)arg1 filename:(id)arg2 pathManager:(id)arg3 isCloudShared:(_Bool)arg4;
...
+ (id)_insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 mainFileMetadata:(id)arg3 savedAssetType:(short)arg4 uuid:(id)arg5 replacementUUID:(id)arg6 imageSource:(struct CGImageSource **)arg7 imageData:(id *)arg8 isPlaceholder:(_Bool)arg9 deleteFileOnFailure:(_Bool)arg10;
...
+ (id)insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 mainFileMetadata:(id)arg3 savedAssetType:(short)arg4 uuid:(id)arg5 replacementUUID:(id)arg6 imageSource:(struct CGImageSource **)arg7 imageData:(id *)arg8 isPlaceholder:(_Bool)arg9 deleteFileOnFailure:(_Bool)arg10;
...
+ (_Bool)isPhotoIrisPlaceholderWithPhotoIris:(_Bool)arg1 isCameraProcessingAdjustment:(_Bool)arg2 videoCpDuration:(long long)arg3 isCloudShared:(_Bool)arg4 videoCpFilePath:(id)arg5 cameraProcessingAdjustmentVideoCpFilePath:(id)arg6;
...
+ (_Bool)hasRequiredExtendedAttributesForPersistanceAttributes:(id)arg1;
...
+ (id)objectsWithScopedIdentifiers:(id)arg1 forEntityName:(id)arg2 prefetchResources:(_Bool)arg3 relationshipKeyPathsForPrefetching:(id)arg4 inLibrary:(id)arg5;
+ (id)assetsWithScopedIdentifiers:(id)arg1 prefetchResources:(_Bool)arg2 relationshipKeyPathsForPrefetching:(id)arg3 inLibrary:(id)arg4;
+ (id)assetWithScopedIdentifier:(id)arg1 inLibrary:(id)arg2 prefetchResources:(_Bool)arg3;
...
+ (_Bool)createMomentShareAssetsForMomentShare:(id)arg1 assetsToCopy:(id)arg2 adjustmentBakeInOptionsDictionary:(id)arg3 metadataCopyOptionsDictionary:(id)arg4 keySourceAssetIdentifier:(id)arg5 clientConnection:(id)arg6 library:(id)arg7 error:(id *)arg8;
+ (_Bool)shouldBakeInAdjustmentsAndFlattenLivePhoto:(_Bool *)arg1 forSourceAsset:(id)arg2 adjustmentBakeInOptions:(id)arg3;
...
+ (id)fetchResourcesForAssetWithObjectID:(id)arg1 inContext:(id)arg2 versions:(id)arg3 includeVirtualResources:(_Bool)arg4 allowDerivatives:(_Bool)arg5 additionalPredicate:(id)arg6 relationshipKeyPathsForPrefetching:(id)arg7 error:(id *)arg8;
...
- (_Bool)renderableAdjustmentDictionary:(id *)arg1 error:(id *)arg2;
...
- (id)_generateDeferredAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 reason:(id)arg3 retryNumber:(unsigned long long)arg4 completion:(CDUnknownBlockType)arg5;
...
- (id)attemptCameraProcessingAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 isOnDemand:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (_Bool)_setDefaultSlowMotionAdjustmentsWithMainFileMetadata:(id)arg1;
- (_Bool)setDefaultAdjustmentsIfNecessaryWithMainFileMetadata:(id)arg1;
...
- (void)setAdjustments:(id)arg1 mainFileMetadata:(id)arg2 shouldUpdateAttributes:(_Bool)arg3;
...
- (id)imageDataForThumbGenerationAndIfNeededRAWUTI:(id *)arg1 isPreviewSource:(_Bool *)arg2;
- (void)setFaceRegionsFromImageMetadata:(struct CGImageMetadata *)arg1;
- (void)setFaceRegionsFromCGImageProperties:(id)arg1;
- (void)generateAndUpdateThumbnailsWithPreviewImage:(id)arg1 thumbnailImage:(id)arg2 fromImageSource:(struct CGImageSource *)arg3 imageData:(id)arg4 metadata:(id)arg5 forceSRGBConversion:(_Bool)arg6 saveCameraPreviewWellImage:(_Bool)arg7;
- (void)generateAndUpdateThumbnailsWithPreviewImage:(id)arg1 thumbnailImage:(id)arg2 fromImageSource:(struct CGImageSource *)arg3 imageData:(id)arg4 forceSRGBConversion:(_Bool)arg5;
- (_Bool)setVideoInfoFromFileAtURL:(id)arg1 mainFileMetadata:(id)arg2 fullSizeRenderURL:(id)arg3 overwriteOriginalProperties:(_Bool)arg4;
- (id)_effectiveMetadataForMainFileURL:(id)arg1 mainFileMetadata:(id)arg2 fullSizeRenderURL:(id)arg3 shouldCache:(_Bool)arg4;
- (void)updateVideoAttributesFromMetadata:(id)arg1 overwriteOriginalProperties:(_Bool)arg2;
- (void)updateVideoExtendedAttributesFromMetadata:(id)arg1;
- (_Bool)setImageInfoFromImageMetadata:(id)arg1 overwriteOriginalProperties:(_Bool)arg2;
...
- (_Bool)updatePlaybackVariationAndLoopingStyleFromVariation:(unsigned short)arg1;
...
- (id)imageProperties;
- (_Bool)setAttributesFromMainFileURL:(id)arg1 mainFileMetadata:(id)arg2 savedAssetType:(short)arg3 isPlaceholder:(_Bool)arg4 placeholderFileURL:(id)arg5 imageSource:(struct CGImageSource **)arg6 imageData:(id *)arg7;
- (_Bool)updateAttributesFromMainFileURL:(id)arg1 mainFileMetadata:(id)arg2 fullSizeRenderURL:(id)arg3;
- (void)refreshFaces;
...
- (_Bool)becomePhotoIrisWithMediaGroupUUID:(id)arg1 mainFileMetadata:(id)arg2 videoURL:(id)arg3 spatialOverCaptureURL:(id)arg4 videoDuration:(CDStruct_198678f7)arg5 stillDisplayTime:(CDStruct_198678f7)arg6 options:(unsigned long long)arg7;
- (_Bool)becomePhotoIrisWithMediaGroupUUID:(id)arg1 mainFileMetadata:(id)arg2 videoURL:(id)arg3 videoDuration:(CDStruct_198678f7)arg4 stillDisplayTime:(CDStruct_198678f7)arg5 options:(unsigned long long)arg6;
...
- (_Bool)imagePropertiesIndicatePresenceOfGainMap:(id)arg1;
- (void)generateThumbnailsWithImageSource:(struct CGImageSource *)arg1 imageData:(id)arg2 metadata:(id)arg3 allowMediumPreview:(_Bool)arg4 forceSRGBConversion:(_Bool)arg5 outSmallThumbnail:(id *)arg6 outLargeThumbnail:(id *)arg7 isPreviewSource:(_Bool)arg8;
...
- (id)masterFingerPrintCacheIfNecessaryAndAdjustedFingerPrint:(id *)arg1 fullsizeRenderImageIfNecessary:(_Bool)arg2 error:(id *)arg3;
...
- (_Bool)addSidecarFileAtIndex:(unsigned long long)arg1 sidecarURL:(id)arg2 withFilename:(id)arg3 compressedSize:(id)arg4 captureDate:(id)arg5 modificationDate:(id)arg6 uniformTypeIdentifier:(id)arg7 imageOrientation:(unsigned int)arg8 pathManager:(id)arg9;
- (_Bool)addSidecarFileInfo:(id)arg1 pathManager:(id)arg2 atIndex:(unsigned long long)arg3 mainFileMetadata:(id)arg4;
...
- (_Bool)setupPlaceholderAssetWithRequiredPropertiesFromSourceAsset:(id)arg1 placeholderAssetUUID:(id)arg2 momentShare:(id)arg3 importSessionID:(id)arg4 bakeInAdjustmentsFromSourceAsset:(_Bool)arg5 flattenLivePhoto:(_Bool)arg6 copyTitleDescriptionAndKeywords:(_Bool)arg7 copyCameraProcessingAdjustmentResources:(_Bool)arg8 library:(id)arg9;
...
- (_Bool)placeholder_shouldCopyCameraProcessingAdjustmentResources;
...
- (id)fetchResourceWithIdentity:(id)arg1 createIfNeeded:(_Bool)arg2 error:(id *)arg3;
- (id)firstPersistedResourceMatching:(CDUnknownBlockType)arg1;
- (id)persistedResourcesMatching:(CDUnknownBlockType)arg1;
- (id)fetchResourcesForAssetVersions:(id)arg1 allowDerivatives:(_Bool)arg2 additionalPredicate:(id)arg3 relationshipKeyPathsForPrefetching:(id)arg4 error:(id *)arg5;
