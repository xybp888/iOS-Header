...
@class AirQualityConditionsViewController, NSNumber, NSObject, NSString, UIContextMenuInteraction, UIStackView, UIView, UIVisualEffectView, WFLocation, WeatherConditionsViewController;
@protocol OS_dispatch_source;

__attribute__((visibility("hidden")))
@interface WeatherStackViewController : MapsThemeViewController <UIContextMenuInteractionDelegate, WeatherLocationDataProviderObserver, WeatherConditionsViewControllerDelegate, AirQualityConditionsViewControllerDelegate>
{
