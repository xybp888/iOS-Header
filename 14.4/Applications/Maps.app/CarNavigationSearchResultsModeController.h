...
@class BrowseCategory, BrowseManager, CLLocation, CarChromeViewController, CarMapTrackingController, CarPlaceCardCardViewController, CarSearchResultsCardViewController, CustomPOIsController, NSArray, NSString, NavigationCustomFeaturesSource, PassThroughViewController, PersonalizedItemManager, SearchInfo, SearchSession, UIView, UIViewController;
