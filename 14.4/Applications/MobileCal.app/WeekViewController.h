...
@class CalendarModel, EKCalendarDate, EKDayOccurrenceView, EKEventCreationGestureController, EKEventGestureController, NSDateComponents, NSDateIntervalFormatter, NSMutableArray, NSString, NSTimer, UIScrollView, UITraitCollection, UIView, WeekTimeView;
@protocol WeekViewControllerDelegate;

@interface WeekViewController : MainViewController <EKDayTimeViewDelegate, EKEventCreationGestureControllerDelegate, MainViewControllerOptionalMethods, UIScrollViewDelegate, WeekViewDataSource, WeekGroupViewDelegate, EKEventGestureControllerDelegate, EKEventViewDelegatePrivate>
{
