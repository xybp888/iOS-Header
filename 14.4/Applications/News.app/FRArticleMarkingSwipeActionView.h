...
@interface FRArticleMarkingSwipeActionView : UIView
{
    ...
    _Bool _hasSmallButtons;
    _Bool _didTriggerSwipeAction;
    _Bool _pullThroughEnabled;
    _Bool _shouldRebuildButtons;
...
@property(nonatomic) _Bool shouldRebuildButtons; // @synthesize shouldRebuildButtons=_shouldRebuildButtons;
@property(nonatomic) _Bool pullThroughEnabled; // @synthesize pullThroughEnabled=_pullThroughEnabled;
@property(nonatomic) _Bool didTriggerSwipeAction; // @synthesize didTriggerSwipeAction=_didTriggerSwipeAction;
...
@property(nonatomic) _Bool hasSmallButtons; // @synthesize hasSmallButtons=_hasSmallButtons;
...
- (void)moveToOriginWithOffset:(double)arg1 animated:(_Bool)arg2 usingSpringWithStiffness:(double)arg3 initialVelocity:(double)arg4;
- (void)animateToOffset:(double)arg1 animated:(_Bool)arg2 usingSpringWithStiffness:(double)arg3 initialVelocity:(double)arg4 withQuickSwipe:(_Bool)arg5;
