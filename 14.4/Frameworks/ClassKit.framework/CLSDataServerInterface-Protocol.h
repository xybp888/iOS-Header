...
- (oneway void)remote_executeQuery:(NSObject<CLSQuery> *)arg1 forClassNamed:(NSString *)arg2 predicate:(NSPredicate *)arg3 sortDescriptors:(NSArray *)arg4 state:(unsigned long long)arg5 limit:(unsigned long long)arg6 issueServerRequest:(_Bool)arg7 completion:(void (^)(void))arg8;
