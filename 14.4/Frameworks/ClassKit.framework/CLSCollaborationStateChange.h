...
- (id)description;
- (_Bool)setInfoValue:(id)arg1 forKey:(id)arg2 forDomain:(long long)arg3;
- (_Bool)setAssetURL:(id)arg1 forDomain:(long long)arg2;
- (_Bool)setNote:(id)arg1 forDomain:(long long)arg2;
- (_Bool)setClassID:(id)arg1 forDomain:(long long)arg2;
- (_Bool)setFlags:(unsigned long long)arg1 forDomain:(long long)arg2;
- (_Bool)setState:(long long)arg1 forDomain:(long long)arg2;
- (_Bool)setDomainVersion:(long long)arg1 forDomain:(long long)arg2;
