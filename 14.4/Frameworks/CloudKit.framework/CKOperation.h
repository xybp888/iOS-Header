...
@property(nonatomic) _Bool startedDiscretionaryOperation; // @synthesize startedDiscretionaryOperation=_startedDiscretionaryOperation;
@property(nonatomic) _Bool scheduledDiscretionaryOperation; // @synthesize scheduledDiscretionaryOperation=_scheduledDiscretionaryOperation;
