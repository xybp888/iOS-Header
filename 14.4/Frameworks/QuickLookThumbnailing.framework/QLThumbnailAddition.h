...
+ (_Bool)shouldUseXattrsToStoreThumbnailsOnURL:(id)arg1;
...
+ (void)_hitAdditionsOnURL:(id)arg1 size:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;
