...
- (_Bool)_acceptsECGWithSymptomsStatus:(long long)arg1;
- (_Bool)_acceptsECGWithPrivateClassification:(unsigned long long)arg1;
- (_Bool)_acceptsECGWithAverageHeartRate:(id)arg1;
- (_Bool)_acceptsECGWithPublicClassification:(long long)arg1;
