...
- (id)_copyOccurrenceDatesWithEKEvent:(id)arg1 recurrenceRule:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 timeZone:(id)arg5 exceptionDates:(id)arg6 limit:(long long)arg7 adjustDatesForAllDayEvents:(_Bool)arg8;
...
- (id)copyOccurrenceDatesWithEKEvent:(id)arg1 recurrenceRule:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 timeZone:(id)arg5 limit:(long long)arg6 adjustDatesForAllDayEvents:(_Bool)arg7;
