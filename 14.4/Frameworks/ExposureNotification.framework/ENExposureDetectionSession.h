...
- (double)scoreWithExposureInfo:(id)arg1 skip:(_Bool *)arg2;
- (double)estimateRiskWithExposureInfo:(id)arg1 referenceTime:(double)arg2 transmissionRiskLevel:(char *)arg3 skip:(_Bool *)arg4;
