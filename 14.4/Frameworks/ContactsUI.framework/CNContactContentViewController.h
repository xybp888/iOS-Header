...
+ (_Bool)shouldShowGeminiForResult:(id)arg1 contact:(id)arg2;
...
- (void)_setupContactBlockingActionPreservingChanges:(_Bool)arg1 withUpdate:(_Bool)arg2;
