...
- (id)detectionPrintsFromPixelBuffers:(struct __CVBuffer *)arg1 version:(unsigned long long)arg2 augmentationOptions:(id)arg3 useCPUOnly:(_Bool)arg4 error:(id *)arg5;
...
- (id)scenePrintsFromPixelBuffers:(struct __CVBuffer *)arg1 version:(unsigned long long)arg2 augmentationOptions:(id)arg3 useCPUOnly:(_Bool)arg4 error:(id *)arg5;
- (id)init;
