...
- (_Bool)deletePlacesWithinIdentifierSetWithZeroVisits:(id)arg1 context:(id)arg2 tombstoneContext:(id)arg3 error:(id *)arg4;
- (_Bool)deletePlacesWithinIdentifierSet:(id)arg1 tombstoneContext:(id)arg2 error:(id *)arg3;
- (_Bool)deleteVisitsUsingCloudFetchRequest:(id)arg1 localFetchRequest:(id)arg2 context:(id)arg3 tombstoneContext:(id)arg4 error:(id *)arg5;
- (_Bool)deleteTransitionsReferencingVisitIdentifiers:(id)arg1 context:(id)arg2 tombstoneContext:(id)arg3 error:(id *)arg4;
...
- (_Bool)cloudStoreChangedSinceDate:(id)arg1;
- (void)fetchCloudStorePersistentHistorySinceDate:(id)arg1 earlyStop:(_Bool)arg2 handler:(CDUnknownBlockType)arg3;
...
- (void)_fetchCloudStorePersistentHistorySinceDate:(id)arg1 earlyStop:(_Bool)arg2 handler:(CDUnknownBlockType)arg3;
...
- (_Bool)placeTypeForMapItem:(id)arg1 placeType:(unsigned long long *)arg2 placeTypeSource:(unsigned long long *)arg3 error:(id *)arg4;
...
- (void)_moc_updateExpirationDateOfVisitSubgraphWithVisitIdentifiers:(id)arg1 expirationDate:(id)arg2 allowThresholdBypass:(_Bool)arg3 context:(id)arg4 handler:(CDUnknownBlockType)arg5;
