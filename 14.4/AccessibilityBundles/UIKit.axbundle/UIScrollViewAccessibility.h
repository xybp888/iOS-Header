...
- (struct CGPoint)_axPageAlignedContentOffsetForPoint:(struct CGPoint)arg1;
- (struct CGSize)_axPageSize;
...
- (struct CGPoint)_axMaximumContentOffset;
- (struct CGPoint)_axMinimumContentOffset;
...
- (id)_accessibilityFirstLastOpaqueElement:(_Bool)arg1 options:(id)arg2;
