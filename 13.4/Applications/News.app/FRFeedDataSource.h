...
- (void)videoGroupViewController:(id)arg1 didSelectShareActivityForHeadline:(id)arg2 activityType:(id)arg3 completed:(_Bool)arg4 returnedItems:(id)arg5 activityError:(id)arg6 withGroupID:(id)arg7;
