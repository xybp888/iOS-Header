...
+ (id)purchaseContextWithSourceChannelID:(id)arg1 articleID:(id)arg2 issueID:(id)arg3 sectionID:(id)arg4 purchaseSessionID:(id)arg5 subscriptionConversionPointType:(long long)arg6 qToken:(id)arg7 parentFeedType:(long long)arg8 arrivedFromAd:(_Bool)arg9 referral:(id)arg10;
