...
- (id)initWithEntryID:(id)arg1 tagID:(id)arg2 purchaseID:(id)arg3 qToken:(id)arg4 adCampaignID:(id)arg5 price:(id)arg6 purchaseInitiatedTime:(id)arg7 arrivedFromAd:(_Bool)arg8;
