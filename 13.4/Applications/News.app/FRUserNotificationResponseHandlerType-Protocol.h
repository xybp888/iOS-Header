...
- (void)shareArticleWithID:(NSString *)arg1 notificationID:(NSString *)arg2 channelID:(NSString *)arg3 forceArticleUpdate:(_Bool)arg4 userActionDate:(NSDate *)arg5;
- (void)showArticleWithID:(NSString *)arg1 notificationID:(NSString *)arg2 channelID:(NSString *)arg3 forceArticleUpdate:(_Bool)arg4 userActionDate:(NSDate *)arg5;
