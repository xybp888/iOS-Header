...
- (id)setReferredHeadlineSectionWithHeadlines:(id)arg1 bannerTitle:(id)arg2 showDiscoverMoreInterstitial:(_Bool)arg3;
...
- (void)handleFetchOperationResultWithHeadlines:(id)arg1 bannerTitle:(id)arg2 showDiscoverMoreInterstitial:(_Bool)arg3;
