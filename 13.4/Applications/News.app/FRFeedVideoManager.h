...
- (_Bool)supportsAutomaticallyEnteringFullscreen;
- (void)feedLayoutFinished;
- (CDUnknownBlockType)videoAdWithCompletionBlock:(CDUnknownBlockType)arg1;
- (_Bool)playbackAllowedForVideoPlayerViewController:(id)arg1;
...
- (_Bool)supportsInlinePlaybackForHeadlineTileInfo:(id)arg1;
- (void)setHeadlineTileInfo:(id)arg1 groupViewExposureID:(id)arg2;
- (void)stopIfShowingAd;
- (void)stop;
- (_Bool)isPresentingAdModalViewController;
- (void)pause;
