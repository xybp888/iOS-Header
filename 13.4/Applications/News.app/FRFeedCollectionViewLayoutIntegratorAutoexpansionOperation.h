...
{
    _Bool _gapOnscreen;
    _Bool _gapOnscreenTooLong;
    _Bool _resumeTimer;
    _Bool _committedBlueprintOrError;
...
@property(nonatomic) _Bool committedBlueprintOrError; // @synthesize committedBlueprintOrError=_committedBlueprintOrError;
@property(nonatomic) _Bool resumeTimer; // @synthesize resumeTimer=_resumeTimer;
@property(retain, nonatomic) NSObject<OS_dispatch_source> *gapOnscreenTimer; // @synthesize gapOnscreenTimer=_gapOnscreenTimer;
@property(nonatomic) _Bool gapOnscreenTooLong; // @synthesize gapOnscreenTooLong=_gapOnscreenTooLong;
@property(nonatomic) _Bool gapOnscreen; // @synthesize gapOnscreen=_gapOnscreen;
...
- (_Bool)_shouldCommitFastBlueprint;
- (_Bool)_tryToFinishWithError:(id)arg1;
