...
{
    _Bool _fadeInExtraContent;
    _Bool _shouldCrossFade;
    _Bool _isViewObscured;
    _Bool _fullWidthAnimation;
    _Bool _endOfArticle;
    _Bool _topOfFeed;
    _Bool _isVideoCell;
...
@property(nonatomic) _Bool topOfFeed; // @synthesize topOfFeed=_topOfFeed;
@property(nonatomic) _Bool endOfArticle; // @synthesize endOfArticle=_endOfArticle;
@property(nonatomic) _Bool fullWidthAnimation; // @synthesize fullWidthAnimation=_fullWidthAnimation;
@property(nonatomic) _Bool isViewObscured; // @synthesize isViewObscured=_isViewObscured;
@property(nonatomic) _Bool shouldCrossFade; // @synthesize shouldCrossFade=_shouldCrossFade;
@property(nonatomic) _Bool fadeInExtraContent; // @synthesize fadeInExtraContent=_fadeInExtraContent;
...
- (id)initWithCell:(id)arg1 article:(id)arg2 fullWidthAnimation:(_Bool)arg3 topOfFeed:(_Bool)arg4 endOfArticle:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;
