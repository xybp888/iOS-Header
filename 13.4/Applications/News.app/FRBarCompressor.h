...
@property(nonatomic) _Bool toolbarCompressionEnabled; // @synthesize toolbarCompressionEnabled=_toolbarCompressionEnabled;
@property(nonatomic) _Bool navigationBarCompressionEnabled; // @synthesize navigationBarCompressionEnabled=_navigationBarCompressionEnabled;
...
- (_Bool)canAnimateNavigationBar;
- (_Bool)canAnimateToolbar;
- (_Bool)shouldCompress;
- (_Bool)didHitBottom;
- (_Bool)scrollViewDidHitTop;
- (void)resetBarsAnimated:(_Bool)arg1;
- (void)reloadForTraitCollection:(id)arg1;
- (void)setToolbarBarCompressed:(_Bool)arg1 animated:(_Bool)arg2;
- (void)setNavigationBarCompressed:(_Bool)arg1 animated:(_Bool)arg2;
- (void)setBarsCompressed:(_Bool)arg1 animated:(_Bool)arg2 force:(_Bool)arg3;
...
- (_Bool)isScrollViewBouncingAtTop;
