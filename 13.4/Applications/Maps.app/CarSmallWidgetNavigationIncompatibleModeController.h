...
@class CarChromeViewController, CarMapTrackingController, ChromeViewController, NSArray, NSString, UILabel;
@protocol MapSelectionManagerDelegate;

__attribute__((visibility("hidden")))
@interface CarSmallWidgetNavigationIncompatibleModeController : UIViewController <CarChromeModeController>
{
