...
@class NSString, RAPHomeWorkCoordinator, RAPHomeWorkCorrectionsWhichOneQuestion, RAPReport;

__attribute__((visibility("hidden")))
@interface RAPHomeWorkSelectionViewController : UITableViewController <RAPHomeWorkCoordinatorDelegate, RAPInstrumentableTarget>
{
    RAPHomeWorkCoordinator *_currentCorrectionsCoordinator;
