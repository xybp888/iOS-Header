...
- (id)initWithApplication:(id)arg1 rideOption:(id)arg2 canceled:(_Bool)arg3 canceledByService:(_Bool)arg4 userActivityForCanceling:(id)arg5 identifier:(id)arg6 phase:(unsigned long long)arg7 error:(unsigned long long)arg8;
