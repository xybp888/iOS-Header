...
@class CLInUseAssertion, GuidanceETA, IPCLoadDirectionsMessage, MKJunction, MKServerFormattedString, MNTrafficIncidentAlert, MapsSuggestionsEntry, NSArray, NSData, NSString, NSTimer, NSUUID, NSXPCConnection, NSXPCListenerEndpoint, NavSignLaneGuidanceInfo, NavSignShieldInfo, UIView, UNNotificationSettings;
@protocol BackgroundNavigationDelegate, ExternalGuidanceSource;
...
@interface IPCServer : NSObject <MapsSiriXPCInterface, MapsCompanionDaemonXPCInterface, MapsPushDaemonXPCInterface, MNNavigationServiceObserver>
{
    ...
    _Bool _carplaySceneForegrounded;
    _Bool _mainSceneForegrounded;
