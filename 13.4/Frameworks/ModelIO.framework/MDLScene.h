...
-     // Error parsing type: B64@0:81632^{RTCamera=^^?QQffi^f^^@{?=[4]}{?=[4]}^{RTRaySegment}ffffffffff}48^{RTIntersectionResult=f^{RTGeometry}@}56, name: castRayFrom:withDirection:usingCamera:result:
