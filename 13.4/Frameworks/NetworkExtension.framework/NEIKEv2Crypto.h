...
+     // Error parsing type: B52@0:8@16@24Q32^{__SecKey={__CFRuntimeBase=QAQ}^{__SecKeyDescriptor}^v}40I48, name: verifySignature:octets:hashAlgorithm:publicKey:padding:
+     // Error parsing type: B56@0:8@16@24Q32^{__SecKey={__CFRuntimeBase=QAQ}^{__SecKeyDescriptor}^v}40I48B52, name: verifySignature:octets:hashAlgorithm:publicKey:padding:sha2:
...
+     // Error parsing type: ^{__SecKey={__CFRuntimeBase=QAQ}^{__SecKeyDescriptor}^v}48@0:8@16@24^v32B40B44, name: copyTrustedKeyForCertificate:remoteCAArray:policyRef:enableRevocationCheck:strictRevocationCheck:
