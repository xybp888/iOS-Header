...
- (unsigned long long)eventNotificationCountForSource:(id)arg1 excludingDelegateSources:(_Bool)arg2 filteredByShowsNotificationsFlag:(_Bool)arg3;
@property(readonly, nonatomic) unsigned long long eventNotificationCount;
- (id)eventNotificationsFilteredByShowsNotificationsFlag:(_Bool)arg1;
