...
@property(readonly, nonatomic) PUCPAnalyticsBrowsingViewModelChangeObserver *cpAnalyticsChangeObserver; // @synthesize cpAnalyticsChangeObserver=_cpAnalyticsChangeObserver;
