...
- (void)gatherAutoFillDisplayDataWithTextField:(id)arg1 displayedInQuickType:(_Bool)arg2 prefix:(id)arg3 contact:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
