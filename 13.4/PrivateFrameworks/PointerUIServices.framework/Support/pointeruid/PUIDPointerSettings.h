...
@interface PUIDPointerSettings : PTSettings
{
    ...
    double _shapeMorphingAnimationDuration;
...
@property(nonatomic) double shapeMorphingAnimationDuration; // @synthesize shapeMorphingAnimationDuration=_shapeMorphingAnimationDuration;
