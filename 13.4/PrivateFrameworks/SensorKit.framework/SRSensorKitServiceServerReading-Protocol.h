...
- (void)fetchAllDevicesIdOnly:(_Bool)arg1 reply:(void (^)(NSArray *, NSError *))arg2;
...
- (void)startReadingForSensor:(NSString *)arg1 deviceId:(NSString *)arg2 bundleId:(NSString *)arg3 bypassHoldingPeriod:(_Bool)arg4 reply:(void (^)(void))arg5;
@end
