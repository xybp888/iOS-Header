...
- (_Bool)isValidWriteToDestinationAddress:(void *)arg1 withLength:(unsigned long long)arg2 bytes:(const void *)arg3;
@property(readonly, getter=isWritable) _Bool writable;
- (_Bool)containsAddress:(const void *)arg1;
- (void)sync;
- (void)unmap;
- (_Bool)mapWithFileHandle:(id)arg1;
- (void)dealloc;
