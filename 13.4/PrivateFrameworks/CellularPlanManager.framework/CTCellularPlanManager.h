...
- (void)userDidProvideResponse:(long long)arg1 confirmationCode:(id)arg2 forPlan:(id)arg3 isRemote:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)addNewAddonPlanDuringBuddy:(_Bool)arg1 userConsent:(long long)arg2 completion:(CDUnknownBlockType)arg3;
