...
- (id)nearestCustomResponsesToPromptEmbedding:(id)arg1 limit:(unsigned long long)arg2 withinRadius:(float)arg3 responseCountExponent:(float)arg4 minimumDecayedCount:(float)arg5 compatibilityVersion:(unsigned long long)arg6 language:(id)arg7 locale:(id)arg8 allowProfanity:(_Bool)arg9 minimumTimeInterval:(double)arg10;
