...
@interface TSWPStorage : TSPObject <TSDDrawableContainerInfo, TSKPencilAnnotationContainer, TSWPStorageParent, TSSStyleClient, TSWPTextSource>
{
    ...
    // Error parsing type: {atomic<unsigned long>="__a_"{__cxx_atomic_impl<unsigned long, std::__1::__cxx_atomic_base_impl<unsigned long> >="__a_value"AQ}}, name: _changeCount
    _Bool _isInInit;
