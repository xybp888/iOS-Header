...
- (_Bool)documentVersion:(CDStruct_af2b86c8 *)arg1 closedCleanlyToken:(long long *)arg2 error:(id *)arg3;
- (_Bool)setClosedCleanlyToken:(long long)arg1 error:(id *)arg2;
- (_Bool)setDocumentVersion:(CDStruct_af2b86c8)arg1 error:(id *)arg2;
