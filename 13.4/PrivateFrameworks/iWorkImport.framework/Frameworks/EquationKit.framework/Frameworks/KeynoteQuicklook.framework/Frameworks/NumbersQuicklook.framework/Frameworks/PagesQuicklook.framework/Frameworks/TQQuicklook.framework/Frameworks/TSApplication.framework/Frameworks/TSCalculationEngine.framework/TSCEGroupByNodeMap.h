...
- (id).cxx_construct;
- (void).cxx_destruct;
-     // Error parsing type: v24@0:8^{GroupByNodeMapArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{RepeatedPtrField<TSCE::GroupByNodeMapArchive_GroupNodesForGroupBy>=^{Arena}ii^{Rep}}}16, name: encodeToArchive:
-     // Error parsing type: @24@0:8r^{GroupByNodeMapArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{RepeatedPtrField<TSCE::GroupByNodeMapArchive_GroupNodesForGroupBy>=^{Arena}ii^{Rep}}}16, name: initFromArchive:
