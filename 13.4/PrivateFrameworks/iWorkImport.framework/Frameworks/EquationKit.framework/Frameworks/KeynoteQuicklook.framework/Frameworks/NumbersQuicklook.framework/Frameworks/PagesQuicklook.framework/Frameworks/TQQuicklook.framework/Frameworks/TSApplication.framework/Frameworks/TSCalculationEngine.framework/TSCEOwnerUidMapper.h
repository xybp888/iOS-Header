...
-     // Error parsing type: v24@0:8^{OwnerUIDMapperArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}}16, name: saveToArchive:
-     // Error parsing type: @24@0:8r^{OwnerUIDMapperArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}^{UUID}}16, name: initWithArchive:
