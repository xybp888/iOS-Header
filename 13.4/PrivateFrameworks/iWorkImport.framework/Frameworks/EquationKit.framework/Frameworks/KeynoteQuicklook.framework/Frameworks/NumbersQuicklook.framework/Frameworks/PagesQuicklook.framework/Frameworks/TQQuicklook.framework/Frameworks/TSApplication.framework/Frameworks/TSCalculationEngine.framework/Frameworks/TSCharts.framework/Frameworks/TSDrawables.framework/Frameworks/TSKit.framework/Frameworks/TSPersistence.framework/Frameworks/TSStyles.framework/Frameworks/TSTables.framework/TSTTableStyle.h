...
-     // Error parsing type: v32@0:8^{TableStylePropertiesArchive=^^?{InternalMetadataWithArena=^v}{HasBits<3>=[3I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{FillArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{StrokePresetListArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}BBBBBBBBiBBBBBi}16@24, name: saveTableStylePropertiesToArchive:archiver:
-     // Error parsing type: v40@0:8@16r^{TableStylePropertiesArchive=^^?{InternalMetadataWithArena=^v}{HasBits<3>=[3I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{FillArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{Deprecated_TableStrokeArchive}^{StrokePresetListArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}^{StrokeArchive}BBBBBBBBiBBBBBi}24@32, name: loadTableStylePropertiesIntoPropertyMap:fromArchive:unarchiver:
