...
#import <TSPersistence/TSPMutableLargeDictionarySegmentDelegate-Protocol.h>
...
- (id).cxx_construct;
- (void).cxx_destruct;
-     // Error parsing type: v32@0:8r^{LargeDictionary=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{RepeatedPtrField<TSP::Range>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}QQQIBB}16@24, name: loadFromLargeDictionaryMessage:unarchiver:
-     // Error parsing type: v32@0:8^{LargeDictionary=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{RepeatedPtrField<TSP::Range>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}QQQIBB}16@24, name: saveToLargeDictionaryMessage:archiver:
