...
-     // Error parsing type: v40@0:8r^{ChartInfoArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}^{DrawableArchive}^{ChartModelArchive}^{Reference}^{LegendModelArchive}^{RectArchive}^{SparseReferenceArray}^{SparseReferenceArray}^{Reference}^{Reference}^{Point}^{Reference}iiiiB}16@24@32, name: loadFromPreUFFArchive:unarchiver:persistentChartInfo:
