...
{
    _Bool _destinationIsInstructor;
}

@property(readonly, nonatomic) _Bool destinationIsInstructor; // @synthesize destinationIsInstructor=_destinationIsInstructor;
...
- (id)initForInstructorDestination:(_Bool)arg1;
- (id)init;
