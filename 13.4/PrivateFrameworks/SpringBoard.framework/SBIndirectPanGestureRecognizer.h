...
@property(retain, nonatomic) NSMutableSet *gestureRecognizersToDelayOnMouseActivation; // @synthesize gestureRecognizersToDelayOnMouseActivation=_gestureRecognizersToDelayOnMouseActivation;
...
- (_Bool)_isVelocityOrthogonalToAxis:(struct CGPoint)arg1 axis:(unsigned long long)arg2;
...
- (_Bool)_pointerEventRepresentsTrackpadTouchUp:(id)arg1;
- (_Bool)_pointerEventHasNonZeroOffset:(id)arg1 axis:(unsigned long long)arg2;
- (struct __IOHIDEvent *)_pointerHIDSubEventFromEvent:(struct __IOHIDEvent *)arg1;
- (_Bool)_isTrackpadEvent:(id)arg1;
- (struct CGPoint)_pointerModelLocation;
- (_Bool)_computeShouldSwitchAxes;
