...
- (id)appendTimeInterval:(double)arg1 withName:(NSString *)arg2 decomposeUnits:(_Bool)arg3;
...
- (id)appendFlag:(long long)arg1 withName:(NSString *)arg2 skipIfNotSet:(_Bool)arg3;
- (id)appendFlag:(long long)arg1 withName:(NSString *)arg2;
- (id)appendBool:(_Bool)arg1 withName:(NSString *)arg2 ifEqualTo:(_Bool)arg3;
- (id)appendBool:(_Bool)arg1 withName:(NSString *)arg2;
- (void)appendString:(NSString *)arg1 withName:(NSString *)arg2 skipIfEmpty:(_Bool)arg3;
- (void)appendString:(NSString *)arg1 withName:(NSString *)arg2;
- (void)appendProem:(id)arg1 block:(void (^)(void))arg2;
- (id)appendObject:(id)arg1 withName:(NSString *)arg2 skipIfNil:(_Bool)arg3;
