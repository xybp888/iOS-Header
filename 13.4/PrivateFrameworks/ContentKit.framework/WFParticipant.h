...
- (id)initWithURL:(id)arg1 name:(id)arg2 status:(long long)arg3 role:(long long)arg4 type:(long long)arg5 sourceIdentifier:(id)arg6 isManaged:(_Bool)arg7 isCurrentUser:(_Bool)arg8 contactPredicate:(id)arg9;
