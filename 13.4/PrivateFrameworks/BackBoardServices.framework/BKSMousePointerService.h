...
- (void)_calloutQueue_locked_setMousePointerPreferencesObservationEnabled:(_Bool)arg1;
- (void)_calloutQueue_locked_setMousePointerDeviceObservationEnabled:(_Bool)arg1;
