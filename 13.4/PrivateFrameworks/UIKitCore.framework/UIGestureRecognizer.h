...
- (_Bool)_hasAllowedPressTypes;
@property(copy, nonatomic) NSArray *allowedTouchTypes;
- (_Bool)_hasAllowedTouchTypes;
...
- (_Bool)_delegateShouldReceivePressesEvent:(id)arg1;
...
- (_Bool)_shouldReceivePressesEvent:(id)arg1;
- (_Bool)_shouldReceiveTouch:(id)arg1 withEvent:(id)arg2;
- (_Bool)_shouldReceiveTouchesEvent:(id)arg1;
