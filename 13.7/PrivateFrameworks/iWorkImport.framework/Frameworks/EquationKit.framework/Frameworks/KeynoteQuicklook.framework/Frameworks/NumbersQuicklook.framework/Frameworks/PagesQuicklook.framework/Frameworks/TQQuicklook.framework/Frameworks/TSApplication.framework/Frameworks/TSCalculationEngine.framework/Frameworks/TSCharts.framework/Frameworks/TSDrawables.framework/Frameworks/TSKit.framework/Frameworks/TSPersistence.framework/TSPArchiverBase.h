...
- (void)setWeakReferenceToObjectUUIDData:(const UUIDData_d8cf1c72 *)arg1 message:(struct UUID *)arg2;
...
- (id)alternateDiffToMergeBeforeVersion:(unsigned long long)arg1 fileFormatVersion:(unsigned long long)arg2 fieldPath:(int *)arg3 baseFieldPath:(const struct FieldPath *)arg4 message:(const struct Message *)arg5;
