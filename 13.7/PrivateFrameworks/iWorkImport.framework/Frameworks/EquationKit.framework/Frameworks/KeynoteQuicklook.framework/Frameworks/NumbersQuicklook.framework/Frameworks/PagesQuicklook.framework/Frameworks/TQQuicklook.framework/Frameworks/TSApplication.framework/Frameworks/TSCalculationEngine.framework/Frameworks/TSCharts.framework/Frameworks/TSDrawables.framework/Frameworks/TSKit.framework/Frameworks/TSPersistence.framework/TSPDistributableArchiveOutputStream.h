...
- (id)initWithOutputStream:(id)arg1 checkCrc:(unsigned int)arg2 enableDescriptors:(_Bool)arg3 enableToc:(_Bool)arg4 closedCleanly:(_Bool)arg5 archivedVersions:(CDStruct_af2b86c8)arg6;
