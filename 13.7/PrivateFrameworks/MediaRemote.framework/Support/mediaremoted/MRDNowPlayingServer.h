...
- (void)maybePostDistrubtedNotifications;
...
- (void)postPlayerDidUnregisterWithPlaybackState:(unsigned int)arg1 forPlayerPath:(id)arg2 handler:(CDUnknownBlockType)arg3;
...
- (void)postPlaybackQueueDidChange:(id)arg1 forPlayerPath:(id)arg2 handler:(CDUnknownBlockType)arg3;
...
- (void)postIsPlayingDidChange:(_Bool)arg1 forPlayerPath:(id)arg2 handler:(CDUnknownBlockType)arg3;
...
- (void)postClientDidUnregisterForPlayerPath:(id)arg1 hasDefaultSupportedCommands:(_Bool)arg2 handler:(CDUnknownBlockType)arg3;
...
- (void)_handleReRegisterCustomOriginMessage:(id)arg1 fromClient:(id)arg2;
