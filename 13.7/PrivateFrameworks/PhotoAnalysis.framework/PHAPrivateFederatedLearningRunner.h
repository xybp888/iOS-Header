...
- (id)initWithAttachmentURLs:(id)arg1 layersToTrain:(id)arg2 numberOfEpochs:(unsigned long long)arg3 learningRate:(id)arg4 modelInputName:(id)arg5 modelOutputName:(id)arg6 lossName:(id)arg7 optimizerName:(id)arg8 iCloudAggServiceKey:(id)arg9 clippingNorm:(id)arg10 normBinCount:(id)arg11 trainingTask:(id)arg12 fingerprintVersion:(id)arg13 datasetPolicy:(id)arg14 positivesDatasetName:(id)arg15 positivesSubsetName:(id)arg16 negativesDatasetName:(id)arg17 negativesSubsetName:(id)arg18 totalNumberOfSamples:(id)arg19 photoLibrary:(id)arg20 shouldAddNoise:(_Bool)arg21 shouldEncrypt:(_Bool)arg22;
