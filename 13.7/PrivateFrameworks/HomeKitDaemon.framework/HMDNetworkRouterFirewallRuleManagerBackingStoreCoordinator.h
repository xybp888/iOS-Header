...
- (void)_fetchCloudChangesWithQualityOfService:(long long)arg1 ignoreLastFetchedAccessories:(_Bool)arg2 forceChangeNotifications:(_Bool)arg3 xpcActivity:(id)arg4 completion:(CDUnknownBlockType)arg5;
