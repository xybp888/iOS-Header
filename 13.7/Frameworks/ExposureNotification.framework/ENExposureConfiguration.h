...
- (double)reportTypeWeightWithReportType:(unsigned int)arg1 skip:(_Bool *)arg2;
- (unsigned int)mappedDiagnosisReportType:(unsigned int)arg1;
- (double)infectiousnessWeightWithDaysSinceOnsetOfSymptoms:(long long)arg1 skip:(_Bool *)arg2;
