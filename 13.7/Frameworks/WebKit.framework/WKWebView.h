...
- (void)_evaluateJavaScript:(id)arg1 asAsyncFunction:(_Bool)arg2 withArguments:(id)arg3 forceUserGesture:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
