...
- (id)_sectionWithGroup:(id)arg1 inFirstPosition:(_Bool)arg2 topmostGroup:(id)arg3 regions:(id)arg4;
- (id)_sectionWithGroup:(id)arg1 inFirstPosition:(_Bool)arg2 topmostGroup:(id)arg3 persistedLayoutRegionsByTileInfoID:(id)arg4;
