...
@interface FRArticleViewContext : NSObject <NSSecureCoding>
{
    ...
    _Bool _showPlacardForFreeArticle;
    _Bool _showPlacardForSharedArticle;
    _Bool _isPaidSubscriberToSourceChannel;
    _Bool _originallyPresentedViaOpenURL;
    _Bool _shouldAutoPlayVideo;
    _Bool _isCoverArticle;
    _Bool _isEditorialTabShowingBadge;
...
+ (id)articleContextForLinkOpenedFromEditorialHomepageWithURL:(id)arg1 componentID:(id)arg2 previousArticleID:(id)arg3 previousArticleVersion:(id)arg4 isEditorialTabShowingBadge:(_Bool)arg5 sourceApplication:(id)arg6 adPreviewSessionID:(id)arg7 adPreviewID:(id)arg8 maximumAdRequestsForCurrentAdPreviewID:(long long)arg9;
+ (id)articleContextForLinkWithURL:(id)arg1 sourceApplication:(id)arg2 previousArticleID:(id)arg3 previousArticleVersion:(id)arg4 adPreviewSessionID:(id)arg5 adPreviewID:(id)arg6 adQToken:(id)arg7 maximumAdRequestsForCurrentAdPreviewID:(long long)arg8 userActionDate:(id)arg9 shouldAutoPlayVideo:(_Bool)arg10;
+ (id)articleContextForRelatedArticlesWithIsPaidSubscriberToSourceChannel:(_Bool)arg1 previousArticleID:(id)arg2;
+ (id)articleContextForMoreFromPublisherWithIsPaidSubscriberToSourceChannel:(_Bool)arg1 previousArticleID:(id)arg2;
+ (id)coverArticleContextForFeed:(id)arg1 feedContext:(id)arg2 coverArticleDisplayRank:(long long)arg3 coverArticleFeatureType:(long long)arg4 sourceChannel:(id)arg5 isSubscribedToFeed:(_Bool)arg6 isPaidSubscriberToSourceChannel:(_Bool)arg7 userActionDate:(id)arg8;
+ (id)articleContextForSearchResultWithSourceChannel:(id)arg1 isVideoInFeed:(_Bool)arg2 isSubscribedToFeed:(_Bool)arg3 isPaidSubscriberToSourceChannel:(_Bool)arg4;
+ (id)articleContextForSwipingBetweenArticlesWithFeed:(id)arg1 feedContext:(id)arg2 sourceChannel:(id)arg3 isVideoInFeed:(_Bool)arg4 isSubscribedToFeed:(_Bool)arg5 isPaidSubscriberToSourceChannel:(_Bool)arg6;
+ (id)articleContextForFeed:(id)arg1 feedContext:(id)arg2 bridgedFeedArticleContext:(id)arg3 sourceChannel:(id)arg4 isVideoInFeed:(_Bool)arg5 isSubscribedToFeed:(_Bool)arg6 isPaidSubscriberToSourceChannel:(_Bool)arg7 userActionDate:(id)arg8;
...
@property(nonatomic) _Bool isEditorialTabShowingBadge; // @synthesize isEditorialTabShowingBadge=_isEditorialTabShowingBadge;
...
@property(nonatomic) _Bool originallyPresentedViaOpenURL; // @synthesize originallyPresentedViaOpenURL=_originallyPresentedViaOpenURL;
...
@property(nonatomic) _Bool showPlacardForSharedArticle; // @synthesize showPlacardForSharedArticle=_showPlacardForSharedArticle;
@property(nonatomic) _Bool showPlacardForFreeArticle; // @synthesize showPlacardForFreeArticle=_showPlacardForFreeArticle;
...
@property(readonly, nonatomic) _Bool openedFromWidget;
