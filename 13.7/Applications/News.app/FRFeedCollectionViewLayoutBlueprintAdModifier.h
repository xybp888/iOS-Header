...
- (_Bool)isAdVisibleInBlueprint:(id)arg1 forAdIdentifier:(id)arg2 withVisibility:(id)arg3;
- (_Bool)canProcessOperation:(id)arg1 inBlueprint:(id)arg2 withVisibility:(id)arg3;
