...
@class AFConversation, NSArray, NSBundle, NSDictionary, NSError, NSString, NSURL, NSUUID, SASRequestOptions, SAUIAddContentToView, SAUIAddViews, SAUIChangePrimaryUtterance, SAUIGetResponseAlternativesPlayback, SAUIShowFullScreenEffect, SAUIShowSpeechAlternatives, SAUIUpdateViews, SAVCSPlayContent, UIViewController;
