...
@class CalendarDebugViewController, CalendarModel, MobileCalWindow, NSArray, NSString, RootNavigationController, UIApplicationShortcutItem;
...
- (void)_constructAndPresentSplashScreen:(id)arg1 window:(id)arg2;
